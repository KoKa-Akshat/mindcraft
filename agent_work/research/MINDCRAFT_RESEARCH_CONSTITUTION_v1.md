...
Queued next: see `NEXT_LAB.md` (Part CXLI exposure cool-down after reveal, then 142+). Company law through CXXXIII (v1.17); CXXXIV–CXL provisional pending synthesizer.
...
3ch. Exposure cool-down after reveal before same-stem C4 — **NEXT** id 141  
3ci. Student-facing hole copy after gap-scan — queued id 142  
