...
**Edition:** v1.15 (Synthesizer consolidation of Parts CVIII–CXVI into surviving doctrine)  
...
**Last updated:** 2026-08-10 (Synthesizer v1.15 — CVIII–CXVI company law)  
...
| CXXI | `chapters/121_explanation_quality_rubrics_ai_coach_wraps.md` | AI coach wrap QA rubrics; SAFE-EXPLAINQA; principle-short gates (provisional) |
| CXXII | `chapters/122_partial_credit_soft_wrong_taxonomy.md` | Soft-wrong mark taxonomy; SAFE-TAXON; type before points (provisional) |
| CXXIII | `chapters/123_exam_week_tutor_load_shedding_playbooks.md` | Exam-week tutor load shedding; SAFE-LOADSHED; acuity shed under crunch (provisional) |
| CXXIV | `chapters/124_distractor_design_diagnostic_soft_wrong_mc.md` | Distractor design for soft-wrong MC; SAFE-DISTRACTOR; misconception-mapped options (provisional) |
| CXXV | `chapters/125_confidence_tagged_misses_gap_scan_recovery.md` | Confidence-tagged gap-scan miss recovery; SAFE-CONFMISS; CRI fork without Identity Score™ (provisional) |
...
**Red Team verdict (updated v1.15):**
...
## I.4 Surviving doctrine stack (Synthesizer merge through CXVI)
...
| `map_slice_adjust` | Mid-session grain-slice Map open that changed next prompt/mission | SAFE-MAPORCH adjust (CXIX; provisional) |
| `map_student_dual_open` | Student-facing Map open concurrent with active attempt (demote / gate) | SAFE-MAPORCH anti-dual (CXIX; provisional) |
...
3bl. Explanation quality rubrics for AI coach wraps — **DONE** Part CXXI / SAFE-EXPLAINQA (provisional)  
3bm. Partial-credit & soft-wrong taxonomy productization — **DONE** Part CXXII / SAFE-TAXON (provisional)  
3bn. Exam-week tutor load shedding playbooks — **DONE** Part CXXIII / SAFE-LOADSHED (provisional)  
3bo. Distractor design for diagnostic soft-wrong MC — **DONE** Part CXXIV / SAFE-DISTRACTOR (provisional)  
3bp. Confidence-tagged misses in gap-scan recovery — **DONE** Part CXXV / SAFE-CONFMISS (provisional)  
3bq. Tutor micro-debrief fidelity under time caps — queued id 126 **NEXT**  
3br. Parent crunch-week message tests (availability vs thinking minutes) — queued id 127  
3bs. Format-trap distractors on diagram/graph items — queued id 128  
...
92. **NEXT:** Worked-example fading under high math anxiety (id 117)
...
**v1.15 synthesizer pass folded Parts CVIII–CXVI into surviving commercial doctrine (I.4 rows SAFE-ANALOG through SAFE-OFFLINE; Red Team kills #62–#70 promoted from provisional). Experiment families ANALOG/WRITE/SPATIAL/FA/FBLIT/COLLAB/DDSCHED/ROLEMODEL/OFFLINE confirmed mounted. Next researcher id: CXVII fade×anxiety. Researcher count since v1.15 = 0. Page count is not the finish line — falsifiable truth is.**
