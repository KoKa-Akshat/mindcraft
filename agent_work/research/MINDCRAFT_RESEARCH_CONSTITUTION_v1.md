...
Queued next: see `NEXT_LAB.md` (Part CLVI generator vs rater poison separation, then 157+). Company law through CL (v1.19); CLI–CLV provisional pending synthesizer.
...
**Next research bottleneck:** Part CLVI **Generator vs rater poison separation on inherit repair**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) + SAFE-PATHBLAME (CLII) + SAFE-PANELRAMP (CLIII) + SAFE-DEMOB (CLIV) + SAFE-GOLDSET (CLV) provisional** densifiers pending synthesizer. Experiment families …/SURGEPANEL/**REVOKE**/**PATHBLAME**/**PANELRAMP**/**DEMOB**/**GOLDSET** gate claims above L1. Researcher count since v1.19 synthesizer = **5**.
...
3ct. Generator vs rater poison separation on inherit repair — **NEXT** id 156  
3cu. LEA packet path-mix honesty without Dual Shame theater — queued id 157  
