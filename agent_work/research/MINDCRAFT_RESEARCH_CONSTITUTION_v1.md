...
Queued next: see `NEXT_LAB.md` (Part CLVIII gold-bank rotation, then 159+). Company law through CL (v1.19); CLI–CLVII provisional pending synthesizer.
...
**Next research bottleneck:** Part CLVIII **Gold-bank rotation & tip-resistance under rater familiarity**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) + SAFE-PATHBLAME (CLII) + SAFE-PANELRAMP (CLIII) + SAFE-DEMOB (CLIV) + SAFE-GOLDSET (CLV) + SAFE-POISONSEP (CLVI) + SAFE-PATHMIX (CLVII) provisional** densifiers pending synthesizer. Experiment families …/SURGEPANEL/**REVOKE**/**PATHBLAME**/**PANELRAMP**/**DEMOB**/**GOLDSET**/**POISONSEP**/**PATHMIX** gate claims above L1. Researcher count since v1.19 synthesizer = **7**.
