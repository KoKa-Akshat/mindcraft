...
**Edition:** v1.17 (Synthesizer consolidation of Parts CXXVI–CXXXIII into surviving doctrine)  
...
**Last updated:** 2026-08-12 (Synthesizer v1.17 — CXXVI–CXXXIII company law)  
...
Queued next: see `NEXT_LAB.md` (Part CXLIII promote backlog SLA, then 144+). Company law through CXXXIII (v1.17); CXXXIV–CXLII provisional pending synthesizer.

**Synthesizer note (v1.17):** Eight researcher chapters (CXXVI–CXXXIII) landed after v1.16 as provisional I.4 densifiers — tutor micro-debrief under time caps, parent crunch-week message tests, format-trap visual distractors, session-open micro-briefs under late joins, dual-rail Solver CTAs under crunch, figure key-verify for FormatId generation, async pre-brief cards on late/early wait, and one-tap Solver→Practice transfer grain. This edition promotes each stack to company law (removes provisional tags), formalizes Red Team kills #80–#87, confirms MICRODEB/CRUNCHMSG/FORMTRAP/MICROBRIEF/CRUNCHCTA/FIGKEY/ASYNCBRIEF/XFERGRAIN experiment families in Part IX, and refreshes metrics/glossary/competitive implication. Deep-dive files remain authoritative for citations; the OS keeps only *surviving* product rules.
...
**Red Team verdict (updated v1.17):**
...
## I.4 Surviving doctrine stack (Synthesizer merge through CXXXIII)
...
**Next research bottleneck:** Part CXLIII **Promote backlog SLA vs parent hole-ETA honesty**. Provisional densifiers landed: SAFE-HCELIG (CXXXIV), SAFE-KNOWNETA (CXXXV), SAFE-SOFTGATE (CXXXVI), SAFE-SPLITPOOL (CXXXVII), SAFE-SCANCOMP (CXXXVIII), SAFE-HOLETRUST (CXXXIX), SAFE-PROMOTE (CXL), SAFE-COOLDOWN (CXLI), SAFE-STUDHOLE (CXLII). Experiment families CAL/DP/CoP/RIT/AAR/FILM/MUSIC/ANNOT/EXP- gate claims above L1. Researcher count since v1.17 synthesizer = **9** (Synthesizer v1.18 overdue on next eligible non–Red-Team tick).
...
3ca. Hide-correctness eligibility gates for FormatId items — **DONE** Part CXXXIV / SAFE-HCELIG (provisional)  
3cb. Known-finite ETA honesty in late-tutor lobby copy — **DONE** Part CXXXV / SAFE-KNOWNETA (provisional)  
3cc. Soft-require vs hard-gate follow-on under help-avoidance risk — **DONE** Part CXXXVI / SAFE-SOFTGATE (provisional)  
3cd. Reveal-Practice vs C4 split pools for sealed FormatId — **DONE** Part CXXXVII / SAFE-SPLITPOOL (provisional)  
3ce. FormatId gap-scan composition under sealed-stock scarcity — **DONE** Part CXXXVIII / SAFE-SCANCOMP (provisional)  
3cf. Parent trust copy when visual diagnostic holes remain — **DONE** Part CXXXIX / SAFE-HOLETRUST (provisional)  
3cg. Promote-to-C4 tutor QA workflow for Practice-only FormatId — **DONE** Part CXL / SAFE-PROMOTE (provisional)  
3ch. Exposure cool-down after reveal before same-stem C4 — **DONE** Part CXLI / SAFE-COOLDOWN (provisional)  
3ci. Student-facing hole copy after gap-scan — **DONE** Part CXLII / SAFE-STUDHOLE (provisional)  
...
111. **DONE (2026-08-13):** Hide-correctness eligibility gates for FormatId items (Part CXXXIV / id 134) — SAFE-HCELIG stack (provisional)  
112. **DONE (2026-08-13):** Known-finite ETA honesty in late-tutor lobby copy (Part CXXXV / id 135) — SAFE-KNOWNETA stack (provisional)  
113. **DONE (2026-08-13):** Soft-require vs hard-gate follow-on under help-avoidance (Part CXXXVI / id 136) — SAFE-SOFTGATE stack (provisional)  
114. **DONE (2026-08-13):** Reveal-Practice vs C4 split pools for sealed FormatId (Part CXXXVII / id 137) — SAFE-SPLITPOOL stack (provisional)  
115. **DONE (2026-08-13):** FormatId gap-scan composition under sealed-stock scarcity (Part CXXXVIII / id 138) — SAFE-SCANCOMP stack (provisional)  
116. **DONE (2026-08-13):** Parent trust copy when visual diagnostic holes remain (Part CXXXIX / id 139) — SAFE-HOLETRUST stack (provisional)  
117. **DONE (2026-08-13):** Promote-to-C4 tutor QA workflow for Practice-only FormatId (Part CXL / id 140) — SAFE-PROMOTE stack (provisional)  
118. **DONE (2026-08-13):** Exposure cool-down after reveal before same-stem C4 (Part CXLI / id 141) — SAFE-COOLDOWN stack (provisional)  
119. **DONE (2026-08-14):** Student-facing hole copy after gap-scan (Part CXLII / id 142) — SAFE-STUDHOLE stack (provisional)  
120. **NEXT:** Promote backlog SLA vs parent hole-ETA honesty (id 143)
...
**v1.17 synthesizer pass folded Parts CXXVI–CXXXIII into surviving commercial doctrine (I.4 rows SAFE-MICRODEB through SAFE-XFERGRAIN; Red Team kills #80–#87 promoted from provisional). Experiment families MICRODEB/CRUNCHMSG/FORMTRAP/MICROBRIEF/CRUNCHCTA/FIGKEY/ASYNCBRIEF/XFERGRAIN confirmed mounted. Researcher ticks landed provisional SAFE-HCELIG (CXXXIV / #88), SAFE-KNOWNETA (CXXXV / #89), SAFE-SOFTGATE (CXXXVI / #90), SAFE-SPLITPOOL (CXXXVII / #91), SAFE-SCANCOMP (CXXXVIII / #92), SAFE-HOLETRUST (CXXXIX / #93), SAFE-PROMOTE (CXL / #94), SAFE-COOLDOWN (CXLI / #95), and SAFE-STUDHOLE (CXLII / #96) pending synthesizer. Next researcher id: CXLIII promote backlog SLA vs parent hole-ETA honesty. Researcher count since v1.17 synthesizer = 9 (Synthesizer v1.18 overdue). Page count is not the finish line — falsifiable truth is.**
