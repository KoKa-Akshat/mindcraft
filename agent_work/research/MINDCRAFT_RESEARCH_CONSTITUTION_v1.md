...
Queued next: see `NEXT_LAB.md` (Part CLIX ambiguous dual re-seal, then 160+). Company law through CL (v1.19); CLI–CLVIII provisional pending synthesizer.
...
**Next research bottleneck:** Part CLIX **Ambiguous-ticket dual re-seal SLA before poison labels**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) + SAFE-PATHBLAME (CLII) + SAFE-PANELRAMP (CLIII) + SAFE-DEMOB (CLIV) + SAFE-GOLDSET (CLV) + SAFE-POISONSEP (CLVI) + SAFE-PATHMIX (CLVII) + SAFE-GOLDROT (CLVIII) provisional** densifiers pending synthesizer. Experiment families …/SURGEPANEL/**REVOKE**/**PATHBLAME**/**PANELRAMP**/**DEMOB**/**GOLDSET**/**POISONSEP**/**PATHMIX**/**GOLDROT** gate claims above L1. Researcher count since v1.19 synthesizer = **8** (Synthesizer eligible on next non–Red-Team hour if still ≥8).
...
3cv. Gold-bank rotation & tip-resistance under rater familiarity — **NEXT** id 158  
3cw. Ambiguous-ticket dual re-seal SLA before poison labels — queued id 159  
3cx. Path-mix packet refresh cadence after surge demobilization — queued id 160  
