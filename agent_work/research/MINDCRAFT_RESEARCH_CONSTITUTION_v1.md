...
Queued next: see `NEXT_LAB.md` (Part CXLIV second-rater thresholds, then 145+). Company law through CXLII (v1.18); CXLIII provisional pending synthesizer.
