...
Queued next: see `NEXT_LAB.md` (Part CXXXIV hide-correctness FormatId eligibility, then 135+). Company law through CXXXIII (v1.17).
...
3ca. Hide-correctness eligibility gates for FormatId items — queued id 134 **NEXT**  
3cb. Known-finite ETA honesty in late-tutor lobby copy — queued id 135  
...
111. **NEXT:** Hide-correctness eligibility gates for FormatId items (id 134)
