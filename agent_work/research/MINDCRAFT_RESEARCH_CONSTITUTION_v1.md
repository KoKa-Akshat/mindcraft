...
Queued next: see `NEXT_LAB.md` (Part CXXIV distractor design for soft-wrong MC, then 125+).
...
**Next research bottleneck:** Part CXXIV **Distractor design for diagnostic soft-wrong MC**. Experiment families CAL/DP/CoP/RIT/AAR/FILM/MUSIC/ANNOT/EXP- gate claims above L1. Researcher count since v1.15 synthesizer = **7**. Provisional densifiers pending synthesizer: SAFE-FADEX (CXVII), SAFE-SOFTMSG (CXVIII), SAFE-MAPORCH (CXIX), SAFE-BURNWARN (CXX), SAFE-EXPLAINQA (CXXI), SAFE-TAXON (CXXII), SAFE-LOADSHED (CXXIII).
...
3bo. Distractor design for diagnostic soft-wrong MC — queued id 124 **NEXT**  
3bp. Confidence-tagged misses in gap-scan recovery — queued id 125  
