...
Queued next: see `NEXT_LAB.md` (Part CXXV confidence-tagged gap-scan misses, then 126+).
...
**Next research bottleneck:** Part CXXV **Confidence-tagged misses in gap-scan recovery**. Experiment families CAL/DP/CoP/RIT/AAR/FILM/MUSIC/ANNOT/EXP- gate claims above L1. Researcher count since v1.15 synthesizer = **8** (Synthesizer eligible on next non–Red-Team hour). Provisional densifiers pending synthesizer: SAFE-FADEX (CXVII), SAFE-SOFTMSG (CXVIII), SAFE-MAPORCH (CXIX), SAFE-BURNWARN (CXX), SAFE-EXPLAINQA (CXXI), SAFE-TAXON (CXXII), SAFE-LOADSHED (CXXIII), SAFE-DISTRACTOR (CXXIV).
...
3bp. Confidence-tagged misses in gap-scan recovery — queued id 125 **NEXT**  
3bq. Tutor micro-debrief fidelity under time caps — queued id 126  
