...
Queued next: see `NEXT_LAB.md` (Part CXXXII async pre-brief cards, then 133+).
...
3bx. Async pre-brief cards while waiting for late tutor — queued id 132 **NEXT**  
3by. One-tap Solver→Practice transfer grain after instrumental help — queued id 133  
...
107. **Synthesizer v1.16 (2026-08-11):** Merged CXVII–CXXV into I.4 / XIV / IX / XXI — no new chapter  
108. **NEXT:** Async pre-brief cards while waiting for late tutor (id 132)
