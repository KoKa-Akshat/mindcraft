...
**Edition:** v1.20 (Synthesizer consolidation of Parts CLI–CLIX into surviving doctrine)  
...
**Last updated:** 2026-08-17 (Synthesizer v1.20 — CLI–CLIX company law)  
...
| C | `chapters/100_worked_example_vs_problem_solving_timing.md` | Worked-example vs PS timing across expertise; SAFE-EXPTIME; grain-local adaptive fade |
| CI | `chapters/101_self_regulated_learning_cycles_practice_ux.md` | SRL cycles (Zimmerman) in Practice UX; SAFE-SRL; phase→control micro-prompts |
| CII | `chapters/102_generative_learning_activities_practice.md` | Generative learning (Fiorella/Mayer) in Practice; SAFE-GENERATE; SOI-forcing micro-GLAs |
| CIII | `chapters/103_error_climate_psychological_safety_tutoring.md` | Error climate & psychological safety in tutoring; SAFE-ERRCLIMATE; stay-diagnose under FEI |
| CIV | `chapters/104_homework_help_vs_practice_identity.md` | Homework help vs practice identity; SAFE-HWHELP; dual-rail Solver/Practice |
| CV | `chapters/105_gesture_embodiment_math_practice.md` | Gesture & embodiment in math practice; SAFE-GESTURE; strategy-tied optional motion |
| CVI | `chapters/106_peer_explanation_quality_knowledge_building.md` | Peer explanation quality; SAFE-PEERX; knowledge-building vs telling |
| CVII | `chapters/107_curiosity_prediction_before_reveal.md` | Curiosity & prediction before reveal; SAFE-PREDICT; commit→surprise→encode |
| CVIII | `chapters/108_analogical_reasoning_bridge_teaching.md` | Analogical reasoning & bridge teaching; SAFE-ANALOG; structure-map joins |
| CIX | `chapters/109_writing_to_learn_math_practice.md` | Writing-to-learn in math practice; SAFE-WRITE; Notes/protocol chips |
| CX | `chapters/110_spatial_skills_math_identity.md` | Spatial skills & math identity; SAFE-SPATIAL; FormatId hops |
| CXI | `chapters/111_formative_assessment_cycles_tutor_sessions.md` | Formative assessment cycles; SAFE-FA; exit tickets vs FEI |
| CXII | `chapters/112_feedback_literacy_coach_uptake.md` | Feedback literacy / coach uptake; SAFE-FBLIT; delivery≠uptake |
| CXIII | `chapters/113_collaborative_problem_solving_vs_solo_fei.md` | Collaborative PS vs solo FEI; SAFE-COLLAB; group≠solo mastery |
...
| CXVII | `chapters/117_worked_example_fading_under_high_math_anxiety.md` | Fade × anxiety; SAFE-FADEX; protect then fade |
| CXVIII | `chapters/118_parent_message_framing_after_soft_wrong_streaks.md` | Parent soft-wrong framing; SAFE-SOFTMSG; grain+CTA not nag |
| CXIX | `chapters/119_classroom_orchestration_map_live_tutoring.md` | Map live-session orchestration; SAFE-MAPORCH; brief→slice→adjust |
| CXX | `chapters/120_tutor_burnout_early_warning_without_wellness_theater.md` | Tutor burnout early-warning; SAFE-BURNWARN; fidelity/load→redesign |
| CXXI | `chapters/121_explanation_quality_rubrics_ai_coach_wraps.md` | AI coach wrap QA rubrics; SAFE-EXPLAINQA; principle-short gates |
| CXXII | `chapters/122_partial_credit_soft_wrong_taxonomy.md` | Soft-wrong mark taxonomy; SAFE-TAXON; type before points |
| CXXIII | `chapters/123_exam_week_tutor_load_shedding_playbooks.md` | Exam-week tutor load shedding; SAFE-LOADSHED; acuity shed under crunch |
| CXXIV | `chapters/124_distractor_design_diagnostic_soft_wrong_mc.md` | Distractor design for soft-wrong MC; SAFE-DISTRACTOR; misconception-mapped options |
| CXXV | `chapters/125_confidence_tagged_misses_gap_scan_recovery.md` | Confidence-tagged gap-scan miss recovery; SAFE-CONFMISS; CRI fork without Identity Score™ |
| CXXVI | `chapters/126_tutor_micro_debrief_fidelity_under_time_caps.md` | Tutor micro-debrief fidelity under time caps; SAFE-MICRODEB; capped AAR without lecture cosplay |
| CXXVII | `chapters/127_parent_crunch_week_message_tests.md` | Parent crunch-week message tests; SAFE-CRUNCHMSG; shed honesty vs 24/7 CBC |
| CXXVIII | `chapters/128_format_trap_distractors_diagram_graph_items.md` | Format-trap distractors on diagram/graph items; SAFE-FORMTRAP; visual traps without decoration theater |
| CXXIX | `chapters/129_session_open_brief_fidelity_under_late_joins.md` | Session-open brief fidelity under late joins; SAFE-MICROBRIEF; capped shared-model open |
| CXXX | `chapters/130_dual_rail_solver_cta_copy_under_crunch.md` | Dual-rail Solver CTA copy under crunch; SAFE-CRUNCHCTA; help tonight vs Practice gym without Chegg hero |
| CXXXI | `chapters/131_figure_key_verify_loops_generated_formatid.md` | Figure key-verify loops for generated FormatId stems; SAFE-FIGKEY; structural gates without fluency SVG pass |
| CXXXII | `chapters/132_async_prebrief_cards_late_tutor_wait.md` | Async pre-brief cards while waiting for late tutor; SAFE-ASYNCBRIEF; student-owned Set without idle lobby |
| CXXXIII | `chapters/133_one_tap_solver_practice_transfer_grain.md` | One-tap Solver→Practice transfer grain; SAFE-XFERGRAIN; handoff without dump-and-quit |
| CXXXIV | `chapters/134_hide_correctness_eligibility_formatid.md` | Hide-correctness FormatId eligibility gates; SAFE-HCELIG; C4 stricter than Practice browse |
| CXXXV | `chapters/135_known_finite_eta_honesty_late_tutor_lobby.md` | Known-finite ETA honesty in late-tutor lobby; SAFE-KNOWNETA; finite band without soon/shame |
| CXXXVI | `chapters/136_soft_require_vs_hard_gate_follow_on_help_avoidance.md` | Soft-require vs hard-gate follow-on; SAFE-SOFTGATE; soft-require default under help-avoidance |
| CXXXVII | `chapters/137_reveal_practice_vs_c4_split_pools_sealed_formatid.md` | Reveal-Practice vs C4 split pools; SAFE-SPLITPOOL; graded use without silent Map writes |
| CXXXVIII | `chapters/138_formatid_gap_scan_composition_sealed_stock_scarcity.md` | FormatId gap-scan composition under sealed-stock scarcity; SAFE-SCANCOMP; honest holes vs pad theater |
| CXXXIX | `chapters/139_parent_trust_copy_visual_diagnostic_holes.md` | Parent trust copy when visual diagnostic holes remain; SAFE-HOLETRUST; labeled holes without shame/pad |
| CXL | `chapters/140_promote_to_c4_tutor_qa_workflow.md` | Promote-to-C4 tutor QA for Practice-only FormatId; SAFE-PROMOTE; ticketed checklist without play-count flip |
| CXLI | `chapters/141_exposure_cooldown_after_reveal_same_stem_c4.md` | Exposure cool-down after reveal before same-stem C4; SAFE-COOLDOWN; anti-answer-hunt without pool starvation |
| CXLII | `chapters/142_student_facing_hole_copy_after_gap_scan.md` | Student-facing hole copy after gap-scan; SAFE-STUDHOLE; no shame, no fake greens; parity with HOLETRUST |
| CXLIII | `chapters/143_promote_backlog_sla_parent_hole_eta.md` | Promote backlog SLA vs parent hole-ETA honesty; SAFE-FILLETA; capacity-grounded verify bands |
| CXLIV | `chapters/144_second_rater_thresholds_figured_c4.md` | Second-rater thresholds for figured C4 admits; SAFE-DUALRATE; risk-triggered dual without cost theater |
| CXLV | `chapters/145_isomorphic_stem_family_hashing_cooldown.md` | Isomorphic stem-family hashing for cool-down; SAFE-FAMHASH; sealed family unit without over-block |
| CXLVI | `chapters/146_gap_scan_exit_emotion_without_anxiety_score.md` | Gap-scan exit emotion without Anxiety Score™; SAFE-EXITEMO; destake copy after holes |
| CXLVII | `chapters/147_dual_rater_capacity_planning_filleeta.md` | Dual-rater capacity planning vs FILLETA band honesty; SAFE-CAPPLAN; dual minutes in fill estimator |
| CXLVIII | `chapters/148_template_trust_inheritance_first_of_cell_dual.md` | Template-trust inheritance after first-of-cell dual; SAFE-TMPTRUST; inherit intensity not seals |
| CXLIX | `chapters/149_post_promote_repair_stratified_dashboards.md` | Post-promote repair stratified dashboards; SAFE-REPAIRSTRAT; path-true IRR without Kappa % NS |
| CL | `chapters/150_dual_capacity_hire_vs_contract_sme_panels.md` | Dual-capacity hire vs contract SME panels; SAFE-SURGEPANEL; make-or-buy dual under exam spikes |
| CLI | `chapters/151_template_trust_revoke_sample_dual_cadence.md` | Template-trust revoke & sample-dual cadence; SAFE-REVOKE; switching-rule tighten/revoke under repair spikes |
| CLII | `chapters/152_path_conditioned_dual_blame_selection_vs_quality.md` | Path-conditioned dual blame tests; SAFE-PATHBLAME; selection vs quality without Dual Shame Score™ |
| CLIII | `chapters/153_contract_sme_panel_seal_onboarding_parallel_run.md` | Contract SME panel seal onboarding & parallel-run gates; SAFE-PANELRAMP; ramp before C4 authority |
| CLIV | `chapters/154_post_spike_dual_demobilization_fidelity_cliff.md` | Post-spike dual demobilization without fidelity cliff; SAFE-DEMOB; handover + capture, no invent-work |
| CLV | `chapters/155_gold_set_planted_probes_path_stratum_monitors.md` | Gold-set planted probes for path×stratum monitors; SAFE-GOLDSET; sealed canaries without Gold Set Score™ |
| CLVI | `chapters/156_generator_vs_rater_poison_inherit_repair.md` | Generator vs rater poison separation on inherit repair; SAFE-POISONSEP; poison_source labels without Generator Shame Score™ |
| CLVII | `chapters/157_lea_packet_path_mix_honesty.md` | LEA packet path-mix honesty without Dual Shame theater; SAFE-PATHMIX; mix charts in trust packets without case-mix cosplay |
| CLVIII | `chapters/158_gold_bank_rotation_tip_resistance.md` | Gold-bank rotation & tip-resistance under rater familiarity; SAFE-GOLDROT; rotate/cap sealed probes without Gold Familiarity Score™ |
| CLIX | `chapters/159_ambiguous_ticket_dual_reseal_sla.md` | Ambiguous-ticket dual re-seal SLA before poison labels; SAFE-AMBSEAL; finite hold without Forced Blame Score™ |
| CLX | `chapters/160_path_mix_packet_refresh_cadence_demob.md` | Path-mix packet refresh cadence after surge demobilization; SAFE-MIXREFRESH; stale/vintage labels without Mix Freshness Score™ |

Queued next: see `NEXT_LAB.md` (Part CLXI panel gold hygiene, then 162+). Company law through CLIX (v1.20); CLX provisional pending synthesizer.
**Synthesizer note (v1.20):** Nine researcher chapters (CLI–CLIX) landed after v1.19 as provisional I.4 densifiers — revocable template-trust with switching sample cadence, path×stratum blame before dual/single verdicts, contract-panel seal ramp before C4 authority, planned post-spike demobilization without invent-work, sealed gold probes for path×stratum monitors, generator-vs-rater poison labels on inherit repair, LEA path-mix honesty in trust packets, gold-bank rotation against tip/familiarity, and finite ambiguous re-seal SLAs before poison labels. This edition promotes each stack to company law (removes provisional tags), formalizes Red Team kills #105–#113, confirms REVOKE/PATHBLAME/PANELRAMP/DEMOB/GOLDSET/POISONSEP/PATHMIX/GOLDROT/AMBSEAL experiment families in Part IX, and refreshes metrics/glossary/competitive implication. Deep-dive files remain authoritative for citations; the OS keeps only *surviving* product rules.
...
**Red Team verdict (updated v1.20):**
...
| Talk-% / silence theater / got-it ≡ Socratic quality | **KILLED** | SAFE-TALK (LXXXIV); construction > airtime; prompt density |
| Immersion / lore / Story Engagement ≡ learning | **KILLED** | SAFE-STORYLOAD (LXXXV); CLT-budgeted structure wrap |
| User-count / star-wall / vague praise ≡ learning proof | **KILLED** | SAFE-PROOF (LXXXVI); dated solo competence artifacts |
| Item-count / complete-ACT / unsynced GENQ ≡ coverage | **KILLED** | SAFE-COVER (LXXXVII); matrix + gaps + use-tier |
| Always-full-worked / never-fade / solution-first ≡ learning | **KILLED** | SAFE-FADE (LXXXVIII); completion ladder + solo proof |
...
| Universal E0→E3 destiny / fixed≡adaptive / confidence≡fade stage / Example Timing Score™ | **KILLED** | SAFE-EXPTIME (C); grain-local adaptive example↔solve timing |
| SRL Score™ / reflection-streak / survey≡event / streak≡SRL / forethought-without-control | **KILLED** | SAFE-SRL (CI); phase→control cycles + FEI proof |
| Generative Learning Score™ / AI≡generation / teach-for-XP / eight-menu GLA bomb | **KILLED** | SAFE-GENERATE (CII); SOI-forcing sparse GLAs + transfer proof |
| Psychological Safety Score™ / poster safe-space / Bermuda-triangle / praise-fog≡climate | **KILLED** | SAFE-ERRCLIMATE (CIII); stay-diagnose + adaptive action under FEI |
| Homework Completion Score™ / tonight-% / Chegg-dump / assisted≡ready / purity-ban help | **KILLED** | SAFE-HWHELP (CIV); dual-rail instrumental help + solo proof |
| Embodiment Score™ / styles meshing / always-gesture / action≡gesture / pose-camera AI | **KILLED** | SAFE-GESTURE (CV); strategy-tied optional motion + transfer proof |
| Peer Explanation Score™ / teach-for-XP / telling≡quality / Discord≡building / AI≡peer teaching | **KILLED** | SAFE-PEERX (CVI); building-gated teach-back + solo proof |
| Curiosity Score™ / cliffhanger-without-commit / postdiction / instant-reveal entertainment | **KILLED** | SAFE-PREDICT (CVII); commit→surprise→encode repair |
| Analogy Score™ / Mapping Minutes / mention≡pedagogy / surface-story≡structure / AI likeness dump | **KILLED** | SAFE-ANALOG (CVIII); co-present structure-map + student alignment |
| Writing Score™ / Journal Minutes / freewrite≡learning / longer≡deeper / AI rewrite≡WTL | **KILLED** | SAFE-WRITE (CIX); short prompted cognitive+metacognitive protocols + FEI |
| Spatial Score™ / Mental Rotation Minutes / brain-training≡identity / boys-better spatial / Spatial Personality™ | **KILLED** | SAFE-SPATIAL (CX); FormatId-embedded hops + conditional transfer |
| Formative Score™ / Assessment Minutes / exit-ticket≡learning / 0.4–0.7 AfL ads | **KILLED** | SAFE-FA (CXI); evidence→adjust cycles + FEI |
| Feedback Literacy Score™ / Feedback Minutes / delivery≡uptake / thumbs≡used / longer≡literate | **KILLED** | SAFE-FBLIT (CXII); uptake loop + FEI |
| Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready | **KILLED** | SAFE-COLLAB (CXIII); solo gate + accountability |
| Desirable Difficulty Score™ / Challenge Minutes / always-ease / always-max / cram≡ready | **KILLED** | SAFE-DDSCHED (CXIV); horizon hold/ease + stakes≠DD |
| Representation Score™ / Diversity Minutes / costume≡belonging / match≡quality / empty likeness praise | **KILLED** | SAFE-ROLEMODEL (CXV); fidelity-first + competence-visible near-peers |
| Capture Score™ / Photo Minutes / OCR≡mastery / always-camera / photo→answer hero | **KILLED** | SAFE-OFFLINE (CXVI); attempt→capture→confirm + no Photomath pipe |
| Forever-E0 anxious track / day-one fade flood / Anxiety·Calm Score™ fade gates | **KILLED** | SAFE-FADEX (CXVII); protect-then-fade; no forever dump |
| Miss Streak / soft-wrong shame push / live wrong-answer stalk / empty mindset parent letter | **KILLED** | SAFE-SOFTMSG (CXVIII); grain+failure-enhancing+one CTA |
| Always-on student Map / Map Minutes·Map Score™ / mid-attempt full-graph dump | **KILLED** | SAFE-MAPORCH (CXIX); brief→grain-slice→adjust |
| Burnout Score™ / Wellness Minutes / wellness-primary under caseload spike | **KILLED** | SAFE-BURNWARN (CXX); fidelity/load→org redesign |
| Fluency≡pedagogy / Explanation·Rubric Score™ / LLM-judge-alone ship / soft-pass wrong math | **KILLED** | SAFE-EXPLAINQA (CXXI); principle-short gates + hard-fail math |
| Soft-wrong≡half-credit / Partial Credit Score™ / all-wrongs-equal / gradebook cosplay | **KILLED** | SAFE-TAXON (CXXII); type before points |
| Hours-booked crunch NS / Load Shed Score™ / infinite-availability / pour≡exam support | **KILLED** | SAFE-LOADSHED (CXXIII); acuity shed under crunch |
| Distractor Score™ / always-four≡better / beauty traps / unmapped “diagnostic” MC | **KILLED** | SAFE-DISTRACTOR (CXXIV); misconception-mapped options |
| Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence NS | **KILLED** | SAFE-CONFMISS (CXXV); CRI fork + hypercorrection priority |
| Skip-as-default / lecture-as-debrief / Microdebrief Score™ / +25% ACT debrief ads | **KILLED** | SAFE-MICRODEB (CXXVI); capped student-first micro-AAR with traces |
| 24/7 default / hours-hero crunch / fear-parent emails / Availability Score™ / silent shed | **KILLED** | SAFE-CRUNCHMSG (CXXVII); shed-honesty + thinking-minutes CBC |
| FormatTrap Score™ / seductive stem art≡FormatId / beauty visual traps / unmapped visual “diagnostic” | **KILLED** | SAFE-FORMTRAP (CXXVIII); trap-mapped FormatId distractors |
| Brief Score™ / “no time for brief” / pour-open / late-join shame / I-PASS cosplay ACT ads | **KILLED** | SAFE-MICROBRIEF (CXXIX); capped shared-model open + student synthesis |
| Chegg-hero crunch CTA / fear-countdown dump / Dual-CTA Score™ / assisted≡ready | **KILLED** | SAFE-CRUNCHCTA (CXXX); dual labeled rails + follow-on Practice |
| Fluency SVG≡keyed figure / judge-alone figure ship / Figure Key Score™ / unverified FormatId diagnostic | **KILLED** | SAFE-FIGKEY (CXXXI); structural figure verify + use gating |
| Idle spinner lobby / pour-open wait / Wait Minutes·Lobby Score™ / entertainment-primary fill | **KILLED** | SAFE-ASYNCBRIEF (CXXXII); session-related Set card + verify handoff |
| Dump-and-quit Solver close / maze handoff / Transfer Score™ / assisted≡ready | **KILLED** | SAFE-XFERGRAIN (CXXXIII); one-tap edge-matched Practice grain + solo gate |
| Tagged FormatId≡C4 / fluency eligibility / coverage-padding / HideCorrectness Score™ | **KILLED** | SAFE-HCELIG (CXXXIV); seals-first C4 eligibility; honest holes |
| Soon-default / optimistic ETA slip / apology-primary / ETA Score™ / shame feed | **KILLED** | SAFE-KNOWNETA (CXXXV); known-finite ETA + refresh honesty |
| Universal hard-gate after every hint / Gate Score™ / hint-tax shame | **KILLED** | SAFE-SOFTGATE (CXXXVI); soft-require default; conditional hard-gate + avoidance falsifiers |
| Unified sealed bank ≡ Practice+C4 / silent dual-write / auto-promote / SplitPool Score™ | **KILLED** | SAFE-SPLITPOOL (CXXXVII); graded pools; ticketed promote |
| Symbolic/Practice pad into C4 / equal-quota theater / Composition Score™ / diagnose-every-format ads | **KILLED** | SAFE-SCANCOMP (CXXXVIII); blueprint + sealed stock; labeled holes |
| Hide-holes for conversion / child-deficit shame / complete-visual ads / Hole Trust Score™ | **KILLED** | SAFE-HOLETRUST (CXXXIX); label hole + one fill CTA |
| Play-count/thumbs auto-promote / silent hcelig_pass / Promote Score™ | **KILLED** | SAFE-PROMOTE (CXL); ticketed checklist; demote faster than promote |
| Immediate same-stem C4 after reveal / forever·global cool-down / Cool-Down Score™ / pad under cool-down | **KILLED** | SAFE-COOLDOWN (CXLI); per-student cool-down + isomorphic substitutes |
| Parent-only hole honesty / fake greens / ability-shame / empty mindset poster / Student Hole Score™ | **KILLED** | SAFE-STUDHOLE (CXLII); parity honesty + one Practice CTA |
| Coming-soon / play-count fill bars / date soft-pass / FillETA Score™ | **KILLED** | SAFE-FILLETA (CXLIII); capacity-grounded verify bands |
| Always-dual / never-dual figured C4 / Dual Rater Score™ / mammography-cosplay guarantees | **KILLED** | SAFE-DUALRATE (CXLIV); risk-triggered dual; seals before second rater |
| Item_id-only cool-down / concept-wide ban / embedding-only Family Hash Score™ | **KILLED** | SAFE-FAMHASH (CXLV); sealed family compromise set |
| Anxiety·Calm·Exit Emotion Score™ / consoling ability comfort / ego Completeness % / emotion-AI exit | **KILLED** | SAFE-EXITEMO (CXLVI); destake exit + one Practice CTA |
| Dual-omitted FILLETA / ETA-skipped dual / always-dual without FTE / Dual Rater·Capacity Score™ | **KILLED** | SAFE-CAPPLAN (CXLVII); dual minutes in fill estimator |
| Forever-dual clones / silent inherit / Template Trust Score™ / FERF≡C4-ready | **KILLED** | SAFE-TMPTRUST (CXLVIII); inherit intensity not seals; sample+revoke |
| Kappa % NS / pooled repair vanity / Landis-band marketing / Dual Rater Score™ IRR | **KILLED** | SAFE-REPAIRSTRAT (CXLIX); path-stratified repair first |
| Dual Rater Score™ / Surge Hire % / Contract Minutes / unsealed freelancer dual / hospital-surge cosplay | **KILLED** | SAFE-SURGEPANEL (CL); sealed make-or-buy dual portfolio |
| Forever-trust latch / frozen sample-% / Template Trust Score™ / AQL≡ACT / CUSUM cosplay | **KILLED** | SAFE-REVOKE (CLI); revocable trust + switching sample cadence |
| Dual Shame Score™ / unconditioned dual rankings / Propensity Theater™ / case-mix cosplay | **KILLED** | SAFE-PATHBLAME (CLII); path×stratum blame before quality verdicts |
| Parallel Score™ / day-one C4 / Loom≡ready / SOW≡scaled dual | **KILLED** | SAFE-PANELRAMP (CLIII); seal literacy + shadow dual before authority |
| Demobilization Score™ / invent-work / cliff-cut / forever-panel latch | **KILLED** | SAFE-DEMOB (CLIV); planned handover + FILLETA demob honesty |
| Gold Set Score™ / open-student canaries / pooled gold vanity | **KILLED** | SAFE-GOLDSET (CLV); blind sealed gold probes |
| Generator Shame Score™ / always-rater·gen dogma / unlabeled Dual Shame / MSA cosplay | **KILLED** | SAFE-POISONSEP (CLVI); poison_source labels before escalate |
| Dual Shame / Case-Mix Score™ / hide-mix / hospital report-card cosplay / mix≡DPA | **KILLED** | SAFE-PATHMIX (CLVII); dated path-mix + routing rationale in LEA packets |
| Gold Familiarity Score™ / Tip Minutes / forever-fixed gold / CAT-security cosplay | **KILLED** | SAFE-GOLDROT (CLVIII); rotate + exposure-cap sealed gold bank |
| Forced Blame Score™ / clock≡poison / forever silent hold / GRE adjudication cosplay | **KILLED** | SAFE-AMBSEAL (CLIX); finite dual re-seal/gold SLA before poison labels |

**Implication:** Do not bet on “better explanations,” graph-file cosplay, warm-tutor theater, emotion cameras, page-count science, Ivy hire theater, unverified AI banks, FERPA-badge GTM, expanding-SRS mystique, headcount vanity, mastery fireworks, FSRS brand, cram packages, instant-feedback theater, bridge-count ads, day-one greens, format-count cosplay, parent surveillance portals, Talk Ratio theater, immersive lore-as-pedagogy, star-wall / user-count learning proof, item-count / complete-ACT coverage theater, always-full-worked / unlimited-solutions Solver theater, unlimited-hints / never-stuck answer-dump theater, DAU/streak/XP / FEI Score™ dashboard theater, unlimited free hard peeks / Hint Score™ theater, longer≡better / unlimited thorough AI essay theater, struggle-theater / blank-time / always-wait / instant-dump stall UX, fail-first / every-miss-as-PF / discovery-without-consolidation cosplay, guild / master-tutor / modeling-as-lecture / never-fade apprenticeship costume, Focus Score™ / phone-shame / mid-attempt DAU pushes, Dual Coding Score™ / always-add-picture / visual-learner meshing, Monitoring Score™ / one-scan calibration, Session ROI Score™ / tutoring-is-free, Example Timing Score™ / universal E0→E3, SRL Score™ / reflection-streak, Generative Learning Score™ / AI≡generation, Psychological Safety Score™ / Bermuda-triangle, Homework Completion Score™ / Chegg-dump, Embodiment Score™ / pose-camera, Peer Explanation Score™ / Discord≡building, Curiosity Score™ / cliffhanger-without-commit, Analogy Score™ / surface-story≡structure, Writing Score™ / Journal Minutes, Spatial Score™ / Mental Rotation Minutes, Formative Score™ / 0.4–0.7 AfL ads, Feedback Literacy Score™ / delivery≡uptake, Collaboration Score™ / Discord≡CSCL / group-correct≡ready, Desirable Difficulty Score™ / Challenge Minutes / always-ease-before-ACT / always-max-DD-until-bell / cram-week≡ready calendar theater, or Capture Score™ / Photo Minutes / OCR≡mastery / Photomath-pipe notebook AI, forever-E0 / Anxiety·Calm Score™ fade gates, Miss Streak / soft-wrong shame push parent theater, always-on Map / Map Minutes mid-attempt dumps, Burnout Score™ / wellness-primary under caseload, fluency≡pedagogy / LLM-judge-alone wrap ship, Partial Credit Score™ / all-wrongs-equal gradebook cosplay, hours-booked crunch / Load Shed Score™ / pour≡exam support, Distractor Score™ / always-four / beauty-trap MC, or Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence theater, Microdebrief Score™ / skip-as-default lecture-close, 24/7·Availability Score™ / fear-parent crunch emails, FormatTrap Score™ / beauty visual traps, Brief Score™ / pour-open / late-join shame, Chegg-hero Dual-CTA Score™, Figure Key Score™ / fluency SVG pass, Wait Minutes·Lobby Score™ / entertainment lobby, or Transfer Score™ / dump-and-quit / maze handoff, HideCorrectness Score™ / tagged≡C4 eligibility, ETA Score™ / soon-wait theater, Gate Score™ / universal hard-gate, SplitPool Score™ / silent dual-use, Composition Score™ / pad-scan theater, Hole Trust Score™ / complete-visual ads under holes, Promote Score™ / play-count flip, Cool-Down Score™ / immediate same-stem C4, or Student Hole Score™ / fake greens / parent-only honesty, FillETA Score™ / play-count fill bars / date soft-pass, Dual Rater Score™ / always-dual·never-dual / mammography cosplay, Family Hash Score™ / item_id-only·concept-wide cool-down, Exit Emotion Score™ / emotion-AI exit comfort, Capacity Score™ / ETA-skipped dual, Template Trust Score™ / silent inherit / forever-dual clones, Kappa % / pooled IRR vanity, Surge Hire % / unsealed freelancer dual / hospital-surge cosplay, forever-trust latch / frozen sample-% / Template Trust Score™ revoke theater, Dual Shame Score™ / unconditioned dual rankings, Parallel Score™ / day-one C4 panel, Demobilization Score™ / invent-work, Gold Set Score™ / open canaries, Generator Shame Score™ / unlabeled Dual Shame, Case-Mix Score™ / hide-mix packets, Gold Familiarity Score™ / forever-fixed gold, or Forced Blame Score™ / clock≡poison — subordinate UX under FEI + surviving doctrine. Bet on **FEI + pedagogy wrap + SAFE-* stack**: fear→evidence→identity, with inspectable diagnosis and surviving doctrine densifiers — not calendar theater or Score™ costumes.
...
## I.4 Surviving doctrine stack (Synthesizer merge through CLIX)
...
| **SAFE-TALK** | Construction > airtime; prompt density + constructive share + wait bands; pour-streak QA; human=AI schema | LXXXIV | Ban Talk Ratio Score™ / talk-% NS / 50/50 dogma / silence≡Socratic / got-it≡construction / AI monologue≡dialogue |
...
| **SAFE-EXPTIME** | Grain-local example↔solve timing; completion bridge; adaptive>fixed; rapid rechecks; densifies SAFE-FADE | C | Ban universal E0→E3 destiny / fixed≡adaptive / confidence≡stage / Example Timing Score™ / always-struggle-first |
| **SAFE-SRL** | Phase→control cycles; process goals; attribution→plan writeback; microanalysis>inventories; densifies MONITOR/AAR | CI | Ban SRL Score™ / reflection-streak NS / survey≡event / streak≡SRL / forethought-without-control / ability-shame reflection |
| **SAFE-GENERATE** | SOI-forcing sparse GLAs; student produces; teach-back act; guided FormatId draw; densifies EXPLAIN/DUAL/SRL/SE | CII | Ban Generative Learning Score™ / AI≡generation / teach-for-XP / eight-menu bomb / verbatim summary theater |
| **SAFE-ERRCLIMATE** | Error climate > slogan; stay-diagnose-reattempt; destake learn / keep FEI; densifies MISCON/HELP/TALK/AAR | CIII | Ban Safety Score™ / poster safe-space / Bermuda-triangle / shame reel / praise-fog≡climate |
| **SAFE-HWHELP** | Dual-rail Help vs Practice; instrumental unstuck; assisted≠solo; help recruits proof; densifies HELP/FADE/ROI | CIV | Ban Completion Score™ / Chegg-dump / assisted≡ready / Bastani Base hero / purity-ban help |
| **SAFE-GESTURE** | Strategy-tied optional gesture/draw; gesture≠action for transfer; respect non-gesturers; densifies DUAL/GENERATE/FORMAT | CV | Ban Embodiment Score™ / styles meshing / always-gesture / pose-camera / AR body≡FEI |
| **SAFE-PEERX** | Building over telling; inferential prompts; apply after explain; capture act; grain+QA; densifies GENERATE/EXPLAIN/HELP | CVI | Ban Peer Explanation Score™ / teach-for-XP / Discord≡building / AI≡peer teaching |
| **SAFE-PREDICT** | Commit before reveal; curiosity+surprise for expectancy violations; encode repair; mode gates; densifies FBTIME/MONITOR/MISCON | CVII | Ban Curiosity Score™ / cliffhanger-without-commit / postdiction / guess-for-XP / curiosity ACT ads |
| **SAFE-ANALOG** | Structure-map joins; co-present compare; student alignment; supports required; densifies BRIDGE/TRANSFER/DUAL | CVIII | Ban Analogy Score™ / mention≡pedagogy / surface-story≡structure / AI likeness dump / always-analogy |
| **SAFE-WRITE** | Short prompted WTL; cognitive+metacognitive protocols; Notes dual-rail; AI cues not authors; densifies GENERATE/SE/SRL | CIX | Ban Writing Score™ / Journal Minutes / freewrite≡learning / longer≡deeper / AI≡WTL / always-journal |
| **SAFE-SPATIAL** | Spatial via FormatId hops; conditional transfer; destake spatial anxiety; densifies FORMAT/DUAL/GESTURE/GENDER | CX | Ban Spatial Score™ / Mental Rotation Minutes / brain-training≡identity / boys-better / Spatial Personality™ |
| **SAFE-FA** | Formative cycles: evidence→adjust→close gap; exit tickets only if wired; densifies HITL/AAR/FBTIME/SRL | CXI | Ban Formative Score™ / Assessment Minutes / ticket≡learning / 0.4–0.7 ads |
| **SAFE-FBLIT** | Feedback literacy = sense+use; uptake loop; proactive recipience; densifies FBTIME/FA/EXPLAIN/HINT | CXII | Ban Feedback Literacy Score™ / Feedback Minutes / delivery≡uptake / thumbs≡used |
| **SAFE-COLLAB** | Structured collab + individual accountability + solo FEI gate; densifies PEERX/CoP/PROOF | CXIII | Ban Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready |
| **SAFE-DDSCHED** | Horizon-matched hold/ease of DD; stakes≠DD; Protect+probe final 72h; densifies DD/EXAM/SCHED/CRAM | CXIV | Ban Desirable Difficulty Score™ / Challenge Minutes / always-ease / always-max / cram≡ready |
| **SAFE-ROLEMODEL** | Fidelity-first near-peer; competence-visible attainable bios; optional preference match; densifies GENDER/ELL/TUTORGRAIN | CXV | Ban Representation Score™ / Diversity Minutes / costume≡belonging / match≡quality |
| **SAFE-OFFLINE** | Offline-first attempt; post-commit capture; verify before Map; densifies ATTN/HELP/HWHELP/PROOF/GENQ | CXVI | Ban Capture Score™ / Photo Minutes / OCR≡mastery / photo→answer hero |
| **SAFE-FADEX** | Protect-then-fade under HMA; longer E0/E1 hold without forever track; peek binge = safety behavior; densifies FADE/EXPOSE/DD | CXVII | Ban forever-E0 / day-one fade flood / Anxiety·Calm Score™ fade gates / Fade Score™ |
| **SAFE-SOFTMSG** | Grain + failure-enhancing frame + one CTA; autonomy>control; densifies PDASH/FBLIT/ERRCLIMATE/MISCON | CXVIII | Ban Miss Streak / live wrong-answer stalk / empty mindset posters / Parent Correctness Score™ |
| **SAFE-MAPORCH** | Brief→grain-slice→adjust; tutor-private default; no mid-attempt full-graph; densifies HITL/FA/ATTN/BRIDGE | CXIX | Ban always-on student Map / Map Minutes·Map Score™ / dual-screen default / ontology tour≡tutoring |
| **SAFE-BURNWARN** | Fidelity/load early-warn → org redesign; JD-R; densifies WORKFORCE/PRIVACY/ROI | CXX | Ban Burnout Score™ / Wellness Minutes / mandatory mood gate / wellness-primary under caseload |
| **SAFE-EXPLAINQA** | Principle-short rubric gates; hard-fail math/key; densifies EXPLAIN/GENQ/REPAIR | CXXI | Ban fluency≡pedagogy / Explanation·Rubric Score™ / LLM-judge-alone / soft-pass wrong math |
| **SAFE-TAXON** | Typed marks drive route+graph; soft-wrong wraps type; densifies MISCON/FBLIT/FBTIME | CXXII | Ban soft-wrong≡half-credit / Partial Credit Score™ / all-wrongs-equal / gradebook cosplay |
| **SAFE-LOADSHED** | Named exam-week pause list; acuity FEI minutes; org redesign first; densifies BURNWARN/DDSCHED/WORKFORCE/EXAM/ROI | CXXIII | Ban hours-booked crunch NS / Load Shed Score™ / infinite-availability / pour≡exam support |
| **SAFE-DISTRACTOR** | Misconception-mapped functioning distractors; function>fashion; densifies TAXON/MISCON/GENQ | CXXIV | Ban Distractor Score™ / always-four≡better / beauty traps / unmapped “diagnostic” MC |
| **SAFE-CONFMISS** | Confidence×type recovery dose; CRI fork; hypercorrection priority; densifies TAXON/CALIB/MONITOR/COLD | CXXV | Ban Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence NS |
| **SAFE-MICRODEB** | Capped student-first micro-AAR with traces; protect under LOADSHED; densifies AAR/LOADSHED/HITL/TALK/FBLIT | CXXVI | Ban skip-as-default / lecture-as-debrief / Microdebrief Score™ / +25% ACT debrief ads / vibes-only close |
| **SAFE-CRUNCHMSG** | Shed-honesty + protected thinking-minutes CBC/messages; densifies LOADSHED/WTP/SOFTMSG/PDASH/EXAM | CXXVII | Ban 24/7 default / hours-hero / fear-parent emails / silent shed / Availability Score™ |
| **SAFE-FORMTRAP** | Named format-trap visual distractors; coherent structural stems; densifies DISTRACTOR/FORMAT/DUAL/GENQ | CXXVIII | Ban FormatTrap Score™ / seductive stems / beauty visual traps / unmapped visual “diagnostic” |
| **SAFE-MICROBRIEF** | Capped shared-model open (edge/success/trap/role + synthesis); densifies AAR/MICRODEB/LOADSHED/HITL/EXPECTANCY | CXXIX | Ban “no time for brief” / pour-open / Brief Score™ / late-join shame / aviation·OR·I-PASS ACT cosplay |
| **SAFE-CRUNCHCTA** | Dual labeled Solver/Practice CTAs under crunch; instrumental verbs; fiduciary defaults; follow-on Practice; densifies HWHELP/CRUNCHMSG/HELP/DURABLE/SOFTMSG | CXXX | Ban Chegg-hero CTA / fear-countdown dump / Dual-CTA Score™ / silent Practice collapse / assisted≡ready |
| **SAFE-FIGKEY** | Structural figure key-verify for FormatId generation; deterministic spine; use gating; densifies GENQ/FORMTRAP/DUAL/COVER/EXPLAINQA | CXXXI | Ban fluency SVG pass / judge-alone figure ship / Figure Key Score™ / unverified FormatId diagnostic / FormatId-count hero |
| **SAFE-ASYNCBRIEF** | Capped async Set card on late/early wait; session-related occupied wait; if-then chip; live verify-not-replace; densifies MICROBRIEF/SRL/ATTN/LOADSHED/EXPECTANCY | CXXXII | Ban idle spinner / pour-open wait / Wait Minutes·Lobby Score™ / entertainment-primary / forced marathon Practice-before-join / late-shame feed |
| **SAFE-XFERGRAIN** | One-tap edge-matched Practice grain after instrumental Solver; short default; solo gate; SCHED return; densifies HWHELP/CRUNCHCTA/SCHED/HELP/FADE/PROOF | CXXXIII | Ban dump-and-quit / maze handoff / Transfer Score™ / assisted≡ready / marathon-after-hint / XP-for-help-without-solo |
| **SAFE-HCELIG** | Seals-first FormatId eligibility for C4; `hcelig_pass` ≠ tagged-in-bank; honest holes > pad; densifies FIGKEY/GENQ/CALIB/COLD/FORMAT/COVER/FORMTRAP | CXXXIV | Ban tagged≡C4 / fluency eligibility / coverage-padding / HideCorrectness Score™ |
| **SAFE-KNOWNETA** | Known-finite late-tutor ETA with refresh honesty; occupied wait under ASYNCBRIEF; densifies ASYNCBRIEF/MICROBRIEF/LOADSHED/EXPECTANCY | CXXXV | Ban soon-default / optimistic slip / apology-primary / ETA Score™ / tutor-shame feed |
| **SAFE-SOFTGATE** | Soft-require default after instrumental help; hard-gate only with avoidance falsifiers; densifies XFERGRAIN/HELP/CRUNCHCTA | CXXXVI | Ban universal hard-gate / Gate Score™ / Forced Follow-On % NS / hint-tax shame |
| **SAFE-SPLITPOOL** | Graded Practice-reveal vs C4 pools; no silent Map dual-write; ticketed promote; densifies HCELIG/REPAIR/GENQ/COVER | CXXXVII | Ban unified bank≡diagnose / silent dual-write / auto-promote / SplitPool Score™ |
| **SAFE-SCANCOMP** | Blueprint composition from sealed C4 stock; omit+label holes; densifies HCELIG/SPLITPOOL/COVER/FORMAT | CXXXVIII | Ban symbolic pad / equal-quota theater / Composition Score™ / diagnose-every-format ads |
| **SAFE-HOLETRUST** | Parent hole honesty: label + seal reason + one fill CTA; densifies SCANCOMP/PDASH/COVER/WTP/SOFTMSG | CXXXIX | Ban hide-holes / child-deficit shame / complete-visual ads / Hole Trust Score™ |
| **SAFE-PROMOTE** | Ticketed Practice→C4 QA checklist + seals re-verify; demote faster than promote; densifies SPLITPOOL/REPAIR/FIGKEY/HCELIG/COVER | CXL | Ban play-count/thumbs auto-promote / silent hcelig_pass / Promote Score™ |
| **SAFE-COOLDOWN** | Per-student cool-down after reveal before same-family C4; isomorphic substitutes then holes; densifies SPLITPOOL/SCANCOMP/CALIB/COLD | CXLI | Ban immediate same-stem C4 / forever·global lock default / Cool-Down Score™ / pad under cool-down |
| **SAFE-STUDHOLE** | Student hole parity with HOLETRUST; product-hole frame; one Practice CTA; no fake greens; densifies HOLETRUST/COLD/CALIB/SOFTMSG/FBLIT | CXLII | Ban parent-only honesty / fake greens / ability shame / empty mindset poster / Student Hole Score™ |
| **SAFE-FILLETA** | Capacity-grounded finite fill bands; no play-count progress; no date soft-pass seals; densifies PROMOTE/KNOWNETA/HOLETRUST/STUDHOLE | CXLIII | Ban coming-soon / play-count fill bars / FillETA Score™ / complete-visual-by-date |
| **SAFE-DUALRATE** | Risk-triggered second rater; seals before dual; disagreement→reject/repair; densifies PROMOTE/FIGKEY/HITL/FILLETA | CXLIV | Ban always-dual / never-dual / Dual Rater Score™ / mammography-cosplay ACT ads |
| **SAFE-FAMHASH** | Sealed isomorphic family as cool-down compromise unit; substitutes outside family; densifies COOLDOWN/GENQ/FIGKEY/SCANCOMP | CXLV | Ban item_id-only / concept-wide ban / embedding-only Family Hash Score™ |
| **SAFE-EXITEMO** | Destake gap-scan exit copy; task/process + one CTA; no mood telemetry; densifies STUDHOLE/PRIVACY/EXPOSE/SOFTMSG | CXLVI | Ban Anxiety·Calm·Exit Emotion Score™ / consoling ability comfort / ego Completeness % / emotion-AI exit |
| **SAFE-CAPPLAN** | Dual minutes as first-class FILLETA capacity line; headroom; label dual scarcity; densifies DUALRATE/FILLETA/WORKFORCE | CXLVII | Ban dual-omitted ETA / ETA-skipped dual / always-dual without FTE / Dual Rater·Capacity Score™ |
| **SAFE-TMPTRUST** | Blueprint dual once; inherit single-rater under sealed sameness + sample audit + revoke; densifies DUALRATE/FAMHASH/FIGKEY/CAPPLAN | CXLVIII | Ban forever-dual clones / silent inherit / Template Trust Score™ / FERF≡C4-ready |
| **SAFE-REPAIRSTRAT** | Path-stratified post-promote repair + contingency drill-downs; κ aide not NS; densifies DUALRATE/PROMOTE/INSTRUMENT/TMPTRUST | CXLIX | Ban Kappa % NS / pooled repair vanity / Landis-band marketing / Dual Shame boards |
| **SAFE-SURGEPANEL** | Make-or-buy dual portfolio with seals, parallel-run, demobilization honesty; densifies CAPPLAN/LOADSHED/WORKFORCE/DUALRATE | CL | Ban Surge Hire % / unsealed freelancer dual / always-hire·contract dogma / hospital-surge cosplay |
| **SAFE-REVOKE** | Revocable template-trust + switching sample cadence under repair spikes; densifies TMPTRUST/REPAIRSTRAT/CAPPLAN | CLI | Ban forever-trust latch / frozen sample-% / Template Trust Score™ / AQL≡ACT / CUSUM cosplay |
| **SAFE-PATHBLAME** | Path×stratum blame before dual/single quality verdicts; densifies REPAIRSTRAT/DUALRATE/CAPPLAN | CLII | Ban Dual Shame Score™ / unconditioned rankings / Propensity Theater™ / case-mix cosplay |
| **SAFE-PANELRAMP** | Seal literacy → shadow dual → graduate before contract C4; densifies SURGEPANEL/FIGKEY/DUALRATE/CAPPLAN | CLIII | Ban Parallel Score™ / day-one C4 / Loom≡ready / SOW≡scaled dual |
| **SAFE-DEMOB** | Planned post-spike dual wind-down with handover, capture, FILLETA demob honesty; densifies SURGEPANEL/WORKFORCE/REPAIRSTRAT | CLIV | Ban Demobilization Score™ / invent-work / cliff-cut / forever-panel latch |
| **SAFE-GOLDSET** | Blind sealed gold probes for path×stratum monitor integrity; densifies PATHBLAME/REPAIRSTRAT/INSTRUMENT | CLV | Ban Gold Set Score™ / open-student canaries / pooled gold vanity |
| **SAFE-POISONSEP** | Label generator vs rater vs ambiguous poison on inherit repair before escalate; densifies REVOKE/PATHBLAME/GENQ | CLVI | Ban Generator Shame Score™ / always-rater·gen dogma / unlabeled Dual Shame / MSA cosplay |
| **SAFE-PATHMIX** | Dated path-mix + routing rationale in LEA trust packets; Kane L1/L2 ambition; densifies PATHBLAME/PROCURE/HOLETRUST | CLVII | Ban Dual Shame Score™ / Case-Mix Score™ / hide-mix / hospital report-card cosplay / mix≡DPA |
| **SAFE-GOLDROT** | Rotate + exposure-cap sealed gold bank against tip/familiarity; densifies GOLDSET/REVOKE/PANELRAMP | CLVIII | Ban Gold Familiarity Score™ / Tip Minutes / forever-fixed gold / CAT-security cosplay |
| **SAFE-AMBSEAL** | Finite dual re-seal/gold SLA for ambiguous poison tickets; densifies POISONSEP/GOLDSET/DUALRATE/CAPPLAN | CLIX | Ban Forced Blame Score™ / clock≡poison / forever silent hold / GRE adjudication cosplay |
| **SAFE-MIXREFRESH** *(provisional)* | Event+calendar path-mix refresh / stale labels after DEMOB·CAPPLAN flips; densifies PATHMIX/DEMOB/CAPPLAN | CLX | Ban Mix Freshness Score™ / forever-green surge mix / silent demob / hospital-lag cosplay |
...
**Merged / demoted (do not treat as separate products):** “AI tutor,” “mastery path,” “growth mindset,” “engagement,” “grit,” “habit streak,” “celebrate mistakes,” “community of practice,” “deliberate practice brand,” “film study,” “recital,” “grandmaster review,” “exposure therapy,” “girl STEM brand,” “WTP survey,” “Identity Score™,” “8-week math person,” “character equity,” “knowledge-graph moat,” “emotion AI empathy,” “science-backed page count,” “Ivy tutor SKU,” “AI wrote N questions,” “FERPA-compliant badge,” “perfect-interval SRS,” “tutor headcount / retention-%,” “mastery fireworks / personal Ebbinghaus,” “FSRS/Anki brain optimizer,” “cram/bootcamp/+points packages,” “instant feedback AI / always-delay science,” “bridge-count / we connect everything,” “day-one personalized mastery / placement belt,” “every format / visual learning / Format Personality™,” “parent fireworks portal / Family Leaderboard / live wrong-answer stalk,” “immersive story world / lore engagement / Story Engagement Score™,” “user-count / star-wall / vague confidence testimonials as learning proof,” “item-count / complete ACT bank / AI fills all holes coverage theater,” “always-full-worked / unlimited solutions / never-fade Solver,” “unlimited hints / never stuck / Help Score™,” “DAU/streak/XP North Star / FEI Score™ / thumbs-up≡learning,” “unlimited free hard peeks / Hint Score™ / XP-for-hints / perfect-hint AI,” “longer≡better / Explanation Score™ / unlimited thorough AI essays / monologue≡SE,” “maximize productive struggle minutes / Struggle Score™ / blank-time grit / always-wait / never-stuck dump,” “fail-first always / every miss is productive failure / PF Score™ / discovery-without-consolidation,” “guild / master tutor / cognitive apprenticeship™ costume / Apprenticeship Score™ / modeling-minutes / never-fade coach,” “Focus Score™ / deep-work theater / phone-shame / mid-attempt streak pings / multitasking digital-native talent,” “Dual Coding Score™ / always-add-picture / decoration-as-dual-coding / visual-learner meshing / animation-first multimedia / split-legend density theater,” and “Monitoring Score™ / metacognition-without-control / easy-only calibration / one-scan calibration theater,” and “AI-replaces-tutors / tutoring-is-free / unlimited-human / hours-booked / Session ROI Score™ theater,” and “SRL Score™ / reflection-streak / survey-SRL≡event / streak≡self-regulation theater,” and “universal E0→E3 destiny / Example Timing Score™ / fixed≡adaptive fade costume,” and “Generative Learning Score™ / AI≡generation / teach-for-XP / eight-strategy GLA bomb,” and “Psychological Safety Score™ / poster safe-space / Bermuda-triangle / praise-fog climate,” and “Homework Completion Score™ / tonight-% / Chegg-dump / assisted≡ready / purity-ban help,” and “Embodiment Score™ / kinesthetic styles / always-gesture / pose-camera AI,” and “Peer Explanation Score™ / teach-for-XP / Discord≡knowledge-building / AI≡peer teaching,” and “Curiosity Score™ / cliffhanger-without-commit / postdiction / guess-for-XP / instant-reveal entertainment,” and “Analogy Score™ / Mapping Minutes / mention≡pedagogy / surface-story≡structure / AI likeness dump,” and “Writing Score™ / Journal Minutes / freewrite≡learning / longer≡deeper / AI≡WTL,” and “Spatial Score™ / Mental Rotation Minutes / brain-training≡identity / Spatial Personality™,” and “Formative Score™ / Assessment Minutes / exit-ticket≡learning / 0.4–0.7 AfL ads,” and “Feedback Literacy Score™ / Feedback Minutes / delivery≡uptake / thumbs≡used,” and “Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready,” and “Desirable Difficulty Score™ / Challenge Minutes / always-ease-before-ACT / always-max-DD / cram-week≡ready,” and “Representation Score™ / Diversity Minutes / costume≡belonging / match≡quality,” and “Capture Score™ / Photo Minutes / OCR≡mastery / photo→answer / Photomath-pipe,” and “forever-E0 anxious track / Anxiety·Calm Score™ fade gates / Fade Score™,” and “Miss Streak / soft-wrong shame push / live wrong-answer stalk / empty mindset parent letter,” and “always-on Map / Map Minutes·Map Score™ / mid-attempt full-graph,” and “Burnout Score™ / Wellness Minutes / wellness-primary under caseload,” and “fluency≡pedagogy / Explanation·Rubric Score™ / LLM-judge-alone wrap ship,” and “Partial Credit Score™ / soft-wrong≡half-credit / all-wrongs-equal gradebook,” and “hours-booked crunch / Load Shed Score™ / pour≡exam support,” and “Distractor Score™ / always-four / beauty-trap MC,” and “Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence,” and “Microdebrief Score™ / Debrief Minutes / skip-as-default lecture-close,” and “24/7 availability default / hours-hero crunch / fear-parent emails / Availability Score™ / silent shed,” and “FormatTrap Score™ / Visual Distractor Minutes / seductive stems / beauty visual traps / unmapped visual diagnostic,” and “Brief Score™ / Brief Minutes / Opening Streak / no-time-for-brief / pour-open / late-join shame / I-PASS cosplay ACT ads,” and “Chegg-hero crunch CTA / finish-tonight primary / fear-countdown dump / Dual-CTA Score™ / Help Tonight Minutes / silent Practice collapse / assisted≡ready,” and “fluency SVG≡keyed figure / LLM-as-judge-alone figure ship / Figure Key Score™ / Visual QA Minutes / unverified FormatId diagnostic / FormatId-count or AI-drew-N-diagrams hero / soft-pass wrong geometry,” and “Wait Minutes / Lobby Score™ / Prebrief Streak / idle spinner / pour-open wait / entertainment-primary fill,” and “dump-and-quit Solver close / maze handoff / Transfer Score™ / Handoff Minutes / Follow-on Streak / assisted≡ready / marathon-after-hint / XP-for-help-without-solo,” and “universal hard-gate after every hint / Gate Score™ / Forced Follow-On % / hint-tax shame / ignore help-avoidance when Forced % rises,” and “hide-format_not_probed for conversion / child-deficit visual-hole shame / complete-visual ads under holes / Hole Trust Score™ / Coverage Satisfaction / Honesty Minutes / fear-scarcity hole WTP,” and “play-count/thumbs auto-promote / silent hcelig_pass / fluency soft-pass promote / Promote Score™ / QA Minutes / Promotion Throughput %,” and “immediate same-stem C4 after reveal / forever·global cool-down lock / Cool-Down Score™ / Exposure Minutes / Lock Duration % / pad under cool-down,” and “parent-only hole honesty / fake greens for not_probed / ability-shame hole frames / empty growth-mindset poster without CTA / Student Hole Score™ / Completeness % / Honesty Minutes / absence≡mastery,” and “coming-soon / play-count fill bars / date soft-pass / FillETA Score™,” and “always-dual / never-dual / Dual Rater Score™ / mammography cosplay,” and “item_id-only cool-down / concept-wide ban / Family Hash Score™,” and “Anxiety·Calm·Exit Emotion Score™ / consoling ability comfort / emotion-AI exit,” and “dual-omitted FILLETA / ETA-skipped dual / Capacity Score™,” and “forever-dual clones / silent inherit / Template Trust Score™,” and “Kappa % NS / pooled repair vanity / Landis-band marketing,” and “Surge Hire % / Contract Minutes / unsealed freelancer dual / hospital-surge cosplay” are *not* independent North Stars — they are subordinate UX under FEI + the rows above (borrow *method*, never *costume*). Also demoted under v1.20: forever-trust latch / frozen sample-% / Template Trust Score™·Sample Dual %·Revoke Minutes, Dual Shame Score™ / Selection-Adjusted Repair % / Path Blame Minutes / Propensity Theater™, Parallel Score™ / Onboard Minutes / Ramp % / day-one C4, Demobilization Score™ / Idle Minutes / invent-work / cliff-cut, Gold Set Score™ / Canary Minutes / open-student canaries, Generator Shame Score™ / Rater Poison Minutes / unlabeled Dual Shame / MSA cosplay, Case-Mix Score™ / Path Mix Minutes / hide-mix-for-conversion / hospital report-card cosplay, Gold Familiarity Score™ / Tip Minutes / forever-fixed gold / CAT-security cosplay, Forced Blame Score™ / Ambiguous Minutes / Decision Velocity % / clock≡poison / GRE adjudication cosplay.

**Next research bottleneck:** Part CLXI **Panel-cohort gold hygiene audits during parallel-run**. Company law through SAFE-AMBSEAL (CLIX / v1.20); SAFE-MIXREFRESH (CLX) provisional. Experiment families …/**PATHMIX**/**GOLDROT**/**AMBSEAL**/**MIXREFRESH** gate claims above L1. Researcher count since v1.20 synthesizer = **1**.
---
...
|------|---------|------|--------|
| 2026-08-17 | SAFE-MIXREFRESH: Path-mix packet refresh cadence after surge demobilization; kill Mix Freshness Score™ / forever-green surge mix / silent demob / hospital-lag cosplay | Evidence | MIXREFRESH-1…5; next = CLXI panel gold hygiene |
| 2026-08-17 | Synthesizer v1.20: merge CLI–CLIX SAFE-* into I.4; kills #105–#113 | Synthesis | Surviving commercial law; next = CLX path-mix refresh |
| 2026-08-17 | SAFE-AMBSEAL: Ambiguous-ticket dual re-seal SLA before poison labels; kill Forced Blame Score™ / clock≡poison / GRE adjudication cosplay | Evidence | AMBSEAL-1…5; next = CLX path-mix refresh |
| 2026-08-16 | SAFE-GOLDROT: Gold-bank rotation & tip-resistance under rater familiarity; kill Gold Familiarity Score™ / forever-fixed gold / CAT-security cosplay | Evidence | GOLDROT-1…5; next = CLIX ambiguous dual re-seal |
| 2026-08-16 | SAFE-PATHMIX: LEA packet path-mix honesty without Dual Shame theater; kill Dual Shame / Case-Mix Score™ / hide-mix / hospital report-card cosplay | Evidence | PATHMIX-1…5; next = CLVIII gold-bank rotation |
| 2026-08-16 | SAFE-POISONSEP: Generator vs rater poison separation on inherit repair; kill Generator Shame Score™ / always-rater·gen / unlabeled Dual Shame / MSA cosplay | Evidence | POISONSEP-1…5; next = CLVII LEA path-mix honesty |
| 2026-08-16 | SAFE-GOLDSET: Gold-set planted probes for path×stratum monitors; kill Gold Set Score™ / open-student canaries / pooled gold vanity | Evidence | GOLDSET-1…5; next = CLVI generator vs rater poison |
| 2026-08-16 | SAFE-DEMOB: Post-spike dual demobilization without fidelity cliff; kill Demobilization Score™ / invent-work / cliff-cut / forever-panel latch | Evidence | DEMOB-1…5; next = CLV gold-set path×stratum probes |
| 2026-08-16 | SAFE-PANELRAMP: Contract SME panel seal onboarding & parallel-run gates; kill Parallel Score™ / day-one C4 / Loom≡ready / SOW≡scaled dual | Evidence | PANELRAMP-1…5; next = CLIV post-spike demobilization |
| 2026-08-15 | SAFE-TMPTRUST: Template-trust inheritance after first-of-cell dual; kill forever-dual clones / silent inherit / Template Trust Score™ / FERF≡C4-ready | Evidence | TMPTRUST-1…5; next = CXLIX post-promote repair dashboards |
| 2026-08-15 | SAFE-REPAIRSTRAT: Post-promote repair stratified dashboards; kill Kappa % NS / pooled repair vanity / Landis-band marketing | Evidence | REPAIRSTRAT-1…5; next = CL dual-capacity hire panels |
| 2026-08-15 | SAFE-PATHBLAME: Path-conditioned dual blame tests (selection vs quality); kill Dual Shame Score™ / unconditioned dual rankings / Propensity Theater™ / case-mix cosplay | Evidence | PATHBLAME-1…5; next = CLIII contract SME panel onboarding |
| 2026-08-15 | SAFE-REVOKE: Template-trust revoke & sample-dual cadence under repair spikes; kill forever-trust latch / frozen sample-% / Template Trust Score™ / AQL≡ACT / CUSUM cosplay | Evidence | REVOKE-1…5; next = CLII path-conditioned dual blame |
| 2026-08-15 | SAFE-SURGEPANEL: Dual-capacity hire vs contract SME panels under exam spikes; kill Surge Hire % / unsealed freelancer dual / hospital-surge cosplay | Evidence | SURGEPANEL-1…5; next = CLI template-trust revoke cadence |
| 2026-08-15 | SAFE-CAPPLAN: Dual-rater capacity planning vs FILLETA band honesty; kill dual-omitted ETA / ETA-skipped dual / always-dual without FTE / Dual Rater Score™ | Evidence | CAPPLAN-1…5; next = CXLVIII template-trust inheritance |
| 2026-08-14 | SAFE-EXITEMO: Gap-scan exit emotion without Anxiety Score™; kill Anxiety/Calm/Exit Emotion Score™ / consoling comfort / ego Completeness % / emotion-AI exit | Evidence | EXITEMO-1…5; next = CXLVII dual-rater capacity × FILLETA |
| 2026-08-14 | SAFE-FAMHASH: Isomorphic stem-family hashing for cool-down; kill item_id-only / concept-wide ban / embedding-only Family Hash Score™ | Evidence | FAMHASH-1…5; next = CXLVI gap-scan exit emotion |
| 2026-08-14 | SAFE-DUALRATE: Second-rater thresholds for figured C4 admits; kill always-dual / never-dual / Dual Rater Score™ / mammography-cosplay guarantees | Evidence | DUALRATE-1…5; next = CXLV isomorphic cool-down hashing |
| 2026-08-14 | SAFE-FILLETA: Promote backlog SLA vs parent hole-ETA honesty; kill coming-soon / play-count fill bars / date soft-pass / FillETA Score™ | Evidence | FILLETA-1…5; next = CXLIV second-rater thresholds |
| 2026-08-15 | Synthesizer v1.19: merge CXLIII–CL SAFE-* into I.4; kills #97–#104 | Synthesis | Surviving commercial law; next = CLI template-trust revoke |
| 2026-08-14 | Synthesizer v1.18: merge CXXXIV–CXLII SAFE-* into I.4; kills #88–#96 | Synthesis | Surviving commercial law; next = CXLIII promote backlog SLA |
| 2026-08-14 | SAFE-STUDHOLE: Student-facing hole copy after gap-scan; kill parent-only honesty / fake greens / ability shame / empty mindset poster / Student Hole Score™ | Evidence | STUDHOLE-1…5; next = CXLIII promote backlog SLA |
| 2026-08-13 | SAFE-COOLDOWN: Exposure cool-down after reveal before same-stem C4; kill immediate same-stem C4 / Cool-Down Score™ / pad under cool-down | Evidence | COOLDOWN-1…5; next = CXLII student-facing hole copy |
| 2026-08-13 | SAFE-PROMOTE: Promote-to-C4 tutor QA for Practice-only FormatId; kill play-count/thumbs auto-promote / silent hcelig_pass / Promote Score™ | Evidence | PROMOTE-1…5; next = CXLI exposure cool-down |
| 2026-08-13 | SAFE-HOLETRUST: Parent trust copy when visual diagnostic holes remain; kill hide-holes / shame frames / complete-visual ads / Hole Trust Score™ | Evidence | HOLETRUST-1…5; next = CXL promote-to-C4 tutor QA |
| 2026-08-13 | SAFE-SCANCOMP: FormatId gap-scan composition under sealed-stock scarcity; kill symbolic pad / equal-quota theater / Composition Score™ / all-formats ads under thin C4 | Evidence | SCANCOMP-1…5; next = CXXXIX parent trust copy when visual holes remain |
| 2026-08-13 | SAFE-SPLITPOOL: Reveal-Practice vs C4 split pools for sealed FormatId; kill unified dual-use / silent Map writes / auto-promote / SplitPool Score™ | Evidence | SPLITPOOL-1…5; next = CXXXVIII FormatId gap-scan composition |
| 2026-08-13 | SAFE-SOFTGATE: soft-require vs hard-gate follow-on under help-avoidance; kill universal hard-gate / Gate Score™ / hint-tax shame | Evidence | SOFTGATE-1…5; next = CXXXVII Reveal-Practice vs C4 split pools |
| 2026-08-13 | SAFE-KNOWNETA: known-finite ETA honesty in late-tutor lobby; kill soon-default / optimistic slip / apology-primary / ETA Score™ / shame feed | Evidence | KNOWNETA-1…5; next = CXXXVI soft-require vs hard-gate transfer |
| 2026-08-13 | SAFE-HCELIG: hide-correctness FormatId eligibility gates; kill tagged≡C4 / fluency eligibility / coverage-padding / HideCorrectness Score™ | Evidence | HCELIG-1…5; next = CXXXV known-finite ETA lobby |
| 2026-08-12 | Synthesizer v1.17: merge CXXVI–CXXXIII SAFE-* into I.4; kills #80–#87 | Synthesis | Surviving commercial law; next = CXXXIV hide-correctness FormatId eligibility |
| 2026-08-12 | SAFE-XFERGRAIN: one-tap Solver→Practice transfer grain; kill dump-and-quit / maze handoff / Transfer Score™ / assisted≡ready / marathon-after-hint | Evidence | XFERGRAIN-1…5; next = CXXXIV hide-correctness FormatId eligibility |
| 2026-08-12 | SAFE-ASYNCBRIEF: async pre-brief cards on late/early wait; kill idle spinner / pour-open wait / Wait Minutes·Lobby Score™ / entertainment-primary / Practice-before-join marathon | Evidence | ASYNCBRIEF-1…5; next = CXXXIII one-tap Solver→Practice transfer |
| 2026-08-12 | SAFE-FIGKEY: figure key-verify loops for generated FormatId stems; kill fluency SVG≡keyed / judge-alone ship / Figure Key Score™ / unverified FormatId diagnostic | Evidence | FIGKEY-1…5; next = CXXXII async pre-brief cards |
| 2026-08-12 | SAFE-CRUNCHCTA: dual-rail Solver CTA copy under crunch; kill Chegg-hero CTA / fear-countdown dump / Dual-CTA Score™ / silent Practice collapse / assisted≡ready | Evidence | CRUNCHCTA-1…5; next = CXXXI figure key-verify loops |
| 2026-08-12 | SAFE-MICROBRIEF: session-open brief fidelity under late joins; kill no-time-for-brief / pour-open / Brief Score™ / late-join shame / I-PASS cosplay ACT ads | Evidence | MICROBRIEF-1…5; next = CXXX dual-rail Solver CTA under crunch |
| 2026-08-12 | SAFE-FORMTRAP: format-trap distractors on diagram/graph items; kill FormatTrap Score™ / seductive stems / beauty visual traps / unmapped visual diagnostic | Evidence | FORMTRAP-1…5; next = CXXIX session-open brief fidelity |
| 2026-08-11 | SAFE-CRUNCHMSG: parent crunch-week message tests; kill 24/7 default / hours-hero / fear-parent emails / Availability Score™ | Evidence | CRUNCHMSG-1…5; next = CXXVIII format-trap distractors |
| 2026-08-11 | SAFE-MICRODEB: tutor micro-debrief fidelity under time caps; kill skip-as-default / lecture-as-debrief / Microdebrief Score™ / +25% ACT debrief ads | Evidence | MICRODEB-1…5; next = CXXVII parent crunch-week message tests |
| 2026-08-11 | Synthesizer v1.16: merge CXVII–CXXV SAFE-* into I.4; kills #71–#79 | Synthesis | Surviving commercial law; next = CXXVI tutor micro-debrief fidelity |
| 2026-08-11 | SAFE-CONFMISS: confidence-tagged gap-scan miss recovery; kill Identity Score™ / equal-weight recovery / inflate-confidence NS | Evidence | CONFMISS-1…5; next = CXXVI tutor micro-debrief fidelity |
| 2026-08-11 | SAFE-TAXON: typed soft-wrong mark taxonomy; kill Partial Credit Score™ / all-wrongs-equal / gradebook cosplay | Evidence | TAXON-1…5; next = CXXIII exam-week load shedding |
| 2026-08-11 | SAFE-DISTRACTOR: misconception-mapped MC distractors; kill Distractor Score™ / always-four / beauty traps / unmapped “diagnostic” | Evidence | DISTRACTOR-1…5; next = CXXV confidence-tagged gap-scan misses |
| 2026-08-11 | SAFE-LOADSHED: exam-week tutor load shedding; kill hours-booked crunch NS / infinite-availability / pour≡exam support | Evidence | LOADSHED-1…5; next = CXXIV distractor design |
| 2026-08-11 | SAFE-EXPLAINQA: principle-short QA gates for AI coach wraps; kill fluency≡pedagogy / Explanation Score™ | Evidence | EXPLAINQA-1…5; next = CXXII soft-wrong taxonomy |
| 2026-08-10 | SAFE-MAPORCH: brief→grain-slice→adjust Map timing; kill always-on / Map Minutes / mid-attempt full-graph | Evidence | MAPORCH-1…5; next = CXX tutor burnout early-warning |
...
| 2026-08-10 | SAFE-DDSCHED: horizon-matched DD hold/ease; kill Desirable Difficulty Score™ / always-ease / always-max / cram≡ready | Evidence | DDSCHED-1…5; next = CXV tutor identity & belonging |
| 2026-08-09 | SAFE-COLLAB: structured collab + solo FEI gate; kill Collaboration Score™ / Discord≡CSCL / group-correct≡ready | Evidence | COLLAB-1…5; next = CXIV DD under exam deadlines |
| 2026-08-09 | SAFE-FBLIT: feedback literacy = sense+use; kill Feedback Literacy Score™ / delivery≡uptake / thumbs≡used | Evidence | FBLIT-1…5; next = CXIII collaborative vs solo FEI |
...
| MAPORCH-* | Grain-slice vs full-graph / tutor-private vs dual-screen / brief+between-attempt vs always-on / bridge slice vs red gallery / CBC timed Map | CXIX |
...
| ANALOG-* | Co-present structure-map vs sequential re-teach / high-support cues vs bare compare / student map vs AI likeness / story-skin vs structure / always vs severity-gated | CVIII |
| WRITE-* | Short prompted protocol vs none vs long freewrite / cognitive+meta vs meta-only / student draft vs AI polish / written vs oral / weekly chips vs diary streak | CIX |
| SPATIAL-* | FormatId-embedded hop vs isolated rotation gym / scaffolded vs flood / destake vs ability-shame / boys-better costume A/B | CX |
| FA-* | Wired exit vs XP ticket / evidence→adjust vs got-it theater / FEI vs Formative Score™ / HITL cycle QA | CXI |
| FBLIT-* | Uptake gate vs essay+thumbs / decodeable vs jargon / affect-managed vs ego / compare-chip vs reveal-only | CXII |
| COLLAB-* | Scripted+solo-gate vs solo-only / open room vs roles / shared unlock vs solo unlock / accountability vs team XP | CXIII |
| DDSCHED-* | Hold-mix vs ease-blocked last 14d / Protect+probe 72h vs scored flood / horizon ISI vs cram / dual-rail vs single scored calendar | CXIV |
| ROLEMODEL-* | Competence-visible bio vs demographic-only / preference match vs random-qualified / attainable vs superstar / belonging brief / parent likeness copy | CXV |
| OFFLINE-* | Offline-first vs always-camera / post-commit capture vs mid-solve phone / OCR-confirm vs auto-green / photo→coach vs photo→answer / parent CBC paper-proof | CXVI |
| BURNWARN-* | Fidelity/load early-warn vs wellness-primary / caseload redesign vs mood gate / coach-capacity hire / parent CBC fidelity honesty | CXX |
| EXPLAINQA-* | Principle-short rubric gate vs fluency / human audit vs LLM-judge-alone / soft-wrong short mark / parent CBC clear-short | CXXI |
| TAXON-* | Typed soft-wrong vs binary / type-conditioned deltas / step-join mark / parent categorical vs % / auto-type+audit | CXXII |
| LOADSHED-* | Acuity queue+pause list vs hours-booked / org redesign vs wellness-primary / dual-rail crunch / parent CBC shed honesty | CXXIII |
| DISTRACTOR-* | Mapped 3-option vs unmapped 4 / retire dead options / GENQ distractor-seal / theory-named soft-wrong / parent CBC grain-from-option | CXXIV |
| CONFMISS-* | Class-conditioned recovery vs equal deck / high-conf springboard priority / easy-vs-probe collision / parent CBC grain vs Personality™ / conf×type severity | CXXV |
| MICRODEB-* | Capped micro-AAR vs skip / student-first vs lecture-close / traces vs vibes / LOADSHED protect / parent CBC brief-close | CXXVI |
| CRUNCHMSG-* | Shed-honesty vs 24/7 CBC / thinking-minutes vs hours-hero / fear vs fiduciary / silent shed vs named pause / parent CBC crunch copy | CXXVII |
| FORMTRAP-* | Trap-mapped visual distractors vs beauty stems / conversion route vs topic-only / GENQ trap seal / parent CBC format-miss honesty | CXXVIII |
| MICROBRIEF-* | Capped shared-model open vs pour / late-join brief vs skip / student synthesis / AAR Set pair / parent CBC goals-before-problems | CXXIX |
| CRUNCHCTA-* | Dual labeled rails vs Chegg-hero / follow-on Practice vs dump-quit / fiduciary default / fear-countdown vs calm dual / parent CBC help+gym | CXXX |
| FIGKEY-* | Structural figure verify vs fluency SVG / use-gate vs unverified diagnostic / judge-alone reject / stem∧key constraints / parent CBC keyed figures | CXXXI |
| ASYNCBRIEF-* | Occupied Set wait vs spinner / if-then chip / verify-not-replace / no entertainment-primary / parent CBC waiting-as-prep | CXXXII |
| XFERGRAIN-* | One-tap same-edge grain vs dump-quit / short vs maze / solo gate / SCHED return / parent CBC help-then-prove | CXXXIII |
| HCELIG-* | HCELIG-pass-only C4 vs mixed tagged / Practice-vs-C4 tier / honest holes vs pad / graphicacy label / parent CBC sealed visuals | CXXXIV |
| KNOWNETA-* | Finite ETA vs soon / optimistic slip vs refresh / apology-only vs duration / shame feed vs neutral / parent CBC wait honesty | CXXXV |
| SOFTGATE-* | Soft-require vs hard-gate / avoidance falsifier / autonomy copy / short hard-gate only / parent CBC no-hint-tax | CXXXVI |
| SPLITPOOL-* | Split pools vs unified dual-use / silent Map block / ticketed promote / coverage tables by use / parent CBC Practice≠C4 | CXXXVII |
| SCANCOMP-* | Sealed-only compose vs pad / omit+label vs quota theater / depth-where-stock / exposure caps / parent CBC holes-as-features | CXXXVIII |
| HOLETRUST-* | Label+CTA vs hide / shame vs product-hole / complete-visual ads vs honesty / fear WTP vs fiduciary / parent CBC hole copy | CXXXIX |
| PROMOTE-* | Ticket+checklist vs play-count / demote-on-repair / second-rater triggers / fluency soft-pass ban / parent CBC fill path | CXL |
| COOLDOWN-* | Cool-down bar vs immediate same-stem / isomorphic substitutes / holes under empty cell / duration band / parent CBC memory≠diagnosis | CXLI |
| STUDHOLE-* | Student parity vs parent-only / fake greens vs chips / ability shame vs product-hole / mindset poster vs CTA / student CBC hole copy | CXLII |
| FILLETA-* | Capacity fill band vs soon / conservative vs optimistic slip / Practice CTA / ticket-state vs play-count bar / parent CBC verify honesty | CXLIII |
| DUALRATE-* | Triggered dual vs always/never / consensus vs either-admit / T1 vs T1∧T2 / IRR sample cadence / parent CBC dual honesty vs hospital cosplay | CXLIV |
| FAMHASH-* | Family vs item_id / narrow vs concept-wide / embed-auto vs SME seal / R2 on-off / parent CBC same-family honesty | CXLV |
| EXITEMO-* | Destake exit vs Anxiety Score™ / ability comfort vs strategy CTA / Completeness % / emotion-AI exit / parent-student CBC | CXLVI |
| CAPPLAN-* | Dual-aware FILLETA vs fantasy / util headroom / named dual constraint / always-dual@fixed FTE / parent CBC dual-honest band | CXLVII |
| TMPTRUST-* | Inherit+sample vs forever-dual / silent inherit / T5-only vs T1 clear / sample % / parent CBC blueprint honesty | CXLVIII |
| REPAIRSTRAT-* | Path-stratified repair vs pooled κ / contingency drill-down / inherit discord revoke / windowed drift / parent CBC no Kappa % ads | CXLIX |
| SURGEPANEL-* | Hire vs contract dual / parallel-run gate / dual_source repair / FILLETA surge label / demobilization without invent-work | CL |
| REVOKE-* | Revoke-on-repair vs soft-investigate / switching sample vs frozen % / Shewhart vs CUSUM trip / re-qualify paths / parent CBC pause honesty | CLI |
| PATHBLAME-* | Path×stratum repair vs pooled / selection narrative / Dual Shame ban / CAPPLAN cite conditioned / parent CBC harder-tickets-get-check | CLII |
| PANELRAMP-* | Seal literacy / shadow dual / graduate gate / FILLETA contract_ramp / DRIFT sample | CLIII |
| DEMOB-* | Planned handover / invent-work ban / capture gate / FILLETA demob / post-exit repair window | CLIV |
| GOLDSET-* | Blind sealed gold probes; path×stratum hit/miss; student firewall; no Gold Set Score™ | CLV |
| POISONSEP-* | Generator vs rater vs ambiguous poison labels; no Generator Shame Score™ | CLVI |
| PATHMIX-* | Dated LEA path-mix + routing rationale; no Dual Shame / Case-Mix Score™ | CLVII |
| MIXREFRESH-* | Path-mix vintage + demob/surge refresh/stale SLA; no Mix Freshness Score™ | CLX |
| GOLDROT-* | Rotate + exposure-cap gold bank; tip-incident labels; no Gold Familiarity Score™ | CLVIII |
| AMBSEAL-* | Finite dual re-seal/gold SLA for ambiguous tickets; no Forced Blame Score™ / clock≡poison | CLIX |
...
### Kill #54 (v1.14): “Universal E0→E3 / Example Timing Score™ / fixed≡adaptive ≡ learning”
**Destroyed:** Universal fixed E0→E3 destiny as pedagogy; treating fixed fade schedules as adaptive science; gap-scan confidence alone as fade-stage truth; Example Timing Score™ vanity NS; always-example or always-struggle-first brand; black-box perfect-fade AI.
**Surviving:** SAFE-EXPTIME — grain-local example↔solve timing; completion bridge; adaptive>fixed when evidence exists; rapid rechecks beat Likert destiny; densifies SAFE-FADE; instrument EXPTIME-* before universal E0→E3 / Timing Score™ campaigns (C).

### Kill #55 (v1.14): “SRL Score™ / reflection-streak / survey≡event / streak≡SRL ≡ learning”
**Destroyed:** SRL Score™ / reflection-streak as North Star; trait survey SRL equated to event microanalysis; streak≡self-regulation; forethought without control writeback; ability-shame reflection; metacognition-module ACT guarantees.
**Surviving:** SAFE-SRL — Zimmerman forethought→performance→reflection with phase→control writeback; microanalysis>trait surveys; process attributions; densifies SAFE-MONITOR/AAR/ATTN/HELP; instrument SRL-* before SRL Score™ / streak≡SRL / metacognition-module ads (CI).

### Kill #56 (v1.14): “Generative Learning Score™ / AI≡generation / teach-for-XP ≡ learning”
**Destroyed:** Generative Learning Score™ as NS; AI monologue labeled as student generation; verbatim summary theater; unguided doodle≡dual-coding; teach-for-XP; eight-strategy menu bombs; ACT guarantees from GLA branding.
**Surviving:** SAFE-GENERATE — SOI-forcing sparse generative asks; student produces (coach does not substitute); teach-back requires the explanation act; guided FormatId draw/map; densifies SAFE-EXPLAIN/DUAL/SRL/SE; instrument GENACT-* before Generative Learning Score™ / AI≡generation / eight-strategy ACT ads (CII).

### Kill #57 (v1.14): “Psychological Safety Score™ / poster safe-space / Bermuda-triangle ≡ learning”
**Destroyed:** Psychological Safety Score™ / Comfort % as NS; poster-only safe space; Bermuda-triangle redirect away from diagnosis; shame reel; praise-fog AI≡climate; destake≡no-standards; ACT guarantees from climate branding.
**Surviving:** SAFE-ERRCLIMATE — error climate > safety slogan; stay-diagnose-scaffold-reattempt; destake learning episodes without deleting FEI standards; adaptive action metrics over comfort surveys; densifies SAFE-MISCON/HELP/TALK/AAR/EXAM/PDASH; instrument ERRCLIM-* before Psychological Safety Score™ / poster safe-space / Bermuda-triangle / praise-fog ACT ads (CIII).

### Kill #58 (v1.14): “Homework Completion Score™ / tonight-% / Chegg-dump / assisted≡ready ≡ learning”
**Destroyed:** Homework Completion Score™ / tonight-% as NS; “we finish your worksheet” brand; assisted≡solo-ready; Chegg-clone dump hero; Bastani Base Solver ads; purity ban on all homework help; parent homework stalk; grade guarantees from Solver.
**Surviving:** SAFE-HWHELP — dual-rail Help vs Practice; instrumental unstuck under deadline; assisted ≠ unassisted; costly dump; help recruits solo proof; densifies SAFE-HELP/FADE/ROI/DURABLE/PROOF; instrument HWHELP-* before Homework Completion Score™ / Chegg-clone / Bastani Base / purity-ban ACT ads (CIV).

### Kill #59 (v1.14): “Embodiment Score™ / styles meshing / always-gesture / pose-camera ≡ learning”
**Destroyed:** Embodiment Score™ / Gesture Score™ / Motion Minutes as NS; kinesthetic-style meshing; always-add-gesture dogma; manipulative≡gesture≡abstraction; forced produce-only; pose-camera embodiment AI; AR body immersion≡FEI; ACT guarantees from gesture kits.
**Surviving:** SAFE-GESTURE — strategy-tied optional gesture/finger-trace/draw; gesture ≠ object-action for transfer; respect non-gesturers; gesture+language; FormatId-triggered; tutor model→fade; densifies SAFE-DUAL/GENERATE/FORMAT/APPRENTICE; instrument GESTURE-* before Embodiment Score™ / styles meshing / pose-camera / AR-body ACT ads (CV).

### Kill #60 (v1.14): “Peer Explanation Score™ / teach-for-XP / Discord≡building / AI≡peer teaching ≡ learning”
**Destroyed:** Peer Explanation Score™ / Teach Minutes as NS; teach-for-XP; knowledge-telling≡quality; Discord≡knowledge-building; AI monologue≡peer teaching; unlock-without-solo after explain; peer-tutoring ACT guarantees.
**Surviving:** SAFE-PEERX — knowledge-building over telling; inferential prompts; apply after explain; capture student explanation act; near-peer grain+QA; densifies SAFE-GENERATE/EXPLAIN/HELP/TUTORGRAIN/APPRENTICE; instrument PEERX-* before Peer Explanation Score™ / teach-for-XP / Discord≡building / AI-monologue≡peer teaching ACT ads (CVI).

### Kill #61 (v1.14): “Curiosity Score™ / cliffhanger-without-commit / postdiction / guess-for-XP ≡ learning”
**Destroyed:** Curiosity Score™ / Engagement-from-curiosity as NS; cliffhanger without prediction commit; postdiction theater; instant-reveal entertainment; guess-for-XP; always-predict dogma; curiosity ACT guarantees.
**Surviving:** SAFE-PREDICT — commit before reveal; prediction-induced curiosity and surprise for expectancy-violating joins; encode the repair; demo/figure predict; mode gates; densifies SAFE-FBTIME/MONITOR/RETRIEVE/MISCON/PF; instrument PREDICT-* before Curiosity Score™ / cliffhanger-without-commit / postdiction / guess-for-XP / curiosity ACT ads (CVII).

### Kill #62 (v1.15): “Analogy Score™ / Mapping Minutes / mention≡pedagogy / surface-story≡structure ≡ learning”
**Destroyed:** Analogy Score™ / Mapping Minutes as NS; analogy-mention≡pedagogy; surface-story≡structure; AI likeness dump without student mapping; always-analogy dogma; HOT Score™; Discord≡supported compare; analogy ACT guarantees.
**Surviving:** SAFE-ANALOG — structure-map joins; co-present compare; student alignment; cognitive supports required; name where analogy breaks; densifies SAFE-BRIDGE/TRANSFER/DUAL/GESTURE/PREDICT; instrument ANALOG-* before Analogy Score™ / mention≡pedagogy / surface-story≡structure / AI likeness dump / always-analogy / analogy ACT ads (CVIII).

### Kill #63 (v1.15): “Writing Score™ / Journal Minutes / freewrite≡learning / AI≡WTL ≡ learning”
**Destroyed:** Writing Score™ / Journal Minutes as NS; freewrite diary≡learning; longer-essay≡deeper; AI rewrite≡WTL; Notes scrapbook without FEI; always-journal dogma; writing ACT guarantees.
**Surviving:** SAFE-WRITE — short prompted cognitive+metacognitive writing-to-learn; Notes dual-rail with FEI; AI may cue not author; densifies SAFE-GENERATE/SE/EXPLAIN/SRL/PEERX/PROOF; instrument WRITE-* before Writing Score™ / Journal Minutes / freewrite≡learning / longer≡deeper / AI≡WTL / always-journal / writing ACT ads (CIX).

### Kill #64 (v1.15): “Spatial Score™ / Mental Rotation Minutes / brain-training≡identity ≡ learning”
**Destroyed:** Spatial Score™ / Mental Rotation Minutes as NS; isolated brain-training≡math identity; innate or boys-better spatial costume; always-add-3D; Spatial Personality™; unscaffolded diagram flood; spatial ACT guarantees.
**Surviving:** SAFE-SPATIAL — FormatId-embedded spatial competence; conditional transfer; destake spatial anxiety; densifies SAFE-FORMAT/DUAL/GESTURE/TRANSFER/GENDER; instrument SPATIAL-* before Spatial Score™ / Mental Rotation Minutes / brain-training≡identity / boys-better / Spatial Personality™ / spatial ACT ads (CX).

### Kill #65 (v1.15): “Formative Score™ / Assessment Minutes / exit-ticket≡learning / 0.4–0.7 AfL ads ≡ learning”
**Destroyed:** Formative Score™ / Assessment Minutes as NS; exit-ticket≡learning; Black–Wiliam 0.4–0.7 product ads; more-quizzes≡formative; gradebook cosplay; “got it?”≡closed cycle; AfL ACT guarantees.
**Surviving:** SAFE-FA — formative-as-process; Sadler gap-closing; no 0.4–0.7 product legend; exit tickets only if wired to next move; FEI over Formative Score™; densifies SAFE-HITL/AAR/FBTIME/MONITOR/SRL/INSTRUMENT; instrument FA-* before AfL marketing (CXI).

### Kill #66 (v1.15): “Feedback Literacy Score™ / Feedback Minutes / delivery≡uptake ≡ learning”
**Destroyed:** Feedback Literacy Score™ / Feedback Minutes as NS; delivery≡uptake; thumbs-up≡used; longer≡more literate; illiteracy-shame without design fix; always-more-feedback dogma; feedback-literacy ACT guarantees.
**Surviving:** SAFE-FBLIT — feedback literacy as sense+use; proactive recipience; uptake loop UX; densifies SAFE-FBTIME/FA/EXPLAIN/HINT/HELP/SRL/MONITOR/ERRCLIMATE; instrument FBLIT-* before Feedback Literacy Score™ / delivery≡uptake / thumbs≡used / Feedback Minutes ads (CXII).

### Kill #67 (v1.15): “Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready ≡ learning”
**Destroyed:** Collaboration Score™ / Group Minutes as NS; Discord≡CSCL learning; group-correct≡ready; free-rider-blind unlocks; always-collab dogma; collab ACT guarantees.
**Surviving:** SAFE-COLLAB — structured collab with group goals + individual accountability; mandatory solo FEI gate; densifies SAFE-PEERX/CoP/PROOF/HELP/INSTRUMENT/ERRCLIMATE; instrument COLLAB-* before Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready / always-collab / collab ACT ads (CXIII).

### Kill #68 (v1.15): “Desirable Difficulty Score™ / Challenge Minutes / always-ease / always-max / cram≡ready ≡ learning”
**Destroyed:** Desirable Difficulty Score™ / Challenge Minutes as NS; always-ease-before-ACT; blocked-comfort≡ready; always-max-DD-until-bell; last-48h scored flood-as-DD; cram-week≡ready; schedule ACT-point guarantees.
**Surviving:** SAFE-DDSCHED — horizon-matched hold/ease of desirable difficulties (Build / Join / Protect+probe); stakes≠DD; ease load not readiness standards in final ~72h; densifies SAFE-DD/EXAM/SCHED/DURABLE/CRAM/RETRIEVE/EXPOSE; instrument DDSCHED-* before Desirable Difficulty Score™ / Challenge Minutes / always-ease / always-max / cram≡ready / schedule ACT guarantees (CXIV).

### Kill #69 (v1.15): “Representation Score™ / Diversity Minutes / costume≡belonging / match≡quality ≡ learning”
**Destroyed:** Representation Score™ / Diversity Minutes as NS; token STEM costume≡belonging; demographic match≡quality; empty likeness praise≡recognition; Belonging Score™; matching ACT guarantees; soft standards for matched pairs.
**Surviving:** SAFE-ROLEMODEL — fidelity before likeness; competence-visible attainable near-peers; optional preference match; recognition = practice evidence; densifies SAFE-GENDER/ELL/TUTORGRAIN/HITL/EXPECTANCY/CoP/IDMEASURE; instrument ROLEMODEL-* before Representation Score™ / Diversity Minutes / costume≡belonging / match≡quality / empty likeness praise / Belonging Score™ / matching ACT guarantees (CXV).

### Kill #70 (v1.15): “Capture Score™ / Photo Minutes / OCR≡mastery / photo→answer ≡ learning”
**Destroyed:** Capture Score™ / Photo Minutes as NS; OCR≡mastery; always-on camera; photo→answer Practice hero; Capture ACT guarantees; phone-companion focus theater.
**Surviving:** SAFE-OFFLINE — offline-first attempt grain; capture after commit; residue-aware brief ritual; verify OCR before Map write; no photo→answer dump; densifies SAFE-ATTN/HELP/HWHELP/GESTURE/PROOF/GENQ/FORMAT; instrument OFFLINE-* before Capture Score™ / Photo Minutes / OCR≡mastery / always-camera / photo→answer hero / Capture ACT guarantees (CXVI).

### Kill #71 (v1.16): “Forever-E0 / day-one fade flood / Anxiety·Calm Score™ fade gates ≡ learning”
**Destroyed:** Forever-E0 anxious track; day-one aggressive fade flood for HMA; Anxiety Score™ or Calm Score™ fade gates; Fade Score™ NS; permanent peek “support”; soft standards for anxious personas; protect-without-fade ChatGPT dump; ACT guarantees from anxiety-aware scaffolding.
**Surviving:** SAFE-FADEX — protective worked study under anxiety WM load; longer E0/E1 hold without permanent persona track; destake; treat peek binge as safety behavior to fade; proof = solo transfer + approach; densifies SAFE-FADE/EXPOSE/DD; instrument FADEX-* before forever-E0 / flood / Calm Score™ fade campaigns (CXVII).

### Kill #72 (v1.16): “Miss Streak / soft-wrong shame push / empty mindset parent letter ≡ learning”
**Destroyed:** Miss Streak / soft-wrong shame push; live wrong-answer stalk; Parent Correctness Score™; empty “mistakes are good!” without grain+CTA; controlling “sit until correct” default; growth-mindset parent letter≡FEI; ACT guarantees from parent messaging.
**Surviving:** SAFE-SOFTMSG — grain + failure-enhancing frame + one improvement CTA; autonomy>control; densifies SAFE-PDASH/FBLIT/ERRCLIMATE/MISCON; instrument SOFTMSG-* before Miss Streak / shame-push / empty mindset parent campaigns (CXVIII).

### Kill #73 (v1.16): “Always-on Map / Map Minutes / mid-attempt full-graph ≡ learning”
**Destroyed:** Always-on student Map; Map Minutes or Map Score™ NS; mid-attempt full-graph dump; Map-open≡cycle-closed; dual-screen Map+problem default; ontology tour≡tutoring; ACT guarantees from Map airtime.
**Surviving:** SAFE-MAPORCH — brief→grain-slice→adjust; tutor-private default; between-attempt opens; densifies SAFE-HITL/FA/ATTN/BRIDGE/ONTOLOGY; instrument MAPORCH-* before always-on Map / Map Minutes / mid-attempt dump campaigns (CXIX).

### Kill #74 (v1.16): “Burnout Score™ / Wellness Minutes / wellness-primary under caseload ≡ quality”
**Destroyed:** Burnout Score™ / Wellness Minutes NS; mandatory mood gate; tutor emotion-AI; wellness-module-as-primary when caseload is the demand; retention-% without fidelity; sell tutor-affect dashboards; ACT guarantees from wellness packaging.
**Surviving:** SAFE-BURNWARN — fidelity/load early-warn → org redesign (JD-R); densifies SAFE-WORKFORCE/PRIVACY/ROI; instrument BURNWARN-* before Burnout Score™ / wellness-primary campaigns (CXX).

### Kill #75 (v1.16): “Fluency≡pedagogy / Explanation·Rubric Score™ / LLM-judge-alone ≡ learning”
**Destroyed:** Fluency/human-likeness≡pedagogy; thumbs-up thoroughness NS; Explanation Score™ or Rubric Score™; LLM-judge-alone ship authority; soft-pass wrong math because prose “helped”; reveal-answer default as guidance; auto-wrap-QA replacing GENQ key verify; ACT guarantees from rubric-scored AI coach.
**Surviving:** SAFE-EXPLAINQA — principle-short rubric gates; hard-fail math/key; densifies SAFE-EXPLAIN/GENQ/REPAIR; instrument EXPLAINQA-* before fluency≡pedagogy / LLM-judge-alone campaigns (CXXI).

### Kill #76 (v1.16): “Soft-wrong≡half-credit / Partial Credit Score™ / all-wrongs-equal ≡ learning”
**Destroyed:** Soft-wrong≡half-credit; Partial Credit Score™ or Mark Minutes NS; all-wrongs-equal mastery deltas; gradebook cosplay (% banners, letter grades, live point stalk); ordered PCM steps≡identity; empty celebrate-mistakes without mark→route; ACT guarantees from partial-credit packaging.
**Surviving:** SAFE-TAXON — typed marks drive routing and type-conditioned graph updates; soft-wrong wraps type; densifies SAFE-MISCON/FBLIT/FBTIME; instrument TAXON-* before Partial Credit Score™ / gradebook cosplay campaigns (CXXII).

### Kill #77 (v1.16): “Hours-booked crunch / Load Shed Score™ / pour≡exam support ≡ quality”
**Destroyed:** Hours-booked / session-volume crunch NS; Load Shed Score™ or Crunch Minutes; infinite-availability exam brand; wellness-primary under caseload spike; hire-surge without coach bandwidth; pour-mode≡exam support; hospital-cosplay ads; soft standards for crunch personas; ACT guarantees from crunch playbooks.
**Surviving:** SAFE-LOADSHED — named exam-week pause list; acuity FEI minutes; org redesign first; densifies SAFE-BURNWARN/DDSCHED/WORKFORCE/EXAM/ROI/HWHELP; instrument LOADSHED-* before hours-booked crunch / infinite-availability campaigns (CXXIII).

### Kill #78 (v1.16): “Distractor Score™ / always-four / beauty traps / unmapped diagnostic MC ≡ learning”
**Destroyed:** Distractor Score™ / Option Minutes; always-four≡better; beauty traps·absurd fillers·NOTA-AOTA default; unmapped wrongs≡diagnostic; LLM distractors without mis_ seal; option-count or item-count NS; ACT guarantees from distractor packaging.
**Surviving:** SAFE-DISTRACTOR — misconception-mapped functioning distractors; function over fashion; soft-wrong from chosen option; densifies SAFE-TAXON/MISCON/GENQ; instrument DISTRACTOR-* before Distractor Score™ / always-four / beauty-trap campaigns (CXXIV).

### Kill #79 (v1.16): “Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence ≡ learning”
**Destroyed:** Identity Score™ / Confidence Personality™ from hard/kinda/easy; equal-weight recovery for all misses; easy≡mastered; inflate-confidence as recovery NS; Belief Score™; CA-without-route; ACT guarantees from confidence-tagged recovery packaging.
**Surviving:** SAFE-CONFMISS — confidence×type recovery dose; CRI fork; hypercorrection priority for sure misses; densifies SAFE-TAXON/CALIB/MONITOR/COLD; instrument CONFMISS-* before Identity Score™ / equal-weight recovery / inflate-confidence campaigns (CXXV).

### Kill #80 (v1.17): “Skip-as-default / lecture-as-debrief / Microdebrief Score™ / +25% ACT from debriefs ≡ learning”
**Destroyed:** “No time for debrief” default; lecture-as-micro-debrief; Microdebrief Score™·Debrief Minutes·Reflection Streak NS; +25% ACT from borrowed debrief metas; military-cosplay micro-AAR; vibes-only close without traces; therapy-length mandate under crunch; ACT guarantees from micro-debrief packaging.
**Surviving:** SAFE-MICRODEB — capped student-first micro-AAR with objective traces; protect under LOADSHED; densifies SAFE-AAR/LOADSHED/HITL/TALK/FBLIT; instrument MICRODEB-* before skip-as-default / lecture-close / Microdebrief Score™ campaigns (CXXVI).

### Kill #81 (v1.17): “24/7 availability / hours-hero / fear-parent emails / Availability Score™ ≡ care”
**Destroyed:** 24/7·infinite-availability default parent value prop; hours-booked crunch hero; fear-appeal parent emails as default; silent shed≡care; Likert-WTP for “thinking minutes”; Availability Score™·Crunch Message Score™·Open-Late Minutes NS; ACT guarantees from crunch messaging.
**Surviving:** SAFE-CRUNCHMSG — shed-honesty + protected thinking-minutes CBC/messages; densifies SAFE-LOADSHED/WTP/SOFTMSG/PDASH/EXAM; instrument CRUNCHMSG-* before 24/7 / hours-hero / fear-parent campaigns (CXXVII).

### Kill #82 (v1.17): “FormatTrap Score™ / seductive stems / beauty visual traps / unmapped visual diagnostic ≡ learning”
**Destroyed:** FormatTrap Score™ / Visual Distractor Minutes; seductive stem art≡FormatId; beauty-trap option pictures; unmapped visual wrongs≡diagnostic; decoration≡dual-coding distractors; LLM figure options without trap seal; visual miss≡topic-only; ACT guarantees from visual-distractor packaging.
**Surviving:** SAFE-FORMTRAP — named format-trap visual distractors; coherent structural stems; densifies SAFE-DISTRACTOR/FORMAT/DUAL/GENQ; instrument FORMTRAP-* before FormatTrap Score™ / beauty visual trap campaigns (CXXVIII).

### Kill #83 (v1.17): “No time for brief / pour-open / Brief Score™ / late-join shame / I-PASS cosplay ≡ learning”
**Destroyed:** “No time for brief/goals” default; pour-open lecture-as-brief; Brief Score™·Brief Minutes·Opening Streak NS; late-join shame open; aviation·OR·I-PASS cosplay ACT ads; vibes-only open without named edge; soft standards via “we connected”; ACT guarantees from micro-brief packaging.
**Surviving:** SAFE-MICROBRIEF — capped shared-model open (edge/success/trap/role + student synthesis); densifies SAFE-AAR/MICRODEB/LOADSHED/HITL/EXPECTANCY; instrument MICROBRIEF-* before no-time-for-brief / pour-open / Brief Score™ campaigns (CXXIX).

### Kill #84 (v1.17): “Chegg-hero crunch CTA / Dual-CTA Score™ / assisted≡ready ≡ learning”
**Destroyed:** Single Chegg-hero Solver CTA under crunch; “finish tonight’s homework” primary brand; fear-countdown→dump CTAs; Dual-CTA Score™·Help Tonight Minutes·Crunch Click NS; silent Practice-rail collapse in exam week; assisted≡ready from Solver CTA; ACT guarantees from dual-rail CTA packaging.
**Surviving:** SAFE-CRUNCHCTA — dual labeled Solver/Practice CTAs under crunch; instrumental verbs; fiduciary defaults; follow-on Practice; densifies SAFE-HWHELP/CRUNCHMSG/HELP/DURABLE/SOFTMSG; instrument CRUNCHCTA-* before Chegg-hero / Dual-CTA Score™ / fear-dump campaigns (CXXX).

### Kill #85 (v1.17): “Fluency SVG≡keyed figure / judge-alone figure ship / Figure Key Score™ ≡ learning”
**Destroyed:** Fluency SVG / pretty-render≡keyed figure; LLM-as-judge-alone figure ship; Figure Key Score™·Visual QA Minutes; unverified FormatId figures as diagnostic ground truth; FormatId-count or “AI drew N diagrams” hero; soft-pass wrong geometry because traps were mapped; ACT guarantees from figure-generation packaging.
**Surviving:** SAFE-FIGKEY — structural figure key-verify for FormatId generation; deterministic spine; use gating; densifies SAFE-GENQ/FORMTRAP/DUAL/COVER/EXPLAINQA; instrument FIGKEY-* before fluency SVG / judge-alone / Figure Key Score™ campaigns (CXXXI).

### Kill #86 (v1.17): “Idle spinner / pour-open wait / Wait Minutes·Lobby Score™ / entertainment lobby ≡ learning”
**Destroyed:** Idle spinner-only late lobby; pour-open AI wait dump; Wait Minutes·Lobby Score™·Prebrief Streak NS; entertainment-primary fill; forced marathon Practice-before-join; late-tutor shame feed; ACT guarantees from async pre-brief packaging.
**Surviving:** SAFE-ASYNCBRIEF — capped async Set card on late/early wait; session-related occupied wait; if-then chip; live verify-not-replace; densifies SAFE-MICROBRIEF/SRL/ATTN/LOADSHED/EXPECTANCY; instrument ASYNCBRIEF-* before idle spinner / Lobby Score™ / pour-open wait campaigns (CXXXII).

### Kill #87 (v1.17): “Dump-and-quit / maze handoff / Transfer Score™ / assisted≡ready ≡ learning”
**Destroyed:** Dump-and-quit Solver close; multi-step maze handoff; Transfer Score™·Handoff Minutes·Follow-on Streak NS; assisted≡ready; marathon-after-soft-hint; XP-for-help-without-solo; ACT guarantees from transfer-grain packaging.
**Surviving:** SAFE-XFERGRAIN — one-tap edge-matched Practice grain after instrumental Solver; short default; solo gate; SCHED return; densifies SAFE-HWHELP/CRUNCHCTA/SCHED/HELP/FADE/PROOF; instrument XFERGRAIN-* before dump-and-quit / Transfer Score™ / maze handoff campaigns (CXXXIII).

### Kill #88 (v1.18): “Tagged FormatId≡C4 / fluency eligibility / coverage-padding / HideCorrectness Score™ ≡ learning”
**Destroyed:** Tagged-FormatId≡C4-eligible; fluency-render eligibility; coverage-padding unsealed visuals into gap-scan; HideCorrectness Score™·Eligibility Minutes·FormatId-count-in-scan NS; miss-on-broken-figure≡format-gap without seals; ACT guarantees from visual diagnostic packaging.
**Surviving:** SAFE-HCELIG — seals-first FormatId eligibility for C4; `hcelig_pass` distinct from in-bank; honest holes > pad; densifies SAFE-FIGKEY/GENQ/CALIB/COLD/FORMAT/COVER/FORMTRAP; instrument HCELIG-* before tagged≡C4 / fluency eligibility / HideCorrectness Score™ campaigns (CXXXIV).

### Kill #89 (v1.18): “Soon-default / optimistic ETA slip / apology-primary / ETA Score™ ≡ care”
**Destroyed:** “Soon”/“almost” default late lobby; optimistic ETA slip loops; apology-primary without duration; ETA Score™·Wait Satisfaction·Lobby Minutes NS; student-facing tutor-shame feed; fake-precision countdown; ACT guarantees from wait-UX packaging.
**Surviving:** SAFE-KNOWNETA — known-finite ETA with refresh honesty; densifies SAFE-ASYNCBRIEF/MICROBRIEF/LOADSHED/EXPECTANCY; instrument KNOWNETA-* before soon-default / ETA Score™ / shame-feed campaigns (CXXXV).

### Kill #90 (v1.18): “Universal hard-gate / Gate Score™ / hint-tax shame ≡ learning”
**Destroyed:** Universal hard-gate after every hint; optional-only dump chip as sole close; Gate Score™·Forced Follow-On %·Soft-Require Compliance Minutes NS; “can’t leave until Practice” hint-tax shame; ignore help-avoidance when Forced % rises; ACT guarantees from soft-vs-hard gate packaging.
**Surviving:** SAFE-SOFTGATE — soft-require default; conditional short hard-gate with avoidance falsifiers; densifies SAFE-XFERGRAIN/HELP/CRUNCHCTA; instrument SOFTGATE-* before Gate Score™ / universal hard-gate campaigns (CXXXVI).

### Kill #91 (v1.18): “Unified bank ≡ Practice+C4 / silent dual-write / SplitPool Score™ ≡ learning”
**Destroyed:** Unified sealed bank ≡ Practice+C4; silent dual-write Practice→Map; auto-promote from play counts; SplitPool Score™·Dual-Use Minutes·Pool-Separation % NS; padding C4 with Practice-only visuals; ACT guarantees from one-bank packaging.
**Surviving:** SAFE-SPLITPOOL — graded Practice-reveal vs C4 pools; ticketed promote; densifies SAFE-HCELIG/REPAIR/GENQ/COVER; instrument SPLITPOOL-* before unified dual-use / SplitPool Score™ campaigns (CXXXVII).

### Kill #92 (v1.18): “Pad-scan / equal-quota theater / Composition Score™ ≡ learning”
**Destroyed:** Symbolic/Practice pad into C4 FormatId blueprint cells; equal-quota theater under N≈1 sealed stock; silent underrepresentation sold as format-flexible; Composition Score™·Format Balance %·Scan Completeness Minutes NS; “diagnose every format” ads under thin C4 stock; absence≡mastery; ACT guarantees from balanced-scan packaging.
**Surviving:** SAFE-SCANCOMP — blueprint composition from sealed stock with labeled holes; densifies SAFE-HCELIG/SPLITPOOL/COVER/FORMAT; instrument SCANCOMP-* before pad / Composition Score™ campaigns (CXXXVIII).

### Kill #93 (v1.18): “Hide-holes / complete-visual ads / Hole Trust Score™ ≡ trust”
**Destroyed:** Hide-`format_not_probed` for conversion; child-deficit visual-hole shame; “complete visual diagnostic” ads while holes remain; Hole Trust Score™·Coverage Satisfaction·Honesty Minutes NS; absence≡format mastery; fear-scarcity hole WTP; ACT guarantees from hole packaging.
**Surviving:** SAFE-HOLETRUST — label hole + seal reason + one fill CTA; densifies SAFE-SCANCOMP/PDASH/COVER/WTP/SOFTMSG; instrument HOLETRUST-* before hide-holes / Hole Trust Score™ campaigns (CXXXIX).

### Kill #94 (v1.18): “Play-count auto-promote / Promote Score™ ≡ bank quality”
**Destroyed:** Play-count / thumbs-up auto-promote to C4; silent `hcelig_pass` flip; fluency soft-pass at promote; Promote Score™·QA Minutes·Promotion Throughput % NS; padding C4 while critical REPAIR open; ACT or complete-visual guarantees from promote packaging.
**Surviving:** SAFE-PROMOTE — ticketed checklist + seal re-verify; demote faster than promote; densifies SAFE-SPLITPOOL/REPAIR/FIGKEY/HCELIG/COVER; instrument PROMOTE-* before play-count / Promote Score™ campaigns (CXL).

### Kill #95 (v1.18): “Immediate same-stem C4 / Cool-Down Score™ ≡ diagnosis”
**Destroyed:** Immediate same-stem C4 after reveal; forever or global cool-down lock as default; Cool-Down Score™·Exposure Minutes·Lock Duration % NS; pad under cool-down; isomorphic-clone leak as “fresh”; ACT or complete-visual guarantees from cool-down packaging.
**Surviving:** SAFE-COOLDOWN — per-student cool-down after reveal before same-family C4; isomorphic substitutes then holes; densifies SAFE-SPLITPOOL/SCANCOMP/CALIB/COLD; instrument COOLDOWN-* before immediate same-stem / Cool-Down Score™ campaigns (CXLI).

### Kill #96 (v1.18): “Parent-only hole honesty / fake greens / Student Hole Score™ ≡ identity”
**Destroyed:** Parent-only hole honesty; fake greens for `not_probed`; ability-shame hole frames; empty growth-mindset poster without CTA; Student Hole Score™·Completeness %·Honesty Minutes NS; absence≡mastery; ACT or identity guarantees from student hole packaging.
**Surviving:** SAFE-STUDHOLE — student parity honesty; product-hole frame; one Practice CTA; no fake greens; densifies SAFE-HOLETRUST/COLD/CALIB/SOFTMSG/FBLIT; instrument STUDHOLE-* before parent-only / fake-green / Student Hole Score™ campaigns (CXLII).
### Kill #97 (v1.19): “Coming-soon / play-count fill bars / FillETA Score™ ≡ trust”
**Destroyed:** Coming-soon / almost-ready default hole-fill; play-count fill bars; optimistic slip loops; date-driven soft-pass promote; FillETA Score™·Backlog Minutes·Honesty Clock NS; ACT or complete-visual-by-date guarantees from fill packaging.
**Surviving:** SAFE-FILLETA — capacity-grounded finite fill bands; no play-count progress; no date soft-pass seals; densifies SAFE-PROMOTE/KNOWNETA/HOLETRUST/STUDHOLE; instrument FILLETA-* before coming-soon / FillETA Score™ campaigns (CXLIII).

### Kill #98 (v1.19): “Always-dual / never-dual / Dual Rater Score™ ≡ quality”
**Destroyed:** Always-dual costume; never-dual figured C4; Dual Rater Score™·Agreement Minutes·Kappa % NS; seal-waiving second rater; mammography-cosplay ACT ads; ETA-skipped mandatory dual; Discord-emoji≡second rater.
**Surviving:** SAFE-DUALRATE — risk-triggered second rater; seals before dual; disagreement→reject/repair; densifies SAFE-PROMOTE/FIGKEY/HITL/FILLETA; instrument DUALRATE-* before Dual Rater Score™ / always-dual campaigns (CXLIV).

### Kill #99 (v1.19): “Item_id-only / concept-wide / Family Hash Score™ ≡ cool-down”
**Destroyed:** Item_id-only cool-down under GENQ clones; concept×FormatId cool-down as default family; embedding-only family without SME seal; Family Hash Score™·Clone Minutes·Similarity % NS; pad when family bar empties a cell; ACT or complete-visual guarantees from hashing packaging.
**Surviving:** SAFE-FAMHASH — sealed isomorphic family as cool-down compromise unit; substitutes outside family; densifies SAFE-COOLDOWN/GENQ/FIGKEY/SCANCOMP; instrument FAMHASH-* before item_id-only / Family Hash Score™ campaigns (CXLV).

### Kill #100 (v1.19): “Anxiety·Calm·Exit Emotion Score™ / consoling comfort ≡ care”
**Destroyed:** Anxiety Score™ / Calm Score™ / Exit Emotion Score™ / Mood Minutes NS; consoling “not everyone can…” ability talk; ego Completeness % beside hole honesty; mandatory mood gate; emotion-AI exit empathy; fake greens as affect management; calm-to-zero or ACT guarantees from gap-scan exit packaging.
**Surviving:** SAFE-EXITEMO — destake exit copy; task/process + one Practice CTA; no mood telemetry; densifies SAFE-STUDHOLE/PRIVACY/EXPOSE/SOFTMSG; instrument EXITEMO-* before Exit Emotion Score™ / emotion-AI exit campaigns (CXLVI).

### Kill #101 (v1.19): “Dual-omitted FILLETA / ETA-skipped dual / Capacity Score™ ≡ honesty”
**Destroyed:** Dual-omitted FILLETA; ETA-skipped dual; always-dual without dual FTE; 100% dual-util plans; Dual Rater Score™·Capacity Score™·Reviewer Minutes NS; hospital-cosplay dual-capacity ads; complete-visual-by-date or ACT guarantees from dual capacity packaging.
**Surviving:** SAFE-CAPPLAN — dual minutes as first-class FILLETA capacity line; headroom; label dual scarcity; densifies SAFE-DUALRATE/FILLETA/WORKFORCE; instrument CAPPLAN-* before ETA-skipped dual / Capacity Score™ campaigns (CXLVII).

### Kill #102 (v1.19): “Forever-dual clones / silent inherit / Template Trust Score™ ≡ quality”
**Destroyed:** Forever-dual on sealed isomorphic clones after blueprint dual; silent inherit without template+family seals; Template Trust Score™·Inherit %·Family Calibration Score™ NS; first dual ≡ forever trust without sample audit; embedding-only inheritance; FERF≡C4-ready ads; ACT or complete-visual guarantees from template-inheritance packaging.
**Surviving:** SAFE-TMPTRUST — blueprint dual once; inherit single-rater under sealed sameness + sample audit + revoke; densifies SAFE-DUALRATE/FAMHASH/FIGKEY/CAPPLAN; instrument TMPTRUST-* before forever-dual / Template Trust Score™ campaigns (CXLVIII).

### Kill #103 (v1.19): “Kappa % NS / pooled repair vanity / Landis-band marketing ≡ integrity”
**Destroyed:** Kappa % / Dual Rater Score™ / Agreement Minutes NS; pooled-only post-promote repair vanity; Landis–Koch “almost perfect” marketing band; unconditioned dual-shame boards; mammography-cosplay IRR heroes; ACT or complete-visual guarantees from IRR packaging.
**Surviving:** SAFE-REPAIRSTRAT — path-stratified repair + contingency drill-downs; κ as aide not NS; densifies SAFE-DUALRATE/PROMOTE/INSTRUMENT/TMPTRUST; instrument REPAIRSTRAT-* before Kappa % / Dual Rater Score™ IRR campaigns (CXLIX).

### Kill #104 (v1.19): “Surge Hire % / unsealed freelancer dual / hospital-surge cosplay ≡ capacity”
**Destroyed:** Dual Rater Score™ / Surge Hire % / Contract Minutes NS; hire-surge theater; unsealed Discord-freelancer≡second rater; always-hire or always-contract dogma; hospital-surge-cosplay dual ads; complete-visual-by-exam-week or ACT guarantees from surge packaging.
**Surviving:** SAFE-SURGEPANEL — make-or-buy dual portfolio with seals, parallel-run, demobilization honesty; densifies SAFE-CAPPLAN/LOADSHED/WORKFORCE/DUALRATE; instrument SURGEPANEL-* before Surge Hire % / unsealed freelancer dual campaigns (CL).

### Kill #105 (v1.20): “Forever-trust latch / frozen sample-% / Template Trust Score™ ≡ quality”
**Destroyed:** Forever-trust latch after blueprint; frozen sample-% theater; Template Trust Score™·Sample Dual %·Revoke Minutes NS; ISO AQL tables as ACT cut-scores; hospital-CUSUM cosplay QA ads; ETA-forced trust during surge; silent re-qualify from play counts; complete-visual from trust-health packaging.
**Surviving:** SAFE-REVOKE — revocable template-trust + switching sample cadence; densifies SAFE-TMPTRUST/REPAIRSTRAT/CAPPLAN; instrument REVOKE-* before forever-trust / Template Trust Score™ campaigns (CLI).

### Kill #106 (v1.20): “Dual Shame Score™ / unconditioned dual rankings ≡ integrity”
**Destroyed:** Dual Shame Score™ / Selection-Adjusted Repair % / Path Blame Minutes NS; unconditioned dual-vs-single rankings as quality proof; Propensity Theater™ brand; hospital case-mix cosplay ACT ads; κ-as-blame-verdict; complete-visual from blame packaging.
**Surviving:** SAFE-PATHBLAME — path×stratum blame before dual/single quality verdicts; densifies SAFE-REPAIRSTRAT/DUALRATE/CAPPLAN; instrument PATHBLAME-* before Dual Shame Score™ / unconditioned ranking campaigns (CLII).

### Kill #107 (v1.20): “Parallel Score™ / day-one C4 / Loom≡ready ≡ scaled dual”
**Destroyed:** Parallel Score™ / Onboard Minutes / Ramp % NS; day-one C4 for contract panelists; Loom≡seal literacy; SOW-signed≡gate-pass; forever-ramp without exit; silent graduate under ETA panic; AP·ETS cosplay ACT ads; complete-visual or ACT guarantees from panel onboarding packaging.
**Surviving:** SAFE-PANELRAMP — seal literacy → shadow dual → graduate before contract C4; densifies SAFE-SURGEPANEL/FIGKEY/DUALRATE/CAPPLAN; instrument PANELRAMP-* before Parallel Score™ / day-one C4 campaigns (CLIII).

### Kill #108 (v1.20): “Demobilization Score™ / invent-work / cliff-cut ≡ exit”
**Destroyed:** Demobilization Score™ / Idle Minutes / Panel Utilization % NS; invent-work after spike; cliff-cut without handover; forever-panel latch without CAPPLAN review; silent FILLETA after demob; hospital-demob cosplay ACT ads; complete-visual or ACT guarantees from demobilization packaging.
**Surviving:** SAFE-DEMOB — planned post-spike dual wind-down with handover, capture, FILLETA demob honesty; densifies SAFE-SURGEPANEL/WORKFORCE/REPAIRSTRAT; instrument DEMOB-* before Demobilization Score™ / invent-work campaigns (CLIV).

### Kill #109 (v1.20): “Gold Set Score™ / open canaries / pooled gold vanity ≡ integrity”
**Destroyed:** Gold Set Score™ / Canary Minutes / Probe Hit % NS; open or student-facing planted stems; pooled-only gold vanity; invent-work gold pad; radiology-canary cosplay ACT ads; complete-visual or ACT guarantees from canary packaging.
**Surviving:** SAFE-GOLDSET — blind sealed gold probes for path×stratum monitors; densifies SAFE-PATHBLAME/REPAIRSTRAT/INSTRUMENT; instrument GOLDSET-* before Gold Set Score™ / open-canary campaigns (CLV).

### Kill #110 (v1.20): “Generator Shame Score™ / unlabeled Dual Shame ≡ root cause”
**Destroyed:** Generator Shame Score™ / Rater Poison Minutes / Blame Separation % NS; always-rater or always-generator dogma; unlabeled Dual Shame on inherit; MSA·Six-Sigma cosplay ACT ads; complete-visual or ACT guarantees from root-cause packaging.
**Surviving:** SAFE-POISONSEP — label generator vs rater vs ambiguous poison before escalate; densifies SAFE-REVOKE/PATHBLAME/GENQ; instrument POISONSEP-* before Generator Shame Score™ / unlabeled Dual Shame campaigns (CLVI).

### Kill #111 (v1.20): “Case-Mix Score™ / hide-mix / hospital report-card ≡ LEA trust”
**Destroyed:** Dual Shame Score™ / Case-Mix Score™ / Path Mix Minutes / Selection-Adjusted Repair % NS; hide-mix-for-conversion; unconditioned dual-vs-single RFP rankings; hospital·CMS report-card cosplay ACT ads; Propensity Theater™ brand; complete-visual or Map-trust guarantees from mix packaging; mix≡DPA.
**Surviving:** SAFE-PATHMIX — dated path-mix + routing rationale in LEA trust packets; densifies SAFE-PATHBLAME/PROCURE/HOLETRUST; instrument PATHMIX-* before Case-Mix Score™ / hide-mix campaigns (CLVII).

### Kill #112 (v1.20): “Gold Familiarity Score™ / forever-fixed gold / CAT-security ≡ integrity”
**Destroyed:** Gold Familiarity Score™ / Tip Minutes / Rotation Health % NS; forever-fixed open gold; tip-sheet Slack keys; thrash-rotate that empties hard cells; CAT-security cosplay ACT ads; complete-visual or ACT guarantees from gold-rotation packaging.
**Surviving:** SAFE-GOLDROT — rotate + exposure-cap sealed gold bank against tip/familiarity; densifies SAFE-GOLDSET/REVOKE/PANELRAMP; instrument GOLDROT-* before Gold Familiarity Score™ / forever-fixed gold campaigns (CLVIII).

### Kill #113 (v1.20): “Forced Blame Score™ / clock≡poison / GRE adjudication ≡ resolution”
**Destroyed:** Forced Blame Score™ / Ambiguous Minutes / Decision Velocity % NS; clock≡poison auto-label; forever silent ambiguous hold; instant Dual Shame on S3; GRE·ETS adjudication cosplay ACT ads; complete-visual or ACT guarantees from re-seal packaging.
**Surviving:** SAFE-AMBSEAL — finite dual re-seal/gold SLA for ambiguous poison tickets; densifies SAFE-POISONSEP/GOLDSET/DUALRATE/CAPPLAN; instrument AMBSEAL-* before Forced Blame Score™ / clock≡poison campaigns (CLIX).

### Kill #114 (provisional, Part CLX): “Mix Freshness Score™ / forever-green surge mix / hospital-lag cosplay ≡ current QA”
**Destroyed:** Mix Freshness Score™ / Case-Mix Score™ / Path Mix Minutes / Refresh Velocity % NS; forever-green surge-era mix; silent demob without stale label; hospital·CMS report-card lag cosplay ACT ads; continuous-refresh≡quality; complete-visual or Map-trust guarantees from path-mix refresh packaging.
**Surviving:** SAFE-MIXREFRESH — event+calendar path-mix refresh / stale labels with `path_mix_as_of`; densifies SAFE-PATHMIX/DEMOB/CAPPLAN; instrument MIXREFRESH-* before Mix Freshness Score™ / forever-green campaigns (CLX).
...
**Strategic implication (v1.20 densified):** Do not out-Khan Khan on content breadth or item-count theater (SAFE-COVER). Do not out-ChatGPT on always-full-worked / unlimited-solutions Solver (SAFE-FADE). Do not out-Duo Duo on streaks/leagues/XP or expanding-SRS mystique. Do not out-Brilliant Brilliant on puzzle delight. Do not out-ChatGPT on fluency or graph-file cosplay. Do not out-Anki/FSRS on black-box interval theater. Do not out-Kaplan/bootcamp on massed cram or +points packages (SAFE-DURABLE). Do not out-instant-feedback AI or always-delay cosplay (SAFE-FBTIME). Do not out-node-weakness theater when the failure is a join (SAFE-BRIDGE). Do not out-day-one mastery fireworks or placement-belt cold starts (SAFE-COLD). Do not out-format-count / every-format / visual-learning-style quizzes (SAFE-FORMAT). Do not out-Dual-Coding-Score / always-add-picture / animation-first multimedia theater (SAFE-DUAL). Do not out-Explanation-Score / longer≡better monologue / monologue≡SE theater (SAFE-EXPLAIN). Do not out-Struggle-Score / blank-time / always-wait / never-stuck stall theater (SAFE-RETRIEVE). Do not out-fail-first / every-miss-as-PF / discovery-without-consolidation cosplay (SAFE-PF). Do not out-guild / modeling-as-lecture / Apprenticeship Score™ costume (SAFE-APPRENTICE). Do not out-Focus-Score / phone-shame / mid-attempt DAU-push theater (SAFE-ATTN). Do not out-Monitoring-Score / metacognition-without-control / one-scan calibration theater (SAFE-MONITOR). Do not out-AI-replaces-tutors / tutoring-is-free / unlimited-human / hours-booked / Session ROI Score™ theater (SAFE-ROI). Do not out-Example-Timing-Score / universal E0→E3 destiny / fixed≡adaptive fade costume (SAFE-EXPTIME). Do not out-SRL-Score / reflection-streak / survey≡event theater (SAFE-SRL). Do not out-Generative-Learning-Score / AI≡generation / teach-for-XP / eight-menu GLA bomb (SAFE-GENERATE). Do not out-Psychological-Safety-Score / poster safe-space / Bermuda-triangle / praise-fog theater (SAFE-ERRCLIMATE). Do not out-Homework-Completion-Score / tonight-% / Chegg-dump / assisted≡ready theater (SAFE-HWHELP). Do not out-Embodiment-Score / styles meshing / always-gesture / pose-camera theater (SAFE-GESTURE). Do not out-Peer-Explanation-Score / teach-for-XP / Discord≡building / AI≡peer teaching theater (SAFE-PEERX). Do not out-Curiosity-Score / cliffhanger-without-commit / postdiction / guess-for-XP theater (SAFE-PREDICT). Do not out-Analogy-Score / Mapping Minutes / surface-story≡structure / AI likeness dump theater (SAFE-ANALOG). Do not out-Writing-Score / Journal Minutes / freewrite / AI≡WTL theater (SAFE-WRITE). Do not out-Spatial-Score / Mental Rotation Minutes / brain-training≡identity theater (SAFE-SPATIAL). Do not out-Formative-Score / Assessment Minutes / 0.4–0.7 AfL legend theater (SAFE-FA). Do not out-Feedback-Literacy-Score / delivery≡uptake / thumbs≡used theater (SAFE-FBLIT). Do not out-Collaboration-Score / Group Minutes / Discord≡CSCL / group-correct≡ready theater (SAFE-COLLAB). Do not out-Desirable-Difficulty-Score / Challenge Minutes / always-ease / always-max / cram≡ready calendar theater (SAFE-DDSCHED). Do not out-Representation-Score / Diversity Minutes / costume≡belonging / match≡quality theater (SAFE-ROLEMODEL). Do not out-Capture-Score / Photo Minutes / OCR≡mastery / Photomath-pipe notebook AI (SAFE-OFFLINE). Do not out-forever-E0 / Anxiety·Calm Score™ fade gates (SAFE-FADEX). Do not out-Miss Streak / soft-wrong shame-push parent theater (SAFE-SOFTMSG). Do not out-always-on Map / Map Minutes mid-attempt dumps (SAFE-MAPORCH). Do not out-Burnout Score™ / wellness-primary under caseload (SAFE-BURNWARN). Do not out-fluency≡pedagogy / LLM-judge-alone wrap ship (SAFE-EXPLAINQA). Do not out-Partial Credit Score™ / all-wrongs-equal gradebook cosplay (SAFE-TAXON). Do not out-hours-booked crunch / Load Shed Score™ / pour≡exam support (SAFE-LOADSHED). Do not out-Distractor Score™ / always-four / beauty-trap MC (SAFE-DISTRACTOR). Do not out-Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence theater (SAFE-CONFMISS). Do not out-parent fireworks portals, Family Leaderboards, or live wrong-answer stalk (SAFE-PDASH). Do not out-Talk Ratio Score / silence theater / Socratic-by-talk-% ads (SAFE-TALK). Do not out-immersive lore / Story Engagement Score / franchise trivia-as-pedagogy (SAFE-STORYLOAD). Do not out-user-count / star-wall / vague-confidence testimonials as learning proof (SAFE-PROOF). Do not out-DAU/streak/XP / FEI Score™ dashboard theater as learning proof (SAFE-INSTRUMENT). Do not out-tutor-headcount vanity or wellness-theater fidelity (SAFE-WORKFORCE). Do not out-grit character apps, therapy Calm Score™, sports academies, conservatories, grandmaster cosplay, pink STEM SKUs, survey-priced ACT guarantees, Ivy-tutor theater, emotion cameras, or FERPA-badge GTM.  Do not out-Microdebrief Score™ / skip-as-default lecture-close (SAFE-MICRODEB). Do not out-24/7 Availability Score™ / fear-parent crunch emails (SAFE-CRUNCHMSG). Do not out-FormatTrap Score™ / beauty visual traps (SAFE-FORMTRAP). Do not out-Brief Score™ / pour-open / late-join shame (SAFE-MICROBRIEF). Do not out-Chegg-hero Dual-CTA Score™ under crunch (SAFE-CRUNCHCTA). Do not out-Figure Key Score™ / fluency SVG pass (SAFE-FIGKEY). Do not out-Wait Minutes·Lobby Score™ / entertainment lobby (SAFE-ASYNCBRIEF). Do not out-Transfer Score™ / dump-and-quit / maze handoff (SAFE-XFERGRAIN). Do not out-HideCorrectness Score™ / tagged≡C4 / fluency eligibility / coverage-padding (SAFE-HCELIG). Do not out-ETA Score™ / soon-wait / optimistic slip / tutor-shame feed (SAFE-KNOWNETA). Do not out-Gate Score™ / universal hard-gate / hint-tax shame (SAFE-SOFTGATE). Do not out-SplitPool Score™ / silent dual-use / auto-promote (SAFE-SPLITPOOL). Do not out-Composition Score™ / pad-scan / diagnose-every-format theater (SAFE-SCANCOMP). Do not out-Hole Trust Score™ / hide-holes / complete-visual ads under holes (SAFE-HOLETRUST). Do not out-Promote Score™ / play-count flip / silent hcelig_pass (SAFE-PROMOTE). Do not out-Cool-Down Score™ / immediate same-stem C4 / pad under cool-down (SAFE-COOLDOWN). Do not out-Student Hole Score™ / fake greens / parent-only honesty / ability-shame hole frames (SAFE-STUDHOLE). Do not out-FillETA Score™ / play-count fill bars / date soft-pass (SAFE-FILLETA). Do not out-Dual Rater Score™ / always-dual·never-dual / mammography cosplay (SAFE-DUALRATE). Do not out-Family Hash Score™ / item_id-only·concept-wide cool-down (SAFE-FAMHASH). Do not out-Exit Emotion Score™ / emotion-AI exit comfort (SAFE-EXITEMO). Do not out-Capacity Score™ / ETA-skipped dual (SAFE-CAPPLAN). Do not out-Template Trust Score™ / silent inherit / forever-dual clones (SAFE-TMPTRUST). Do not out-Kappa % / pooled IRR vanity (SAFE-REPAIRSTRAT). Do not out-Surge Hire % / unsealed freelancer dual / hospital-surge cosplay (SAFE-SURGEPANEL). Do not out-forever-trust latch / frozen sample-% / Template Trust Score™ revoke theater (SAFE-REVOKE). Do not out-Dual Shame Score™ / unconditioned dual rankings / Propensity Theater™ (SAFE-PATHBLAME). Do not out-Parallel Score™ / day-one C4 / Loom≡ready panel theater (SAFE-PANELRAMP). Do not out-Demobilization Score™ / invent-work / cliff-cut (SAFE-DEMOB). Do not out-Gold Set Score™ / open-student canaries (SAFE-GOLDSET). Do not out-Generator Shame Score™ / unlabeled Dual Shame / MSA cosplay (SAFE-POISONSEP). Do not out-Case-Mix Score™ / hide-mix / hospital report-card packets (SAFE-PATHMIX). Do not out-Gold Familiarity Score™ / forever-fixed gold / CAT-security cosplay (SAFE-GOLDROT). Do not out-Forced Blame Score™ / clock≡poison / GRE adjudication cosplay (SAFE-AMBSEAL). Out-compete on the **session + ops + honesty stack**: inspectable diagnosis (SAFE-ONTOLOGY), honest cold-start mapping (SAFE-COLD), format-gap conversion evidence (SAFE-FORMAT), contiguous structural dual-channel figures (SAFE-DUAL), parent MoC proof-age surfaces (SAFE-PDASH), witnessable dated solo competence artifacts (SAFE-PROOF), blueprint-honest coverage matrices with gaps named (SAFE-COVER), faded guidance that earns solo carry (SAFE-FADE), instrumental contingent help not unlimited-hint dumps (SAFE-HELP), FEI North Star events under co-gates not vanity OMTMs (SAFE-INSTRUMENT), contingent soft→hard peeks priced in construction not free dumps (SAFE-HINT), length-contingent principle coaches with SE-before-wrap (SAFE-EXPLAIN), mode-contingent retrieval (TOT cue vs freeze scaffold) without Struggle Score™ (SAFE-RETRIEVE), fidelity-gated productive-failure generate→consolidate when priors allow (SAFE-PF), model→coach→fade apprenticeship phases with articulation (SAFE-APPRENTICE), attempt windows protected from residue and mid-attempt pushes (SAFE-ATTN), connection-first Map when endpoints are green (SAFE-BRIDGE), Map-briefed prompt>pour humans with minute budgets (SAFE-HITL / TUTORGRAIN / WORKFORCE / ROI), grain-local example↔solve timing not universal E0→E3 (SAFE-EXPTIME), phase→control SRL micro-cycles not reflection streaks (SAFE-SRL), SOI-forcing sparse generative asks not AI≡generation (SAFE-GENERATE), stay-diagnose error climate under FEI not poster safety (SAFE-ERRCLIMATE), dual-rail Help vs Practice with solo proof (SAFE-HWHELP), strategy-tied optional gesture/draw not embodiment cosplay (SAFE-GESTURE), building-gated teach-back with solo proof (SAFE-PEERX), predict-commit→surprise→encode not curiosity theater (SAFE-PREDICT), supported structure-map joins not analogy costume (SAFE-ANALOG), short prompted WTL protocols not journal minutes (SAFE-WRITE), FormatId-embedded spatial hops not rotation gyms (SAFE-SPATIAL), evidence→adjust formative cycles not AfL badges (SAFE-FA), feedback uptake loops not delivery≡literacy (SAFE-FBLIT), structured collab with solo FEI gate not Discord≡CSCL (SAFE-COLLAB), horizon-matched DD hold/ease not always-ease/max calendar theater (SAFE-DDSCHED), fidelity-first competence-visible near-peers not Representation Score™ (SAFE-ROLEMODEL), offline-first attempt→capture→confirm not Photomath pipe (SAFE-OFFLINE), protect-then-fade under HMA not forever-E0 (SAFE-FADEX), grain+CTA parent soft-wrong honesty not Miss Streak (SAFE-SOFTMSG), brief→slice→adjust Map not always-on dumps (SAFE-MAPORCH), fidelity/load early-warn→redesign not Burnout Score™ (SAFE-BURNWARN), principle-short wrap QA not fluency theater (SAFE-EXPLAINQA), typed soft-wrong marks not Partial Credit Score™ (SAFE-TAXON), exam-week acuity shed not hours-booked crunch (SAFE-LOADSHED), misconception-mapped distractors not beauty traps (SAFE-DISTRACTOR), confidence×type recovery not Identity Score™ (SAFE-CONFMISS), capped micro-debrief fidelity (SAFE-MICRODEB), shed-honesty crunch parent copy (SAFE-CRUNCHMSG), trap-mapped FormatId distractors (SAFE-FORMTRAP), capped shared-model opens (SAFE-MICROBRIEF), dual-rail crunch CTAs (SAFE-CRUNCHCTA), structural figure key-verify (SAFE-FIGKEY), async Set pre-briefs on wait (SAFE-ASYNCBRIEF), one-tap Solver→Practice transfer grain (SAFE-XFERGRAIN), seals-first FormatId C4 eligibility (SAFE-HCELIG), known-finite late ETAs (SAFE-KNOWNETA), soft-require follow-on with avoidance falsifiers (SAFE-SOFTGATE), graded Practice/C4 pools (SAFE-SPLITPOOL), scarcity-honest scan composition (SAFE-SCANCOMP), parent hole-trust copy (SAFE-HOLETRUST), ticketed promote-to-C4 (SAFE-PROMOTE), reveal→C4 cool-down (SAFE-COOLDOWN), student hole parity copy (SAFE-STUDHOLE), capacity-grounded fill bands (SAFE-FILLETA), risk-triggered dual review (SAFE-DUALRATE), sealed family cool-down hashing (SAFE-FAMHASH), destake gap-scan exits (SAFE-EXITEMO), dual-aware capacity planning (SAFE-CAPPLAN), conditional template-trust inheritance (SAFE-TMPTRUST), path-stratified repair dashboards (SAFE-REPAIRSTRAT), sealed make-or-buy dual surge panels (SAFE-SURGEPANEL), revocable template-trust + switching sample cadence (SAFE-REVOKE), path×stratum blame before dual/single verdicts (SAFE-PATHBLAME), seal-literacy panel ramp before C4 (SAFE-PANELRAMP), planned demobilization without invent-work (SAFE-DEMOB), sealed gold probes for path×stratum monitors (SAFE-GOLDSET), generator-vs-rater poison labels (SAFE-POISONSEP), LEA path-mix honesty in trust packets (SAFE-PATHMIX), gold-bank rotation against tip/familiarity (SAFE-GOLDROT), finite ambiguous re-seal SLAs before poison labels (SAFE-AMBSEAL), verify-before-ship banks (SAFE-GENQ), privacy-bound affect + district trust packets (SAFE-PRIVACY / PROCURE), horizon-matched returns (SAFE-SCHED), calendar-first banded adaptivity (SAFE-ADAPT), time-honest aged evidence (SAFE-FORGET), dual-rail durable GTM (SAFE-DURABLE), mode-conditional feedback clocks (SAFE-FBTIME), SAFE-DP spine under SAFE-DD, productive-error + calibration (SAFE-MISCON / CALIB), recoverable AI truth (SAFE-REPAIR), validated identity on long clocks (SAFE-IDMEASURE / LONGID), structure honesty (SAFE-ELL / GENDER / STRUCTURE), parent CBC (SAFE-WTP), and transfer when help is gone — then *say that* in marketing (CSA-2). Lab process itself obeys SAFE-LABMETA (falsify before “science-backed”).
...
- Example Timing Score™ / universal E0→E3 destiny / fixed≡adaptive fade as learning NS  
- SRL Score™ / reflection-streak / survey-SRL≡event as learning NS  
- Generative Learning Score™ / teach-for-XP / AI≡generation as learning NS  
- Psychological Safety Score™ / Comfort % / poster safe-space as learning NS  
- Homework Completion Score™ / tonight-% / Chegg-dump / assisted≡ready as learning NS  
- Embodiment Score™ / Gesture Score™ / Motion Minutes / pose-camera as learning NS  
- Peer Explanation Score™ / Teach Minutes / Discord≡building as learning NS  
- Curiosity Score™ / cliffhanger-without-commit / postdiction / guess-for-XP as learning NS  
- Analogy Score™ / Mapping Minutes / surface-story≡structure as learning NS  
- Writing Score™ / Journal Minutes / freewrite≡learning as learning NS  
- Spatial Score™ / Mental Rotation Minutes / brain-training≡identity as learning NS  
- Formative Score™ / Assessment Minutes / 0.4–0.7 AfL ads as learning NS  
- Feedback Literacy Score™ / Feedback Minutes / delivery≡uptake as learning NS  
- Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready as learning NS  
- Desirable Difficulty Score™ / Challenge Minutes / always-ease / always-max / cram≡ready as learning NS  
- Representation Score™ / Diversity Minutes / costume≡belonging / match≡quality as learning NS  
- Capture Score™ / Photo Minutes / OCR≡mastery / photo→answer as learning NS  
- Forever-E0 anxious track / Anxiety·Calm Score™ fade gates / Fade Score™ as learning NS  
- Miss Streak / soft-wrong shame push / Parent Correctness Score™ / empty mindset parent letter as learning NS  
- Always-on Map / Map Minutes·Map Score™ / mid-attempt full-graph as learning NS  
- Burnout Score™ / Wellness Minutes / wellness-primary under caseload as learning NS  
- Fluency≡pedagogy / Explanation·Rubric Score™ / LLM-judge-alone wrap ship as learning NS  
- Soft-wrong≡half-credit / Partial Credit Score™ / all-wrongs-equal / gradebook cosplay as learning NS  
- Hours-booked crunch / Load Shed Score™ / infinite-availability / pour≡exam support as learning NS  
- Distractor Score™ / Option Minutes / always-four≡better / beauty traps as learning NS  
- Identity Score™ / Confidence Personality™ / equal-weight recovery / inflate-confidence as learning NS  
- Microdebrief Score™ / Debrief Minutes / skip-as-default lecture-close / +25% ACT debrief ads as learning NS  
- 24/7 availability default / Availability Score™ / hours-hero crunch / fear-parent emails / silent shed as care NS  
- FormatTrap Score™ / Visual Distractor Minutes / seductive stems / beauty visual traps as learning NS  
- Brief Score™ / Brief Minutes / Opening Streak / no-time-for-brief / pour-open / late-join shame as learning NS  
- Dual-CTA Score™ / Help Tonight Minutes / Chegg-hero crunch CTA / fear-countdown dump as learning NS  
- Figure Key Score™ / Visual QA Minutes / fluency SVG≡keyed / unverified FormatId diagnostic as learning NS  
- Wait Minutes / Lobby Score™ / Prebrief Streak / idle spinner / entertainment-primary lobby as learning NS  
- Transfer Score™ / Handoff Minutes / Follow-on Streak / dump-and-quit / maze handoff / assisted≡ready as learning NS  
- HideCorrectness Score™ / Eligibility Minutes / tagged≡C4 / coverage-padding unsealed visuals as learning NS  
- ETA Score™ / Wait Satisfaction / soon-default / optimistic slip / tutor-shame feed as care NS  
- Gate Score™ / Forced Follow-On % / universal hard-gate / hint-tax shame as learning NS  
- SplitPool Score™ / Dual-Use Minutes / silent dual-write / auto-promote as learning NS  
- Composition Score™ / Format Balance % / pad-scan / diagnose-every-format ads as learning NS  
- Hole Trust Score™ / Coverage Satisfaction / hide-holes / complete-visual ads under holes as trust NS  
- Promote Score™ / QA Minutes / play-count auto-promote / silent hcelig_pass as bank-quality NS  
- Cool-Down Score™ / Exposure Minutes / immediate same-stem C4 / pad under cool-down as diagnosis NS  
- Student Hole Score™ / Completeness % / fake greens / parent-only hole honesty as identity NS  
- FillETA Score™ / Backlog Minutes / play-count fill bars / date soft-pass / coming-soon hole clocks as trust NS  
- Dual Rater Score™ / Agreement Minutes / Kappa % / always-dual·never-dual / mammography cosplay as quality NS  
- Family Hash Score™ / Clone Minutes / item_id-only·concept-wide·embedding-only cool-down as learning NS  
- Exit Emotion Score™ / Anxiety·Calm Score™ exit / Mood Minutes / emotion-AI exit empathy as care NS  
- Capacity Score™ / Reviewer Minutes / dual-omitted FILLETA / ETA-skipped dual as honesty NS  
- Template Trust Score™ / Inherit % / silent inherit / forever-dual clones / FERF≡C4-ready as quality NS  
- Kappa % NS / pooled repair vanity / Landis-band marketing / Dual Shame boards as integrity NS  
- Surge Hire % / Contract Minutes / unsealed freelancer dual / hospital-surge cosplay as capacity NS  
- Template Trust Score™ / Sample Dual % / Revoke Minutes / forever-trust latch / frozen sample-% / AQL≡ACT as quality NS  
- Dual Shame Score™ / Selection-Adjusted Repair % / Path Blame Minutes / unconditioned dual rankings as integrity NS  
- Parallel Score™ / Onboard Minutes / Ramp % / day-one C4 / Loom≡ready as scaled-dual NS  
- Demobilization Score™ / Idle Minutes / invent-work / cliff-cut / forever-panel latch as exit NS  
- Gold Set Score™ / Canary Minutes / Probe Hit % / open-student canaries as integrity NS  
- Generator Shame Score™ / Rater Poison Minutes / Blame Separation % / unlabeled Dual Shame as root-cause NS  
- Case-Mix Score™ / Path Mix Minutes / hide-mix / hospital report-card cosplay as LEA-trust NS  
- Gold Familiarity Score™ / Tip Minutes / Rotation Health % / forever-fixed gold / CAT-security cosplay as integrity NS  
- Forced Blame Score™ / Ambiguous Minutes / Decision Velocity % / clock≡poison / GRE adjudication cosplay as resolution NS  
...
| `parent_softmsg_open` | Parent opened soft-wrong grain digest (not miss-streak hero) | SAFE-SOFTMSG honesty (CXVIII) |
| `parent_intrusion_tip_shown` | Autonomy / anti-control tip shown after soft-wrong run | SAFE-SOFTMSG autonomy>control (CXVIII) |
| `map_slice_adjust` | Mid-session grain-slice Map open that changed next prompt/mission | SAFE-MAPORCH adjust (CXIX) |
| `map_student_dual_open` | Student-facing Map open concurrent with active attempt (demote / gate) | SAFE-MAPORCH anti-dual (CXIX) |
...
| `error_episode_fidelity` | Tutor/coach stayed, diagnosed, scaffolded, required re-attempt after miss | SAFE-ERRCLIMATE (CIII) |
...
| `help_rail_mode` | Session labeled Help (instrumental unstuck) vs Practice (FEI gym) | SAFE-HWHELP dual-rail (CIV) |
| `assisted_then_solo_gate` | After Help, solo transfer required before ready claim | SAFE-HWHELP assisted≠solo (CIV) |
| `gesture_strategy_opt_in` | Optional strategy-tied gesture/trace/draw used (not forced) | SAFE-GESTURE optional motion (CV) |
| `peerx_building_code` | Teach-back coded building vs telling (HITL/AI rubric) | SAFE-PEERX quality gate (CVI) |
| `predict_commit_before_reveal` | Prediction logged before feedback/key/demo reveal | SAFE-PREDICT commit wick (CVII) |
| `predict_encode_repair` | After miss/surprise, repair encode before next item | SAFE-PREDICT encode loop (CVII) |
| `analog_map_act` | Student produced source↔target alignment on a join | SAFE-ANALOG mapping act (CVIII) |
| `analog_copresent_ok` | Source kept visible during target comparison | SAFE-ANALOG support (CVIII) |
| `write_protocol_ok` | Short cognitive+metacognitive Notes/protocol chip completed with content | SAFE-WRITE protocol (CIX) |
...
| `feedback_uptake_act` | After coach/tutor feedback, student performed named next attempt | SAFE-FBLIT uptake (CXII) |
| `feedback_decode_ok` | Soft-wrong/coach at concept/ingredient/FormatId grain (not jargon essay) | SAFE-FBLIT decode (CXII) |
| `solo_after_collab` | Solo transfer attempt required after collaborative episode before unlock | SAFE-COLLAB solo gate (CXIII) |
| `collab_accountability_ok` | Group goal + individual check present (not shared-green only) | SAFE-COLLAB Slavin hinge (CXIII) |
| `ddsched_band_ok` | Practice band matches days-to-exam (Build / Join / Protect+probe) | SAFE-DDSCHED horizon (CXIV) |
| `ddsched_stakes_split` | Train sets destaked; prove probes labeled (stakes≠DD) | SAFE-DDSCHED stakes split (CXIV) |
| `rolemodel_fidelity_first` | Tutor passed GRAIN fidelity before any preference match applied | SAFE-ROLEMODEL hire bar (CXV) |
| `rolemodel_competence_visible` | Tutor bio/cue shows attainable near-peer competence (not costume-only) | SAFE-ROLEMODEL Marx signal (CXV) |
| `offline_attempt_before_capture` | Student committed attempt offline before capture unlock | SAFE-OFFLINE attempt grain (CXVI) |
| `capture_ocr_confirmed` | OCR/Map write confirmed by student or tutor before mastery event | SAFE-OFFLINE verify (CXVI) |
| `photo_solve_side_door` | Capture path used as answer-app / full-solution dump | SAFE-OFFLINE anti-Photomath (CXVI) |
| `fadex_hold_ok` | High-MA learner held at protective E0/E1 then advanced without forever track | SAFE-FADEX protect-then-fade (CXVII) |
| `fadex_peek_binge` | Consecutive full peeks treated as safety behavior to fade | SAFE-FADEX exposure join (CXVII) |
| `burnwarn_fidelity_alert` | Fidelity/load early-warn fired before exit (not wellness-primary) | SAFE-BURNWARN early-warn (CXX) |
| `burnwarn_redesign_act` | Caseload/org redesign action logged after alert | SAFE-BURNWARN JD-R (CXX) |
| `explainqa_gate_pass` | Coach wrap passed principle-short + math/key hard-fail before ship | SAFE-EXPLAINQA gate (CXXI) |
| `explainqa_fluency_reject` | Fluent wrap rejected for math/key fail or monologue costume | SAFE-EXPLAINQA anti-fluency (CXXI) |
| `taxon_mark_type` | Miss assigned typed mark (slip/bug/lack/blank/assist) | SAFE-TAXON type (CXXII) |
| `taxon_route_hit` | Typed mark drove Map/route action (not binary red-X only) | SAFE-TAXON route (CXXII) |
| `loadshed_pause_fired` | Named exam-week elective paused per playbook | SAFE-LOADSHED pause list (CXXIII) |
| `loadshed_acuity_ok` | Remaining HITL minutes prioritized high-acuity FEI under crunch | SAFE-LOADSHED acuity (CXXIII) |
| `distractor_mapped_ok` | Chosen MC distractor carries named mis_/trap seal | SAFE-DISTRACTOR map (CXXIV) |
| `distractor_dead_retired` | Non-functioning distractor retired after item analysis | SAFE-DISTRACTOR function (CXXIV) |
| `microdeb_complete` | Close hit four-beat micro-AAR within time cap (student spoke first) | SAFE-MICRODEB complete (CXXVI) |
| `microdeb_trace_ok` | ≥1 objective attempt/media trace cited in close | SAFE-MICRODEB traces (CXXVI) |
| `crunchmsg_shed_named` | Parent crunch message named pause/shed honestly (not silent or 24/7) | SAFE-CRUNCHMSG honesty (CXXVII) |
| `crunchmsg_minutes_frame` | Copy framed protected thinking minutes (not hours-booked hero) | SAFE-CRUNCHMSG framing (CXXVII) |
| `formtrap_seal_ok` | Visual MC distractor carries named format_trap_id (or mis_) | SAFE-FORMTRAP seal (CXXVIII) |
| `formtrap_route_hit` | Format-trap pick drove conversion/FormatId route (not topic-only) | SAFE-FORMTRAP route (CXXVIII) |
| `brief_complete` | Late-join/on-time open hit four-beat micro-brief (or full brief) | SAFE-MICROBRIEF complete (CXXIX) |
| `synthesis_ok` | Student restated edge/success before first problem | SAFE-MICROBRIEF receiver synthesis (CXXIX) |
| `rail_chosen` | Student/parent selected help-tonight vs Practice-gym CTA | SAFE-CRUNCHCTA rail (CXXX) |
| `followon_start` | Practice grain started after Solver instrumental unstick | SAFE-CRUNCHCTA follow-on (CXXX) |
| `figkey_pass` | Generated FormatId figure passed structural/constraint verify with stem∧key | SAFE-FIGKEY pass (CXXXI) |
| `figkey_drop_reason` | Coded fail (stem mismatch / geometry / label / judge-alone reject) | SAFE-FIGKEY drop (CXXXI) |
| `asyncbrief_complete` | Late/early lobby Set card submitted with four beats within cap | SAFE-ASYNCBRIEF complete (CXXXII) |
| `plan_chip_ok` | If-then plan chip present and session-related | SAFE-ASYNCBRIEF implementation intention (CXXXII) |
| `xfer_near_attempt` | Post-Solver Practice grain started on same edge (one-tap) | SAFE-XFERGRAIN near attempt (CXXXIII) |
| `xfer_near_pass` | Near transfer item passed with Solver/AI closed or denied | SAFE-XFERGRAIN near pass (CXXXIII) |
| `xfer_return_due` | SAFE-SCHED return scheduled after transfer grain | SAFE-XFERGRAIN × SCHED (CXXXIII) |
| `hcelig_pass` | FormatId item passed seals for C4 hide-correctness pool | SAFE-HCELIG pass (CXXXIV) |
| `hcelig_block_reason` | Coded block (figkey/genq/formtrap/graphicacy) when tagged≠eligible | SAFE-HCELIG block (CXXXIV) |
| `eta_finite_shown` | Late lobby showed known-finite ETA band (not soon) | SAFE-KNOWNETA finite (CXXXV) |
| `eta_refresh_honest` | ETA refresh without optimistic under-promise | SAFE-KNOWNETA refresh (CXXXV) |
| `softgate_default` | Post-help close used soft-require (Close available) | SAFE-SOFTGATE default (CXXXVI) |
| `hardgate_trigger_ok` | Hard-gate only under named trigger + avoidance falsifier clear | SAFE-SOFTGATE conditional (CXXXVI) |
| `help_avoid_after_gate` | Solver open/help recruit drop after gate escalation | SAFE-SOFTGATE avoidance falsifier (CXXXVI) |
| `pool_practice_only` | Item served from Practice-reveal pool (not C4) | SAFE-SPLITPOOL Practice (CXXXVII) |
| `pool_c4_hcelig` | Item served from C4 HCELIG pool | SAFE-SPLITPOOL C4 (CXXXVII) |
| `silent_dual_write_block` | Practice-only outcome blocked from C4 Map mastery write | SAFE-SPLITPOOL integrity (CXXXVII) |
| `scancomp_hole_flag` | Gap-scan emitted `format_not_probed` for empty sealed cell | SAFE-SCANCOMP hole (CXXXVIII) |
| `scancomp_pad_reject` | Selector rejected symbolic/Practice pad into C4 cell | SAFE-SCANCOMP anti-pad (CXXXVIII) |
| `holetrust_labeled` | Parent summary listed probed vs not_probed + seal reason | SAFE-HOLETRUST label (CXXXIX) |
| `holetrust_cta_one` | Exactly one fill CTA paired with hole (Practice or promote path) | SAFE-HOLETRUST CTA (CXXXIX) |
| `promote_ticket_open` | Practice→C4 promote ticket created with checklist | SAFE-PROMOTE ticket (CXL) |
| `promote_pass` | Ticket closed with seal re-verify + reviewer id → hcelig_pass | SAFE-PROMOTE pass (CXL) |
| `promote_demote` | C4 item demoted on critical repair faster than promote cycle | SAFE-PROMOTE demote (CXL) |
| `cooldown_until` | Per-student stem-family cool-down bar active after reveal | SAFE-COOLDOWN bar (CXLI) |
| `cooldown_subst_ok` | Isomorphic out-of-family substitute used (or hole) under cool-down | SAFE-COOLDOWN substitute (CXLI) |
| `studhole_parity` | Student hole facts match parent HOLETRUST (no dual script) | SAFE-STUDHOLE parity (CXLII) |
| `studhole_no_fake_green` | Unprobed cells not rendered as mastered/flexible | SAFE-STUDHOLE anti-pad (CXLII) |
| `studhole_cta_one` | Student summary had exactly one Practice/open-more CTA | SAFE-STUDHOLE CTA (CXLII) |
| `confmiss_tier_route` | Confidence×type class chose recovery dose (not equal deck) | SAFE-CONFMISS CRI fork (CXXV) |
| `confmiss_highconf_priority` | High-conf miss prioritized for attended destaked springboard | SAFE-CONFMISS hypercorrection (CXXV) |
...
| SAFE-EXPTIME | Grain-local example↔solve timing; adaptive>fixed; no universal E0→E3 / Timing Score™ (Part C) |
| SAFE-SRL | Phase→control SRL cycles; microanalysis>surveys; no SRL Score™ / streak≡SRL (Part CI) |
| SAFE-GENERATE | SOI-forcing sparse GLAs; no Generative Learning Score™ / AI≡generation / teach-for-XP (Part CII) |
| SAFE-ERRCLIMATE | Stay-diagnose error climate; no Safety Score™ / Bermuda-triangle / praise-fog (Part CIII) |
| SAFE-HWHELP | Dual-rail Help vs Practice; no Completion Score™ / Chegg-dump / assisted≡ready (Part CIV) |
| SAFE-GESTURE | Strategy-tied optional gesture/draw; no Embodiment Score™ / styles meshing / pose-camera (Part CV) |
| SAFE-PEERX | Building-gated teach-back; no Peer Explanation Score™ / teach-for-XP / Discord≡building (Part CVI) |
| SAFE-PREDICT | Commit before reveal; encode repair; no Curiosity Score™ / cliffhanger-without-commit / postdiction (Part CVII) |
| SAFE-ANALOG | Structure-map joins; co-present compare; no Analogy Score™ / mention≡pedagogy / surface-story≡structure (Part CVIII) |
| SAFE-WRITE | Short prompted WTL protocols; no Writing Score™ / Journal Minutes / freewrite≡learning / AI≡WTL (Part CIX) |
| SAFE-SPATIAL | FormatId-embedded spatial hops; no Spatial Score™ / Mental Rotation Minutes / brain-training≡identity (Part CX) |
| SAFE-FA | Evidence→adjust cycles; no Formative Score™ / Assessment Minutes / 0.4–0.7 AfL ads (Part CXI) |
| SAFE-FBLIT | Sense+use uptake loops; no Feedback Literacy Score™ / Feedback Minutes / delivery≡uptake / thumbs≡used (Part CXII) |
| SAFE-COLLAB | Structured collab + solo FEI gate; no Collaboration Score™ / Group Minutes / Discord≡CSCL / group-correct≡ready (Part CXIII) |
| SAFE-DDSCHED | Horizon-matched DD hold/ease; stakes≠DD; no Desirable Difficulty Score™ / Challenge Minutes / always-ease / always-max / cram≡ready (Part CXIV) |
| SAFE-ROLEMODEL | Fidelity-first near-peer belonging; competence-visible attainable bios; no Representation Score™ / costume≡belonging / match≡quality (Part CXV) |
| SAFE-OFFLINE | Attempt→capture→confirm; no Capture Score™ / Photo Minutes / OCR≡mastery / photo→answer hero (Part CXVI) |
| SAFE-FADEX | Protect-then-fade under HMA; no forever-E0 / flood / Anxiety·Calm Score™ fade gates (Part CXVII) |
| SAFE-SOFTMSG | Grain+failure-enhancing+one CTA; no Miss Streak / shame-push / empty mindset parent letter (Part CXVIII) |
| SAFE-MAPORCH | Brief→grain-slice→adjust; no always-on Map / Map Minutes / mid-attempt full-graph (Part CXIX) |
| SAFE-BURNWARN | Fidelity/load early-warn→redesign; no Burnout Score™ / wellness-primary under caseload (Part CXX) |
| SAFE-EXPLAINQA | Principle-short wrap QA gates; no fluency≡pedagogy / LLM-judge-alone / soft-pass wrong math (Part CXXI) |
| SAFE-TAXON | Typed soft-wrong marks; no Partial Credit Score™ / all-wrongs-equal / gradebook cosplay (Part CXXII) |
| SAFE-LOADSHED | Exam-week acuity shed; no hours-booked crunch / Load Shed Score™ / pour≡exam support (Part CXXIII) |
| SAFE-DISTRACTOR | Misconception-mapped functioning distractors; soft-wrong from chosen option; no Distractor Score™ / always-four / beauty traps (Part CXXIV) |
| SAFE-CONFMISS | Confidence×type gap-scan miss recovery; CRI fork + hypercorrection priority; no Identity Score™ / equal-weight recovery / inflate-confidence NS (Part CXXV) |
| SAFE-MICRODEB | Capped student-first micro-AAR with traces; no Microdebrief Score™ / skip-as-default / lecture-as-debrief (Part CXXVI) |
| SAFE-CRUNCHMSG | Shed-honesty crunch parent CBC/messages; no 24/7 default / hours-hero / fear-parent emails / Availability Score™ (Part CXXVII) |
| SAFE-FORMTRAP | Named format-trap visual distractors; coherent structural stems; no FormatTrap Score™ / seductive stems / beauty visual traps (Part CXXVIII) |
| SAFE-MICROBRIEF | Capped shared-model open + student synthesis; no Brief Score™ / no-time-for-brief / pour-open / late-join shame (Part CXXIX) |
| SAFE-CRUNCHCTA | Dual labeled Solver/Practice CTAs under crunch; instrumental verbs + follow-on Practice; no Chegg-hero / Dual-CTA Score™ / fear-dump (Part CXXX) |
| SAFE-FIGKEY | Structural figure key-verify for FormatId generation; deterministic spine + use gating; no fluency SVG / judge-alone / Figure Key Score™ (Part CXXXI) |
| SAFE-ASYNCBRIEF | Capped async Set card on late/early wait; session-related occupied wait + verify handoff; no Wait Minutes / Lobby Score™ / pour-open wait (Part CXXXII) |
| SAFE-XFERGRAIN | One-tap edge-matched Practice grain after instrumental Solver; solo gate + SCHED return; no dump-and-quit / Transfer Score™ / maze handoff (Part CXXXIII) |
| SAFE-HCELIG | Seals-first FormatId C4 eligibility; honest holes > pad; no HideCorrectness Score™ / tagged≡C4 (Part CXXXIV) |
| SAFE-KNOWNETA | Known-finite late-tutor ETA + refresh honesty; no ETA Score™ / soon-default / shame feed (Part CXXXV) |
| SAFE-SOFTGATE | Soft-require default; conditional hard-gate + avoidance falsifiers; no Gate Score™ / hint-tax shame (Part CXXXVI) |
| SAFE-SPLITPOOL | Graded Practice vs C4 pools; ticketed promote; no SplitPool Score™ / silent dual-write (Part CXXXVII) |
| SAFE-SCANCOMP | Sealed-stock scan composition with labeled holes; no Composition Score™ / pad theater (Part CXXXVIII) |
| SAFE-HOLETRUST | Parent hole honesty + one fill CTA; no Hole Trust Score™ / hide-holes / complete-visual ads (Part CXXXIX) |
| SAFE-PROMOTE | Ticketed Practice→C4 QA; demote faster than promote; no Promote Score™ / play-count flip (Part CXL) |
| SAFE-COOLDOWN | Per-student reveal→C4 cool-down + substitutes/holes; no Cool-Down Score™ / immediate same-stem C4 (Part CXLI) |
| SAFE-STUDHOLE | Student hole parity + product-hole frame + one CTA; no Student Hole Score™ / fake greens (Part CXLII) |
| SAFE-FILLETA | Capacity-grounded finite fill bands; no FillETA Score™ / play-count bars / date soft-pass (Part CXLIII) |
| SAFE-DUALRATE | Risk-triggered second rater; seals before dual; no Dual Rater Score™ / always-dual·never-dual (Part CXLIV) |
| SAFE-FAMHASH | Sealed isomorphic family cool-down unit; no Family Hash Score™ / item_id-only·concept-wide ban (Part CXLV) |
| SAFE-EXITEMO | Destake gap-scan exit + one CTA; no Exit Emotion Score™ / emotion-AI exit comfort (Part CXLVI) |
| SAFE-CAPPLAN | Dual minutes in FILLETA estimator; no Capacity Score™ / ETA-skipped dual (Part CXLVII) |
| SAFE-TMPTRUST | Inherit intensity not seals; sample+revoke; no Template Trust Score™ / silent inherit (Part CXLVIII) |
| SAFE-REPAIRSTRAT | Path-stratified repair dashboards; κ aide not NS; no Kappa % / pooled IRR vanity (Part CXLIX) |
| SAFE-SURGEPANEL | Sealed make-or-buy dual surge portfolio; no Surge Hire % / unsealed freelancer dual (Part CL) |
| SAFE-REVOKE | Revocable template-trust + switching sample cadence; no Template Trust Score™ / forever-trust latch (Part CLI) |
| SAFE-PATHBLAME | Path×stratum blame before dual/single quality verdicts; no Dual Shame Score™ / unconditioned rankings (Part CLII) |
| SAFE-PANELRAMP | Seal literacy + shadow dual before contract C4 authority; no Parallel Score™ / day-one C4 (Part CLIII) |
| SAFE-DEMOB | Planned post-spike dual wind-down; no Demobilization Score™ / invent-work / cliff-cut (Part CLIV) |
| SAFE-GOLDSET | Blind sealed gold probes for path×stratum monitors; no Gold Set Score™ / student canaries (Part CLV) |
| SAFE-POISONSEP | Label gen vs rater vs ambiguous poison on inherit repair; no Generator Shame Score™ / unlabeled Dual Shame (Part CLVI) |
| SAFE-PATHMIX | Dated path-mix + routing rationale in LEA trust packets; no Dual Shame / Case-Mix Score™ / hospital cosplay (Part CLVII) |
| SAFE-GOLDROT | Rotate + exposure-cap sealed gold bank against tip/familiarity; no Gold Familiarity Score™ / forever-fixed gold (Part CLVIII) |
| SAFE-AMBSEAL | Finite dual re-seal/gold SLA for ambiguous poison tickets; no Forced Blame Score™ / clock≡poison (Part CLIX) |
| SAFE-MIXREFRESH | Event+calendar path-mix refresh/stale after DEMOB·CAPPLAN; no Mix Freshness Score™ / forever-green surge mix (Part CLX; provisional) |
...
3bb. Feedback literacy (coach feedback uptake) — **DONE** Part CXII / SAFE-FBLIT  
3bc. Collaborative problem-solving vs solo FEI — **DONE** Part CXIII / SAFE-COLLAB  
3bd. Desirable difficulty scheduling under exam deadlines — **DONE** Part CXIV / SAFE-DDSCHED  
...
3bh. Worked-example fading under high math anxiety — **DONE** Part CXVII / SAFE-FADEX  
3bi. Parent message framing after soft-wrong streaks — **DONE** Part CXVIII / SAFE-SOFTMSG  
3bj. Classroom orchestration of Map during live tutoring — **DONE** Part CXIX / SAFE-MAPORCH  
3bk. Tutor burnout early-warning without wellness theater — **DONE** Part CXX / SAFE-BURNWARN
3bl. Explanation quality rubrics for AI coach wraps — **DONE** Part CXXI / SAFE-EXPLAINQA  
3bm. Partial-credit & soft-wrong taxonomy productization — **DONE** Part CXXII / SAFE-TAXON  
3bn. Exam-week tutor load shedding playbooks — **DONE** Part CXXIII / SAFE-LOADSHED  
3bo. Distractor design for diagnostic soft-wrong MC — **DONE** Part CXXIV / SAFE-DISTRACTOR  
3bp. Confidence-tagged misses in gap-scan recovery — **DONE** Part CXXV / SAFE-CONFMISS  
3bq. **Synthesizer v1.16** — merge CXVII–CXXV into I.4 company law — **DONE**  
3br. Tutor micro-debrief fidelity under time caps — **DONE** Part CXXVI / SAFE-MICRODEB  
3bs. Parent crunch-week message tests (availability vs thinking minutes) — **DONE** Part CXXVII / SAFE-CRUNCHMSG  
3bt. Format-trap distractors on diagram/graph items — **DONE** Part CXXVIII / SAFE-FORMTRAP  
3bu. Session-open brief fidelity under late joins — **DONE** Part CXXIX / SAFE-MICROBRIEF  
3bv. Dual-rail Solver CTA copy under crunch — **DONE** Part CXXX / SAFE-CRUNCHCTA  
3bw. Figure key-verify loops for generated FormatId stems — **DONE** Part CXXXI / SAFE-FIGKEY  
3bx. Async pre-brief cards while waiting for late tutor — **DONE** Part CXXXII / SAFE-ASYNCBRIEF  
3by. One-tap Solver→Practice transfer grain after instrumental help — **DONE** Part CXXXIII / SAFE-XFERGRAIN  
3bz. **Synthesizer v1.17** — merge CXXVI–CXXXIII into I.4 company law — **DONE**  
3ca. Hide-correctness eligibility gates for FormatId items — **DONE** Part CXXXIV / SAFE-HCELIG  
3cb. Known-finite ETA honesty in late-tutor lobby copy — **DONE** Part CXXXV / SAFE-KNOWNETA  
3cc. Soft-require vs hard-gate follow-on under help-avoidance risk — **DONE** Part CXXXVI / SAFE-SOFTGATE  
3cd. Reveal-Practice vs C4 split pools for sealed FormatId — **DONE** Part CXXXVII / SAFE-SPLITPOOL  
3ce. FormatId gap-scan composition under sealed-stock scarcity — **DONE** Part CXXXVIII / SAFE-SCANCOMP  
3cf. Parent trust copy when visual diagnostic holes remain — **DONE** Part CXXXIX / SAFE-HOLETRUST  
3cg. Promote-to-C4 tutor QA workflow for Practice-only FormatId — **DONE** Part CXL / SAFE-PROMOTE  
3ch. Exposure cool-down after reveal before same-stem C4 — **DONE** Part CXLI / SAFE-COOLDOWN  
3ci. Student-facing hole copy after gap-scan — **DONE** Part CXLII / SAFE-STUDHOLE  
3ci2. **Synthesizer v1.18** — merge CXXXIV–CXLII into I.4 company law — **DONE**  
3ci3. Promote backlog SLA vs parent hole-ETA honesty — **DONE** Part CXLIII / SAFE-FILLETA  
3ci4. Second-rater thresholds for figured C4 admits — **DONE** Part CXLIV / SAFE-DUALRATE  
3ci5. Isomorphic stem-family hashing for cool-down — **DONE** Part CXLV / SAFE-FAMHASH  
3cj. Gap-scan exit emotion without Anxiety Score™ — **DONE** Part CXLVI / SAFE-EXITEMO  
3ck. Dual-rater capacity planning vs FILLETA band honesty — **DONE** Part CXLVII / SAFE-CAPPLAN  
3cl. Template-trust inheritance after first-of-cell dual admit — **DONE** Part CXLVIII / SAFE-TMPTRUST  
3cm. Post-promote repair stratified dashboards (single vs dual) — **DONE** Part CXLIX / SAFE-REPAIRSTRAT  
3cn. Dual-capacity hire vs contract SME panels under exam-week spikes — **DONE** Part CL / SAFE-SURGEPANEL  
3cn2. **Synthesizer v1.19** — merge CXLIII–CL into I.4 company law — **DONE**  
3co. Template-trust revoke & sample-dual cadence — **DONE** Part CLI / SAFE-REVOKE (id 151)  
3cp. Path-conditioned dual blame tests — **DONE** Part CLII / SAFE-PATHBLAME (id 152)  
3cq. Contract SME panel seal onboarding & parallel-run gates — **DONE** Part CLIII / SAFE-PANELRAMP (id 153)  
3cr. Post-spike dual demobilization without fidelity cliff — **DONE** Part CLIV / SAFE-DEMOB (id 154)  
3cs. Gold-set planted probes for path×stratum monitors — **DONE** Part CLV / SAFE-GOLDSET (id 155)  
3ct. Generator vs rater poison separation on inherit repair — **DONE** Part CLVI / SAFE-POISONSEP (id 156)  
3cu. LEA packet path-mix honesty without Dual Shame theater — **DONE** Part CLVII / SAFE-PATHMIX (id 157)  
3cv. Gold-bank rotation & tip-resistance under rater familiarity — **DONE** Part CLVIII / SAFE-GOLDROT (id 158)  
3cw. Ambiguous-ticket dual re-seal SLA before poison labels — **DONE** Part CLIX / SAFE-AMBSEAL (id 159)  
3cw2. **Synthesizer v1.20** — merge CLI–CLIX into I.4 company law — **DONE**  
3cx. Path-mix packet refresh cadence after surge demobilization — **DONE** Part CLX / SAFE-MIXREFRESH (id 160)  
3cy. Panel-cohort gold hygiene audits during parallel-run — **NEXT** id 161  
3cz. Ambiguous re-seal capacity vs FILLETA band honesty — queued id 162  
3da. Staff vs contract dual-share footnotes in path-mix after demob — queued id 163  
...
81. **Synthesizer v1.14 (2026-08-09):** Merged C–CVII into I.4 / XIV / IX / XXI — no new chapter  
...
86. **DONE (2026-08-09):** Feedback literacy / coach uptake (Part CXII / id 112) — SAFE-FBLIT stack  
87. **DONE (2026-08-09):** Collaborative problem-solving vs solo FEI (Part CXIII / id 113) — SAFE-COLLAB stack  
88. **DONE (2026-08-10):** Desirable difficulty scheduling under exam deadlines (Part CXIV / id 114) — SAFE-DDSCHED stack  
89. **DONE (2026-08-10):** Tutor identity & belonging / near-peer role models (Part CXV / id 115) — SAFE-ROLEMODEL stack  
90. **DONE (2026-08-10):** Offline practice fidelity / paper-whiteboard capture (Part CXVI / id 116) — SAFE-OFFLINE stack  
91. **Synthesizer v1.15 (2026-08-10):** Merged CVIII–CXVI into I.4 / XIV / IX / XXI — no new chapter  
92. **DONE (2026-08-10):** Worked-example fading under high math anxiety (Part CXVII / id 117) — SAFE-FADEX stack  
93. **DONE (2026-08-10):** Parent message framing after soft-wrong streaks (Part CXVIII / id 118) — SAFE-SOFTMSG stack  
94. **DONE (2026-08-10):** Classroom orchestration of Map during live tutoring (Part CXIX / id 119) — SAFE-MAPORCH stack  
95. **DONE (2026-08-10):** Tutor burnout early-warning without wellness theater (Part CXX / id 120) — SAFE-BURNWARN stack  
96. **DONE (2026-08-11):** Explanation quality rubrics for AI coach wraps (Part CXXI / id 121) — SAFE-EXPLAINQA stack  
97. **DONE (2026-08-11):** Partial-credit & soft-wrong taxonomy (Part CXXII / id 122) — SAFE-TAXON stack  
98. **DONE (2026-08-11):** Exam-week tutor load shedding playbooks (Part CXXIII / id 123) — SAFE-LOADSHED stack  
99. **DONE (2026-08-11):** Distractor design for diagnostic soft-wrong MC (Part CXXIV / id 124) — SAFE-DISTRACTOR stack  
100. **DONE (2026-08-11):** Confidence-tagged misses in gap-scan recovery (Part CXXV / id 125) — SAFE-CONFMISS stack  
101. **DONE (2026-08-11):** Tutor micro-debrief fidelity under time caps (Part CXXVI / id 126) — SAFE-MICRODEB stack  
102. **DONE (2026-08-11):** Parent crunch-week message tests (Part CXXVII / id 127) — SAFE-CRUNCHMSG stack  
103. **DONE (2026-08-12):** Format-trap distractors on diagram/graph items (Part CXXVIII / id 128) — SAFE-FORMTRAP stack  
104. **DONE (2026-08-12):** Session-open brief fidelity under late joins (Part CXXIX / id 129) — SAFE-MICROBRIEF stack  
105. **DONE (2026-08-12):** Dual-rail Solver CTA copy under crunch (Part CXXX / id 130) — SAFE-CRUNCHCTA stack  
106. **DONE (2026-08-12):** Figure key-verify loops for generated FormatId stems (Part CXXXI / id 131) — SAFE-FIGKEY stack  
107. **DONE (2026-08-12):** Async pre-brief cards while waiting for late tutor (Part CXXXII / id 132) — SAFE-ASYNCBRIEF stack  
108. **DONE (2026-08-12):** One-tap Solver→Practice transfer grain after instrumental help (Part CXXXIII / id 133) — SAFE-XFERGRAIN stack  
109. **Synthesizer v1.16 (2026-08-11):** Merged CXVII–CXXV into I.4 / XIV / IX / XXI — no new chapter  
110. **Synthesizer v1.17 (2026-08-12):** Merged CXXVI–CXXXIII into I.4 / XIV / IX / XXI — no new chapter  
111. **DONE (2026-08-13):** Hide-correctness eligibility gates for FormatId items (Part CXXXIV / id 134) — SAFE-HCELIG stack  
112. **DONE (2026-08-13):** Known-finite ETA honesty in late-tutor lobby copy (Part CXXXV / id 135) — SAFE-KNOWNETA stack  
113. **DONE (2026-08-13):** Soft-require vs hard-gate follow-on under help-avoidance (Part CXXXVI / id 136) — SAFE-SOFTGATE stack  
114. **DONE (2026-08-13):** Reveal-Practice vs C4 split pools for sealed FormatId (Part CXXXVII / id 137) — SAFE-SPLITPOOL stack  
115. **DONE (2026-08-13):** FormatId gap-scan composition under sealed-stock scarcity (Part CXXXVIII / id 138) — SAFE-SCANCOMP stack  
116. **DONE (2026-08-13):** Parent trust copy when visual diagnostic holes remain (Part CXXXIX / id 139) — SAFE-HOLETRUST stack  
117. **DONE (2026-08-13):** Promote-to-C4 tutor QA workflow for Practice-only FormatId (Part CXL / id 140) — SAFE-PROMOTE stack  
118. **DONE (2026-08-13):** Exposure cool-down after reveal before same-stem C4 (Part CXLI / id 141) — SAFE-COOLDOWN stack  
119. **DONE (2026-08-14):** Student-facing hole copy after gap-scan (Part CXLII / id 142) — SAFE-STUDHOLE stack  
120. **Synthesizer v1.18 (2026-08-14):** Merged CXXXIV–CXLII into I.4 / XIV / IX / XXI — no new chapter  
121. **DONE (2026-08-14):** Promote backlog SLA vs parent hole-ETA honesty (Part CXLIII / id 143) — SAFE-FILLETA stack  
122. **DONE (2026-08-14):** Second-rater thresholds for figured C4 admits (Part CXLIV / id 144) — SAFE-DUALRATE stack  
123. **DONE (2026-08-14):** Isomorphic stem-family hashing for cool-down (Part CXLV / id 145) — SAFE-FAMHASH stack  
124. **DONE (2026-08-14):** Gap-scan exit emotion without Anxiety Score™ (Part CXLVI / id 146) — SAFE-EXITEMO stack  
125. **DONE (2026-08-15):** Dual-rater capacity planning vs FILLETA band honesty (Part CXLVII / id 147) — SAFE-CAPPLAN stack  
126. **DONE (2026-08-15):** Template-trust inheritance after first-of-cell dual admit (Part CXLVIII / id 148) — SAFE-TMPTRUST stack  
127. **DONE (2026-08-15):** Post-promote repair stratified dashboards (Part CXLIX / id 149) — SAFE-REPAIRSTRAT stack  
128. **DONE (2026-08-15):** Dual-capacity hire vs contract SME panels (Part CL / id 150) — SAFE-SURGEPANEL stack  
129. **Synthesizer v1.19 (2026-08-15):** Merged CXLIII–CL into I.4 / XIV / IX / XXI — no new chapter  
130. **DONE (2026-08-15):** Template-trust revoke & sample-dual cadence (Part CLI / id 151) — SAFE-REVOKE stack  
131. **DONE (2026-08-15):** Path-conditioned dual blame tests (Part CLII / id 152) — SAFE-PATHBLAME stack  
132. **DONE (2026-08-16):** Contract SME panel seal onboarding & parallel-run gates (Part CLIII / id 153) — SAFE-PANELRAMP stack  
133. **DONE (2026-08-16):** Post-spike dual demobilization without fidelity cliff (Part CLIV / id 154) — SAFE-DEMOB stack  
134. **DONE (2026-08-16):** Gold-set planted probes for path×stratum monitors (Part CLV / id 155) — SAFE-GOLDSET stack  
135. **DONE (2026-08-16):** Generator vs rater poison separation on inherit repair (Part CLVI / id 156) — SAFE-POISONSEP stack  
136. **DONE (2026-08-16):** LEA packet path-mix honesty without Dual Shame theater (Part CLVII / id 157) — SAFE-PATHMIX stack  
137. **DONE (2026-08-16):** Gold-bank rotation & tip-resistance under rater familiarity (Part CLVIII / id 158) — SAFE-GOLDROT stack  
138. **DONE (2026-08-17):** Ambiguous-ticket dual re-seal SLA before poison labels (Part CLIX / id 159) — SAFE-AMBSEAL stack  
139. **Synthesizer v1.20 (2026-08-17):** Merged CLI–CLIX into I.4 / XIV / IX / XXI — no new chapter  
140. **DONE (2026-08-17):** Path-mix packet refresh cadence after surge demobilization (Part CLX / id 160) — SAFE-MIXREFRESH stack  
141. **NEXT:** Panel-cohort gold hygiene audits during parallel-run (id 161)
...
**v1.19 synthesizer pass folded Parts CXLIII–CL into surviving commercial doctrine (I.4 rows SAFE-FILLETA through SAFE-SURGEPANEL; Red Team kills #97–#104 promoted from provisional). Experiment families FILLETA/DUALRATE/FAMHASH/EXITEMO/CAPPLAN/TMPTRUST/REPAIRSTRAT/SURGEPANEL confirmed mounted alongside HCELIG→STUDHOLE. Company law now covers capacity-grounded hole-fill ETA bands, risk-triggered second-rater thresholds, sealed stem-family hashing, destake gap-scan exits, dual-aware FILLETA capacity, conditional template-trust inheritance, path-stratified repair dashboards, and sealed make-or-buy dual surge panels — without FillETA/Dual Rater/Family Hash/Exit Emotion/Capacity/Template Trust/Kappa/Surge Hire Score™ costumes. Next researcher id: CLI template-trust revoke cadence. Researcher count since v1.19 synthesizer = 0. Page count is not the finish line — falsifiable truth is.**
