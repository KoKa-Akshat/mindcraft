...
Queued next: see `NEXT_LAB.md` (Part CXXXV known-finite ETA lobby honesty, then 136+). Company law through CXXXIII (v1.17); CXXXIV provisional pending synthesizer.
