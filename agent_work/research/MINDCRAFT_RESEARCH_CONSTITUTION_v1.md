...
Queued next: see `NEXT_LAB.md` (Part CLX path-mix refresh, then 161+). Company law through CLIX (v1.20).
...
**Next research bottleneck:** Part CLX **Path-mix packet refresh cadence after surge demobilization**. Company law through SAFE-AMBSEAL (CLIX / v1.20). Experiment families …/SURGEPANEL/**REVOKE**/**PATHBLAME**/**PANELRAMP**/**DEMOB**/**GOLDSET**/**POISONSEP**/**PATHMIX**/**GOLDROT**/**AMBSEAL** gate claims above L1. Researcher count since v1.20 synthesizer = **0**.
...
3cx. Path-mix packet refresh cadence after surge demobilization — **NEXT** id 160  
3cy. Panel-cohort gold hygiene audits during parallel-run — queued id 161  
...
140. **NEXT:** Path-mix packet refresh cadence after surge demobilization (id 160)
