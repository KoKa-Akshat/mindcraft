...
Queued next: see `NEXT_LAB.md` (Part CXXX dual-rail Solver CTA under crunch, then 131+).
...
3bv. Dual-rail Solver CTA copy under crunch — queued id 130 **NEXT**  
3bw. Figure key-verify loops for generated FormatId stems — queued id 131  
