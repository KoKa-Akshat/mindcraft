...
Queued next: see `NEXT_LAB.md` (Part CXXXIII one-tap Solver→Practice transfer, then 134+).
...
3by. One-tap Solver→Practice transfer grain after instrumental help — queued id 133 **NEXT**  
3bz. Hide-correctness eligibility gates for FormatId items — queued id 134  
...
108. **Synthesizer v1.16 (2026-08-11):** Merged CXVII–CXXV into I.4 / XIV / IX / XXI — no new chapter  
109. **NEXT:** One-tap Solver→Practice transfer grain after instrumental help (id 133)
