...
Queued next: see `NEXT_LAB.md` (Part CLVII LEA path-mix honesty, then 158+). Company law through CL (v1.19); CLI–CLVI provisional pending synthesizer.
...
**Next research bottleneck:** Part CLVII **LEA packet path-mix honesty without Dual Shame theater**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) + SAFE-PATHBLAME (CLII) + SAFE-PANELRAMP (CLIII) + SAFE-DEMOB (CLIV) + SAFE-GOLDSET (CLV) + SAFE-POISONSEP (CLVI) provisional** densifiers pending synthesizer. Experiment families …/SURGEPANEL/**REVOKE**/**PATHBLAME**/**PANELRAMP**/**DEMOB**/**GOLDSET**/**POISONSEP** gate claims above L1. Researcher count since v1.19 synthesizer = **6**.
...
3cu. LEA packet path-mix honesty without Dual Shame theater — **NEXT** id 157  
3cv. Gold-bank rotation & tip-resistance under rater familiarity — queued id 158  
...
135. **NEXT:** Generator vs rater poison separation on inherit repair (id 156)
