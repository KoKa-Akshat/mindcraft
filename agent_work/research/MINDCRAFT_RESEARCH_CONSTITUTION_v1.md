...
Queued next: see `NEXT_LAB.md` (Part CXXXVII Reveal-Practice vs C4 split pools, then 138+). Company law through CXXXIII (v1.17); CXXXIV–CXXXVI provisional pending synthesizer.
...
**Next research bottleneck:** Part CXXXVII **Reveal-Practice vs C4 split pools for sealed FormatId**. Provisional densifiers landed: SAFE-HCELIG (CXXXIV), SAFE-KNOWNETA (CXXXV), SAFE-SOFTGATE (CXXXVI). Experiment families CAL/DP/CoP/RIT/AAR/FILM/MUSIC/ANNOT/EXP- gate claims above L1. Researcher count since v1.17 synthesizer = **3**.
...
3cd. Reveal-Practice vs C4 split pools for sealed FormatId — **NEXT** id 137  
3ce. FormatId gap-scan composition under sealed-stock scarcity — queued id 138  
...
114. **NEXT:** Reveal-Practice vs C4 split pools for sealed FormatId (id 137)
