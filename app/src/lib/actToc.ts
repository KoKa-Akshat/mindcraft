...
export const ACT_TOC_SECTIONS: ActTocSection[] = [
  {
    ...
    wash: 'linear-gradient(180deg, #fff8e9 0%, #f9dfcf 100%)',
    accent: '#c4783a',
    ink: '#6b3d28',
  ...
  },
  {
    ...
    wash: 'linear-gradient(180deg, #f4faf5 0%, #e4f7dc 100%)',
    accent: '#247a4d',
    ink: '#143a2e',
  ...
  },
  {
    ...
    wash: 'linear-gradient(180deg, #f4fafc 0%, #dceef6 100%)',
    accent: '#2f7a8f',
    ink: '#164455',
  ...
  },
  {
    ...
    wash: 'linear-gradient(180deg, #fffdf7 0%, #f5efd9 100%)',
    accent: '#d3a900',
    ink: '#5c4a10',
