...
export const PRACTICE_CONCEPTS: { id: string; label: string; category: string; emoji: string }[] = [
  ...
  { id:'radical_expressions',        label:'Radicals',             category:'Algebra',      emoji:'√' },
  { id:'polynomials',                label:'Polynomials',          category:'Algebra',      emoji:'〽️' },
  { id:'factoring_polynomials',      label:'Factoring',            category:'Algebra',      emoji:'🔍' },
  { id:'quadratic_equations',        label:'Quadratic Equations',  category:'Algebra',      emoji:'🧮' },
  { id:'complex_numbers',            label:'Complex Numbers',      category:'Algebra',      emoji:'i' },
  { id:'rational_expressions',       label:'Rational Expressions', category:'Algebra',      emoji:'➗' },
  { id:'sequences_series',           label:'Sequences & Series',   category:'Algebra',      emoji:'Σ' },
  ...
  { id:'exponential_functions',      label:'Exponential Functions', category:'Algebra',     emoji:'eˣ' },
  { id:'logarithmic_functions',      label:'Logarithms',           category:'Algebra',      emoji:'log' },
  { id:'lines_angles',               label:'Lines & Angles',       category:'Geometry',     emoji:'∠' },
  { id:'triangles_congruence',       label:'Triangles',            category:'Geometry',     emoji:'△' },
  { id:'right_triangle_geometry',    label:'Right Triangles',      category:'Geometry',     emoji:'◢' },
  { id:'coordinate_geometry',        label:'Coordinate Geometry', category:'Geometry',       emoji:'🗺️' },
  { id:'circles_geometry',           label:'Circles',              category:'Geometry',     emoji:'○' },
  { id:'area_volume',                label:'Area & Volume',        category:'Geometry',     emoji:'▣' },
  { id:'geometric_transformations',  label:'Transformations',      category:'Geometry',     emoji:'↻' },
  { id:'trigonometry_basics',        label:'Trigonometry',        category:'Geometry',       emoji:'📐' },
  { id:'trigonometric_identities',   label:'Trig Identities',      category:'Geometry',     emoji:'sin' },
  { id:'vectors',                    label:'Vectors',              category:'Geometry',     emoji:'→' },
  ...
  { id:'statistics_graphs',          label:'Statistics & Graphs',  category:'Statistics',   emoji:'▥' },
  { id:'data_interpretation',        label:'Data Interpretation',  category:'Statistics',   emoji:'▤' },
  { id:'basic_probability',          label:'Probability',          category:'Statistics',   emoji:'🎲' },
  { id:'limits_continuity',          label:'Limits',               category:'Calculus',     emoji:'lim' },
  { id:'derivatives',                label:'Derivatives',          category:'Calculus',     emoji:"f'" },
  { id:'applications_of_derivatives',label:'Applied Derivatives',  category:'Calculus',     emoji:'max' },
  { id:'integrals',                  label:'Integrals',            category:'Calculus',     emoji:'∫' },
  { id:'applications_of_integrals',  label:'Applied Integrals',    category:'Calculus',     emoji:'∫dx' },
]
...
const BANK_ALIASES: Record<string, string> = {
  // ontology → bank concept ids
  ratios_proportions:          'ratios_proportions',   // v4 bank; percent_ratio is the legacy static alias
  percent_ratio:               'ratios_proportions',   // legacy static → v4 preferred
  ...
  algebraic_manipulation:      'linear_equations',
