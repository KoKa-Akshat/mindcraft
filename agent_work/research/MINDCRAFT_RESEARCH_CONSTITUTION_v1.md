...
Queued next: see `NEXT_LAB.md` (Part CLIV post-spike dual demobilization, then 155+). Company law through CL (v1.19); CLI–CLIII provisional pending synthesizer.
...
**Next research bottleneck:** Part CLIV **Post-spike dual demobilization without fidelity cliff**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) + SAFE-PATHBLAME (CLII) + SAFE-PANELRAMP (CLIII) provisional** densifiers pending synthesizer. Experiment families …/SURGEPANEL/**REVOKE**/**PATHBLAME**/**PANELRAMP** gate claims above L1. Researcher count since v1.19 synthesizer = **3**.
...
3cr. Post-spike dual demobilization without fidelity cliff — **NEXT** id 154  
3cs. Gold-set planted probes for path×stratum monitors — queued id 155  
...
133. **NEXT:** Post-spike dual demobilization without fidelity cliff (id 154)
