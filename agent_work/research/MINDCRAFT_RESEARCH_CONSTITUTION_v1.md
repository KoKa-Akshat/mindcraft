...
**Edition:** v1.16 (Synthesizer consolidation of Parts CXVII–CXXV into surviving doctrine)  
...
**Last updated:** 2026-08-11 (Synthesizer v1.16 — CXVII–CXXV company law)  
...
| CXXVI | `chapters/126_tutor_micro_debrief_fidelity_under_time_caps.md` | Tutor micro-debrief fidelity under time caps; SAFE-MICRODEB *(provisional)*; capped AAR without lecture cosplay |
| CXXVII | `chapters/127_parent_crunch_week_message_tests.md` | Parent crunch-week message tests; SAFE-CRUNCHMSG *(provisional)*; shed honesty vs 24/7 CBC |
| CXXVIII | `chapters/128_format_trap_distractors_diagram_graph_items.md` | Format-trap distractors on diagram/graph items; SAFE-FORMTRAP *(provisional)*; visual traps without decoration theater |
| CXXIX | `chapters/129_session_open_brief_fidelity_under_late_joins.md` | Session-open brief fidelity under late joins; SAFE-MICROBRIEF *(provisional)*; capped shared-model open |
| CXXX | `chapters/130_dual_rail_solver_cta_copy_under_crunch.md` | Dual-rail Solver CTA copy under crunch; SAFE-CRUNCHCTA *(provisional)*; help tonight vs Practice gym without Chegg hero |
| CXXXI | `chapters/131_figure_key_verify_loops_generated_formatid.md` | Figure key-verify loops for generated FormatId stems; SAFE-FIGKEY *(provisional)*; structural gates without fluency SVG pass |
| CXXXII | `chapters/132_async_prebrief_cards_late_tutor_wait.md` | Async pre-brief cards while waiting for late tutor; SAFE-ASYNCBRIEF *(provisional)*; student-owned Set without idle lobby |
| CXXXIII | `chapters/133_one_tap_solver_practice_transfer_grain.md` | One-tap Solver→Practice transfer grain; SAFE-XFERGRAIN *(provisional)*; handoff without dump-and-quit |

Queued next: see `NEXT_LAB.md` (Part CXXXIV hide-correctness FormatId eligibility, then 135+).

**Synthesizer note (v1.16):** Nine researcher chapters (CXVII–CXXV) landed after v1.15 as provisional I.4 densifiers — fade×anxiety protect-then-fade, parent soft-wrong message framing, Map live-session orchestration, tutor burnout early-warning, AI coach wrap QA rubrics, soft-wrong mark taxonomy, exam-week tutor load shedding, misconception-mapped distractors, and confidence-tagged gap-scan miss recovery. This edition promotes each stack to company law (removes provisional tags), formalizes Red Team kills #71–#79, confirms FADEX/SOFTMSG/MAPORCH/BURNWARN/EXPLAINQA/TAXON/LOADSHED/DISTRACTOR/CONFMISS experiment families in Part IX, and refreshes metrics/glossary/competitive implication. Deep-dive files remain authoritative for citations; the OS keeps only *surviving* product rules.
...
**Red Team verdict (updated v1.16):**
...
## I.4 Surviving doctrine stack (Synthesizer merge through CXXV)
...
| **SAFE-MICRODEB** *(provisional)* | Capped student-first micro-AAR with traces; protect under LOADSHED; densifies AAR/LOADSHED/HITL/TALK/FBLIT | CXXVI | Ban skip-as-default / lecture-as-debrief / Microdebrief Score™ / +25% ACT debrief ads / vibes-only close |
| **SAFE-CRUNCHMSG** *(provisional)* | Shed-honesty + protected thinking-minutes CBC/messages; densifies LOADSHED/WTP/SOFTMSG/PDASH/EXAM | CXXVII | Ban 24/7 default / hours-hero / fear-parent emails / silent shed / Availability Score™ |
| **SAFE-FORMTRAP** *(provisional)* | Named format-trap visual distractors; coherent structural stems; densifies DISTRACTOR/FORMAT/DUAL/GENQ | CXXVIII | Ban FormatTrap Score™ / seductive stems / beauty visual traps / unmapped visual “diagnostic” |
| **SAFE-MICROBRIEF** *(provisional)* | Capped shared-model open (edge/success/trap/role + synthesis); densifies AAR/MICRODEB/LOADSHED/HITL/EXPECTANCY | CXXIX | Ban “no time for brief” / pour-open / Brief Score™ / late-join shame / aviation·OR·I-PASS ACT cosplay |
| **SAFE-CRUNCHCTA** *(provisional)* | Dual labeled Solver/Practice CTAs under crunch; instrumental verbs; fiduciary defaults; follow-on Practice; densifies HWHELP/CRUNCHMSG/HELP/DURABLE/SOFTMSG | CXXX | Ban Chegg-hero CTA / fear-countdown dump / Dual-CTA Score™ / silent Practice collapse / assisted≡ready |
| **SAFE-FIGKEY** *(provisional)* | Structural figure key-verify for FormatId generation; deterministic spine; use gating; densifies GENQ/FORMTRAP/DUAL/COVER/EXPLAINQA | CXXXI | Ban fluency SVG pass / judge-alone figure ship / Figure Key Score™ / unverified FormatId diagnostic / FormatId-count hero |
| **SAFE-ASYNCBRIEF** *(provisional)* | Capped async Set card on late/early wait; session-related occupied wait; if-then chip; live verify-not-replace; densifies MICROBRIEF/SRL/ATTN/LOADSHED/EXPECTANCY | CXXXII | Ban idle spinner / pour-open wait / Wait Minutes·Lobby Score™ / entertainment-primary / forced marathon Practice-before-join / late-shame feed |
| **SAFE-XFERGRAIN** *(provisional)* | One-tap edge-matched Practice grain after instrumental Solver; short default; solo gate; SCHED return; densifies HWHELP/CRUNCHCTA/SCHED/HELP/FADE/PROOF | CXXXIII | Ban dump-and-quit / maze handoff / Transfer Score™ / assisted≡ready / marathon-after-hint / XP-for-help-without-solo |
...
|------|---------|------|--------|
| 2026-08-12 | SAFE-XFERGRAIN *(provisional)*: one-tap Solver→Practice transfer grain; kill dump-and-quit / maze handoff / Transfer Score™ / assisted≡ready / marathon-after-hint | Evidence | XFERGRAIN-1…5; next = CXXXIV hide-correctness FormatId eligibility |
| 2026-08-12 | SAFE-ASYNCBRIEF *(provisional)*: async pre-brief cards on late/early wait; kill idle spinner / pour-open wait / Wait Minutes·Lobby Score™ / entertainment-primary / Practice-before-join marathon | Evidence | ASYNCBRIEF-1…5; next = CXXXIII one-tap Solver→Practice transfer |
| 2026-08-12 | SAFE-FIGKEY *(provisional)*: figure key-verify loops for generated FormatId stems; kill fluency SVG≡keyed / judge-alone ship / Figure Key Score™ / unverified FormatId diagnostic | Evidence | FIGKEY-1…5; next = CXXXII async pre-brief cards |
| 2026-08-12 | SAFE-CRUNCHCTA *(provisional)*: dual-rail Solver CTA copy under crunch; kill Chegg-hero CTA / fear-countdown dump / Dual-CTA Score™ / silent Practice collapse / assisted≡ready | Evidence | CRUNCHCTA-1…5; next = CXXXI figure key-verify loops |
| 2026-08-12 | SAFE-MICROBRIEF *(provisional)*: session-open brief fidelity under late joins; kill no-time-for-brief / pour-open / Brief Score™ / late-join shame / I-PASS cosplay ACT ads | Evidence | MICROBRIEF-1…5; next = CXXX dual-rail Solver CTA under crunch |
| 2026-08-12 | SAFE-FORMTRAP *(provisional)*: format-trap distractors on diagram/graph items; kill FormatTrap Score™ / seductive stems / beauty visual traps / unmapped visual diagnostic | Evidence | FORMTRAP-1…5; next = CXXIX session-open brief fidelity |
| 2026-08-11 | SAFE-CRUNCHMSG *(provisional)*: parent crunch-week message tests; kill 24/7 default / hours-hero / fear-parent emails / Availability Score™ | Evidence | CRUNCHMSG-1…5; next = CXXVIII format-trap distractors |
| 2026-08-11 | SAFE-MICRODEB *(provisional)*: tutor micro-debrief fidelity under time caps; kill skip-as-default / lecture-as-debrief / Microdebrief Score™ / +25% ACT debrief ads | Evidence | MICRODEB-1…5; next = CXXVII parent crunch-week message tests |
...
| SAFE-MICRODEB *(provisional)* | Capped student-first micro-AAR with traces; no Microdebrief Score™ / skip-as-default / lecture-as-debrief (Part CXXVI) |
| SAFE-CRUNCHMSG *(provisional)* | Shed-honesty crunch parent CBC/messages; no 24/7 default / hours-hero / fear-parent emails / Availability Score™ (Part CXXVII) |
| SAFE-FORMTRAP *(provisional)* | Named format-trap visual distractors; coherent structural stems; no FormatTrap Score™ / seductive stems / beauty visual traps (Part CXXVIII) |
| SAFE-MICROBRIEF *(provisional)* | Capped shared-model open + student synthesis; no Brief Score™ / no-time-for-brief / pour-open / late-join shame (Part CXXIX) |
| SAFE-CRUNCHCTA *(provisional)* | Dual labeled Solver/Practice CTAs under crunch; instrumental verbs + follow-on Practice; no Chegg-hero / Dual-CTA Score™ / fear-dump (Part CXXX) |
| SAFE-FIGKEY *(provisional)* | Structural figure key-verify for FormatId generation; deterministic spine + use gating; no fluency SVG / judge-alone / Figure Key Score™ (Part CXXXI) |
| SAFE-ASYNCBRIEF *(provisional)* | Capped async Set card on late/early wait; session-related occupied wait + verify handoff; no Wait Minutes / Lobby Score™ / pour-open wait (Part CXXXII) |
| SAFE-XFERGRAIN *(provisional)* | One-tap edge-matched Practice grain after instrumental Solver; solo gate + SCHED return; no dump-and-quit / Transfer Score™ / maze handoff (Part CXXXIII) |
...
3br. Tutor micro-debrief fidelity under time caps — **DONE** Part CXXVI / SAFE-MICRODEB *(provisional)*  
3bs. Parent crunch-week message tests (availability vs thinking minutes) — **DONE** Part CXXVII / SAFE-CRUNCHMSG *(provisional)*  
3bt. Format-trap distractors on diagram/graph items — **DONE** Part CXXVIII / SAFE-FORMTRAP *(provisional)*  
3bu. Session-open brief fidelity under late joins — **DONE** Part CXXIX / SAFE-MICROBRIEF *(provisional)*  
3bv. Dual-rail Solver CTA copy under crunch — **DONE** Part CXXX / SAFE-CRUNCHCTA *(provisional)*  
3bw. Figure key-verify loops for generated FormatId stems — **DONE** Part CXXXI / SAFE-FIGKEY *(provisional)*  
3bx. Async pre-brief cards while waiting for late tutor — **DONE** Part CXXXII / SAFE-ASYNCBRIEF *(provisional)*  
3by. One-tap Solver→Practice transfer grain after instrumental help — **DONE** Part CXXXIII / SAFE-XFERGRAIN *(provisional)*  
3bz. Hide-correctness eligibility gates for FormatId items — queued id 134 **NEXT**  
3ca. Known-finite ETA honesty in late-tutor lobby copy — queued id 135  
3cb. Soft-require vs hard-gate follow-on under help-avoidance risk — queued id 136  
...
101. **DONE (2026-08-11):** Tutor micro-debrief fidelity under time caps (Part CXXVI / id 126) — SAFE-MICRODEB stack *(provisional)*  
102. **DONE (2026-08-11):** Parent crunch-week message tests (Part CXXVII / id 127) — SAFE-CRUNCHMSG stack *(provisional)*  
103. **DONE (2026-08-12):** Format-trap distractors on diagram/graph items (Part CXXVIII / id 128) — SAFE-FORMTRAP stack *(provisional)*  
104. **DONE (2026-08-12):** Session-open brief fidelity under late joins (Part CXXIX / id 129) — SAFE-MICROBRIEF stack *(provisional)*  
105. **DONE (2026-08-12):** Dual-rail Solver CTA copy under crunch (Part CXXX / id 130) — SAFE-CRUNCHCTA stack *(provisional)*  
106. **DONE (2026-08-12):** Figure key-verify loops for generated FormatId stems (Part CXXXI / id 131) — SAFE-FIGKEY stack *(provisional)*  
107. **DONE (2026-08-12):** Async pre-brief cards while waiting for late tutor (Part CXXXII / id 132) — SAFE-ASYNCBRIEF stack *(provisional)*  
108. **DONE (2026-08-12):** One-tap Solver→Practice transfer grain after instrumental help (Part CXXXIII / id 133) — SAFE-XFERGRAIN stack *(provisional)*  
109. **Synthesizer v1.16 (2026-08-11):** Merged CXVII–CXXV into I.4 / XIV / IX / XXI — no new chapter  
110. **NEXT:** Hide-correctness eligibility gates for FormatId items (id 134)
...
**v1.16 synthesizer pass folded Parts CXVII–CXXV into surviving commercial doctrine (I.4 rows SAFE-FADEX through SAFE-CONFMISS; Red Team kills #71–#79 promoted from provisional). Experiment families FADEX/SOFTMSG/MAPORCH/BURNWARN/EXPLAINQA/TAXON/LOADSHED/DISTRACTOR/CONFMISS confirmed mounted. Parts CXXVI–CXXXIII SAFE-MICRODEB / SAFE-CRUNCHMSG / SAFE-FORMTRAP / SAFE-MICROBRIEF / SAFE-CRUNCHCTA / SAFE-FIGKEY / SAFE-ASYNCBRIEF / SAFE-XFERGRAIN landed provisional (researcher count since v1.16 = 8; Synthesizer eligible next non–Red-Team hour). Next researcher id: CXXXIV hide-correctness FormatId eligibility. Page count is not the finish line — falsifiable truth is.**
