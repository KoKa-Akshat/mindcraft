...
Queued next: see `NEXT_LAB.md` (Part CLIII contract SME panel onboarding, then 154+). Company law through CL (v1.19); CLI–CLII provisional pending synthesizer.
...
**Next research bottleneck:** Part CLIII **Contract SME panel seal onboarding & parallel-run gates**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) + SAFE-PATHBLAME (CLII) provisional** densifiers pending synthesizer. Experiment families …/TMPTRUST/REPAIRSTRAT/SURGEPANEL/**REVOKE**/**PATHBLAME** gate claims above L1. Researcher count since v1.19 synthesizer = **2**.
...
3cq. Contract SME panel seal onboarding & parallel-run gates — **NEXT** id 153  
3cr. Post-spike dual demobilization without fidelity cliff — queued id 154  
...
132. **NEXT:** Contract SME panel seal onboarding & parallel-run gates (id 153)
