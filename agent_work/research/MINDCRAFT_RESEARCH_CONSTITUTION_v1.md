...
Queued next: see `NEXT_LAB.md` (Part CXXVIII format-trap distractors, then 129+).
...
3bt. Format-trap distractors on diagram/graph items — queued id 128 **NEXT**  
3bu. Session-open brief fidelity under late joins — queued id 129  
...
102. **NEXT:** Tutor micro-debrief fidelity under time caps (id 126)
