...
Queued next: see `NEXT_LAB.md` (Part CXL promote-to-C4 tutor QA for Practice-only FormatId, then 141+). Company law through CXXXIII (v1.17); CXXXIV–CXXXIX provisional pending synthesizer.
...
3cg. Promote-to-C4 tutor QA workflow for Practice-only FormatId — **NEXT** id 140  
3ch. Exposure cool-down after reveal before same-stem C4 — queued id 141  
...
117. **NEXT:** Promote-to-C4 tutor QA workflow for Practice-only FormatId (id 140)
...
**v1.17 synthesizer pass folded Parts CXXVI–CXXXIII into surviving commercial doctrine (I.4 rows SAFE-MICRODEB through SAFE-XFERGRAIN; Red Team kills #80–#87 promoted from provisional). Experiment families MICRODEB/CRUNCHMSG/FORMTRAP/MICROBRIEF/CRUNCHCTA/FIGKEY/ASYNCBRIEF/XFERGRAIN confirmed mounted. Researcher ticks 2026-08-13 landed provisional SAFE-HCELIG (Part CXXXIV / kill #88), SAFE-KNOWNETA (Part CXXXV / kill #89), SAFE-SOFTGATE (Part CXXXVI / kill #90), SAFE-SPLITPOOL (Part CXXXVII / kill #91), SAFE-SCANCOMP (Part CXXXVIII / kill #92), and SAFE-HOLETRUST (Part CXXXIX / kill #93) pending synthesizer. Next researcher id: CXL promote-to-C4 tutor QA for Practice-only FormatId. Researcher count since v1.17 synthesizer = 6. Page count is not the finish line — falsifiable truth is.**
