...
Queued next: see `NEXT_LAB.md` (Part CXXIII exam-week tutor load shedding, then 124+).
...
**Next research bottleneck:** Part CXXIII **Exam-week tutor load shedding playbooks**. Experiment families CAL/DP/CoP/RIT/AAR/FILM/MUSIC/ANNOT/EXP- gate claims above L1. Researcher count since v1.15 synthesizer = **6**. Provisional densifiers pending synthesizer: SAFE-FADEX (CXVII), SAFE-SOFTMSG (CXVIII), SAFE-MAPORCH (CXIX), SAFE-BURNWARN (CXX), SAFE-EXPLAINQA (CXXI), SAFE-TAXON (CXXII).
...
3bn. Exam-week tutor load shedding playbooks — queued id 123 **NEXT**  
3bo. Distractor design for diagnostic soft-wrong MC — queued id 124  
