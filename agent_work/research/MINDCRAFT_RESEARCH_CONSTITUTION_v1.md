...
Queued next: see `NEXT_LAB.md` (Part CXXXVI soft-require vs hard-gate transfer follow-on, then 137+). Company law through CXXXIII (v1.17); CXXXIV–CXXXV provisional pending synthesizer.
...
3cb. Known-finite ETA honesty in late-tutor lobby copy — **NEXT** id 135  
3cc. Soft-require vs hard-gate follow-on under help-avoidance risk — queued id 136  
3cd. Reveal-Practice vs C4 split pools for sealed FormatId — queued id 137  
...
112. **NEXT:** Known-finite ETA honesty in late-tutor lobby copy (id 135)
