...
Queued next: see `NEXT_LAB.md` (Part CLII path-conditioned dual blame, then 153+). Company law through CL (v1.19); CLI provisional pending synthesizer.
...
**Next research bottleneck:** Part CLII **Path-conditioned dual blame tests (selection vs quality)**. Company law through SAFE-SURGEPANEL (CL); **SAFE-REVOKE (CLI) provisional** densifier pending synthesizer. Experiment families …/TMPTRUST/REPAIRSTRAT/SURGEPANEL/**REVOKE** gate claims above L1. Researcher count since v1.19 synthesizer = **1**.
...
3cp. Path-conditioned dual blame tests — **NEXT** id 152
3cp. Path-conditioned dual blame tests — queued id 152  
3cq. Contract SME panel seal onboarding & parallel-run gates — queued id 153  
...
131. **NEXT:** Path-conditioned dual blame tests (id 152)
