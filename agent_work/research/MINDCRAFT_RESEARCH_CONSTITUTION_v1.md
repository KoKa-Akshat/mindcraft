...
Queued next: see `NEXT_LAB.md` (Part CXXXI figure key-verify loops, then 132+).
...
3bw. Figure key-verify loops for generated FormatId stems — queued id 131 **NEXT**  
3bx. Async pre-brief cards while waiting for late tutor — queued id 132  
...
105. **Synthesizer v1.16 (2026-08-11):** Merged CXVII–CXXV into I.4 / XIV / IX / XXI — no new chapter  
106. **NEXT:** Dual-rail Solver CTA copy under crunch (id 130)
