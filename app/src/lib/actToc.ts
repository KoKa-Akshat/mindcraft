...
export const ACT_TOC_SECTIONS: ActTocSection[] = [
  {
    ...
    wash: 'linear-gradient(165deg, rgba(90, 48, 28, 0.55) 0%, rgba(40, 24, 16, 0.72) 100%)',
    accent: '#e8a06c',
    ink: '#f4efe2',
  ...
  },
  {
    ...
    wash: 'linear-gradient(165deg, rgba(36, 122, 77, 0.38) 0%, rgba(14, 40, 28, 0.72) 100%)',
    accent: '#b9e86f',
    ink: '#f4efe2',
  ...
  },
  {
    ...
    wash: 'linear-gradient(165deg, rgba(47, 122, 143, 0.4) 0%, rgba(14, 36, 48, 0.72) 100%)',
    accent: '#7ec8e3',
    ink: '#f4efe2',
  ...
  },
  {
    ...
    wash: 'linear-gradient(165deg, rgba(211, 169, 0, 0.28) 0%, rgba(40, 32, 12, 0.72) 100%)',
    accent: '#f5d348',
    ink: '#f4efe2',
